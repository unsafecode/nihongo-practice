...
const ui: LocalePack["ui"] = {
  ...
  settings: { language: "Lingua", writing: "Scrittura", reference: "Mostra l'inglese di riferimento", unavailable: "Le preferenze e i progressi non possono essere salvati in questo browser." },
