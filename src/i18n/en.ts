...
const ui: LocalePack["ui"] = {
  ...
  syllabary: {
    ...
    notes: "Remember",
    groupNavLabel: "Jump to a kana group",
    groups: {
      gojuon: "Gojūon",
      dakuten: "Dakuten",
      yoon: "Yōon",
    ...
    invalidGroup: "That group does not exist, so the full chart is shown.",
    invalidReturnTitle: "Invalid return",
    invalidReturn:
      "This return link is invalid; use the navigation to go back to the lesson.",
    targetAnnounce: (groupName) => `Active group: ${groupName}`,
  },
