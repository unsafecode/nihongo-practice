...
const lesson1: A2BuiltLesson = buildA2InstructionalLesson({
  ...
  introducedSenseIds: [],
  models: [
    experienceLine("experiences-narratives-1-m1", null, "a2-value-exp-oyoida", "a2-context-experiences", L("I have swum before.", "Ho già nuotato.")),
    ...
    experienceLine("experiences-narratives-1-m7", "a2-referent-teacher", "a2-value-exp-oyoida", "a2-context-experiences", L("The teacher has swum before.", "L'insegnante ha già nuotato.")),
...
const lesson3: A2BuiltLesson = buildA2InstructionalLesson({
  ...
  introducedSenseIds: [],
  models: [
    experienceLine("experiences-narratives-3-m1", "a2-referent-emi", "a2-value-exp-oyoida", "a2-context-experiences", L("Emi has swum before.", "Emi ha già nuotato.")),
    experienceLine("experiences-narratives-3-m2", "a2-referent-sora", "a2-value-exp-oyoida", "a2-context-outing", L("Sora has swum before.", "Sora ha già nuotato.")),
    experienceLine("experiences-narratives-3-m3", "a2-referent-friend", "a2-value-exp-oyoida", "a2-context-among-friends", L("My friend has swum before.", "Il mio amico ha già nuotato.")),
    experienceLine("experiences-narratives-3-m4", "a2-referent-colleague", "a2-value-exp-oyoida", "a2-context-workplace", L("My colleague has swum before.", "Il mio collega ha già nuotato.")),
...
const lesson4: A2BuiltLesson = buildA2InstructionalLesson({
  ...
  introducedSenseIds: [],
  models: [
    experienceLine("experiences-narratives-4-m1", null, "a2-value-exp-oyoida", "a2-context-experiences", L("Have you ever swum?", "Hai mai nuotato?"), true),
    ...
    experienceLine("experiences-narratives-4-m6", "a2-referent-friend", "a2-value-exp-oyoida", "a2-context-among-friends", L("Has your friend ever swum?", "Il tuo amico ha mai nuotato?"), true),
  ...
  transfers: [
    ...
    experienceLine("experiences-narratives-4-t2", "a2-referent-sora", "a2-value-exp-oyoida", "a2-context-outing", L("Has Sora ever swum?", "Sora ha mai nuotato?"), true),
