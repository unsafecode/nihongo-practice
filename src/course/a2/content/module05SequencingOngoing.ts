...
const lesson3: A2BuiltLesson = buildA2InstructionalLesson({
  ...
  models: [
    ...
    objectLine("sequencing-ongoing-3-m2", "a2-family-ongoing-teiru", "a2-value-teiru-nomu", "a2-value-obj-mizu", "a2-context-routines", L("Emi is drinking water.", "Emi sta bevendo acqua."), "a2-role-emi", "a2-referent-emi"),
    objectLine("sequencing-ongoing-3-m3", "a2-family-ongoing-teiru", "a2-value-teiru-yomu", "a2-value-obj-hon-m5", "a2-context-conversation", L("Sora is reading a book.", "Sora sta leggendo un libro."), "a2-role-sora", "a2-referent-sora"),
    objectLine("sequencing-ongoing-3-m4", "a2-family-ongoing-teiru", "a2-value-teiru-kaku", "a2-value-obj-tegami", "a2-context-routines", L("A friend is writing a letter.", "Un amico sta scrivendo una lettera."), "a2-role-friend", "a2-referent-friend"),
    objectLine("sequencing-ongoing-3-m5", "a2-family-ongoing-teiru", "a2-value-teiru-hanasu", "a2-value-obj-nihongo-m5", "a2-context-workplace", L("A colleague is speaking Japanese.", "Un collega sta parlando giapponese."), "a2-role-colleague", "a2-referent-colleague"),
    objectLine("sequencing-ongoing-3-m6", "a2-family-ongoing-teiru", "a2-value-teiru-asobu", null, "a2-context-among-friends", L("The teacher is playing.", "L'insegnante sta giocando."), "a2-role-teacher", "a2-referent-teacher"),
    ...
    objectLine("sequencing-ongoing-3-m8", "a2-family-ongoing-teiru", "a2-value-teiru-matsu", "a2-value-obj-basu", "a2-context-routines", L("Emi is waiting for a bus.", "Emi sta aspettando un autobus."), "a2-role-emi", "a2-referent-emi"),
  ],
  transfers: [
...
const lesson4: A2BuiltLesson = buildA2InstructionalLesson({
  ...
  models: [
    ...
    bareLine("sequencing-ongoing-4-m2", "a2-family-te-sequence", "a2-value-seq-asonde-kaeru", "a2-context-among-friends", L("I play with a friend, then go home.", "Gioco con un amico, poi torno a casa."), "a2-role-friend"),
    ...
    objectLine("sequencing-ongoing-4-m5", "a2-family-ongoing-teiru", "a2-value-teiru-yomu", "a2-value-obj-tegami", "a2-context-routines", L("The teacher is reading a letter.", "L'insegnante sta leggendo una lettera."), "a2-role-teacher", "a2-referent-teacher"),
