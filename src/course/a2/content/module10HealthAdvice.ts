...
const lesson4: A2BuiltLesson = buildA2InstructionalLesson({
  ...
  models: [
    ...
    line("health-advice-4-m5", "a2-family-clinic-appointment", "a2-value-clinic-yoyaku-shitai", HEALTH, L("Excuse me, I'd like to make an appointment.", "Scusi, vorrei prendere un appuntamento."), { subjectReferent: "a2-referent-clerk", subjectRealization: "vocative", speakerRole: "a2-role-learner" }),
    line("health-advice-4-m6", "a2-family-clinic-appointment", "a2-value-clinic-itsu-aiteru", HEALTH, L("Excuse me, when are you open?", "Scusi, quando siete aperti?"), { subjectReferent: "a2-referent-clerk", subjectRealization: "vocative", speakerRole: "a2-role-learner" }),
    line("health-advice-4-m7", "a2-family-clinic-appointment", "a2-value-clinic-jikan-henkou", HEALTH, L("Excuse me, can you change the time?", "Scusi, potete cambiare l'orario?"), { subjectReferent: "a2-referent-clerk", subjectRealization: "vocative", speakerRole: "a2-role-learner" }),
  ...
  transfers: [
    line("health-advice-4-t1", "a2-family-clinic-appointment", "a2-value-clinic-ashita-ikitai", HEALTH, L("Excuse me, is tomorrow okay too?", "Scusi, va bene anche domani?"), { subjectReferent: "a2-referent-clerk", subjectRealization: "vocative", speakerRole: "a2-role-learner" }),
