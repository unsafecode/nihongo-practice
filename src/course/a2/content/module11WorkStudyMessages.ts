...
const lesson2: A2BuiltLesson = buildA2InstructionalLesson({
  ...
  models: [
    ...
    line("work-study-messages-2-m3", "a2-family-ask-colleague", "a2-value-ask-kakunin-shite", WORKPLACE, L("Please pass along the email.", "Per favore, gira l'email."), { object: "a2-value-obj-mail", speakerRole: "a2-role-teacher" }),
    ...
    line("work-study-messages-2-m6", "a2-family-ask-colleague", "a2-value-ask-kakunin-shite", WORK_STUDY, L("Please pass along the documents.", "Per favore, gira i documenti."), { object: "a2-value-obj-shorui", speakerRole: "a2-role-teacher" }),
  ...
  transfers: [
    line("work-study-messages-2-t1", "a2-family-ask-colleague", "a2-value-ask-kakunin-shite", WORK_STUDY, L("Please pass along the task.", "Per favore, gira il compito."), { object: "a2-value-obj-shigoto-m11", speakerRole: "a2-role-colleague" }),
