...
const lesson1: A2BuiltLesson = buildA2InstructionalLesson({
  ...
  models: [
    ...
    line("travel-reservations-1-m6", "a2-family-make-reservation", "a2-value-resv-heya-arimasuka", OUTING, L("Sora, do you have a room available?", "Sora, avete una stanza disponibile?"), { subjectReferent: "a2-referent-sora", subjectRealization: "vocative", speakerRole: "a2-role-teacher" }),
    ...
    line("travel-reservations-1-m8", "a2-family-make-reservation", "a2-value-resv-heya-arimasuka", OUTING, L("Emi, do you have a room available?", "Emi, avete una stanza disponibile?"), { subjectReferent: "a2-referent-emi", subjectRealization: "vocative", speakerRole: "a2-role-learner" }),
