...
const lesson2: A2BuiltLesson = buildA2InstructionalLesson({
  ...
  models: [
    ...
    line("permission-requests-2-m2", "a2-family-prohibition-tewaikenai", "a2-value-tewaikenai-nomu", "a2-context-rules", L("You must not drink water.", "Non devi bere l'acqua."), { object: "a2-value-obj-mizu", speakerRole: "a2-role-clerk" }),
    ...
    line("permission-requests-2-m4", "a2-family-prohibition-tewaikenai", "a2-value-tewaikenai-hanasu", "a2-context-rules", L("You must not speak English.", "Non devi parlare inglese."), { object: "a2-value-obj-eigo", speakerRole: "a2-role-teacher" }),
...
const lesson4: A2BuiltLesson = buildA2InstructionalLesson({
  ...
  models: [
    ...
    line("permission-requests-4-m2", "a2-family-negative-request", "a2-value-naidekudasai-tomaru", "a2-context-neighborhood", L("Please don't stop.", "Per favore, non fermarti."), { speakerRole: "a2-role-clerk" }),
    ...
    line("permission-requests-4-m6", "a2-family-prohibition-tewaikenai", "a2-value-tewaikenai-hanasu", "a2-context-rules", L("You must not speak English.", "Non devi parlare inglese."), { object: "a2-value-obj-eigo", speakerRole: "a2-role-colleague" }),
  ...
  transfers: [
    line("permission-requests-4-t1", "a2-family-negative-request", "a2-value-naidekudasai-tomaru", "a2-context-rules", L("Emi, please don't stop.", "Emi, per favore non fermarti."), { subjectReferent: "a2-referent-emi" }),
