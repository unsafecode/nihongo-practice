...
const lesson2: A2BuiltLesson = buildA2InstructionalLesson({
  ...
  introducedSenseIds: [],
  models: [
    line("restaurant-problems-2-m1", "a2-family-request-tekudasai", "a2-value-tekudasai-matsu", "a2-context-restaurant", L("Please wait.", "Per favore, aspetta."), { speakerRole: "a2-role-clerk" }),
    line("restaurant-problems-2-m2", "a2-family-request-tekudasai", "a2-value-tekudasai-suwaru", "a2-context-restaurant", L("Please sit down.", "Per favore, siediti."), { speakerRole: "a2-role-clerk" }),
    line("restaurant-problems-2-m3", "a2-family-request-tekudasai", "a2-value-tekudasai-kaku", "a2-context-restaurant", L("Please write your name.", "Per favore, scrivi il tuo nome."), { object: "a2-value-obj-namae", speakerRole: "a2-role-clerk" }),
    line("restaurant-problems-2-m4", "a2-family-request-tekudasai", "a2-value-tekudasai-taberu", "a2-context-restaurant", L("Please try the meat.", "Per favore, prova la carne."), { object: "a2-value-obj-niku", speakerRole: "a2-role-teacher" }),
    line("restaurant-problems-2-m5", "a2-family-request-tekudasai", "a2-value-tekudasai-hanasu", "a2-context-cafe", L("Please speak in English.", "Per favore, parla in inglese."), { object: "a2-value-obj-eigo", speakerRole: "a2-role-colleague" }),
  ...
  transfers: [
    line("restaurant-problems-2-t1", "a2-family-request-tekudasai", "a2-value-tekudasai-tatsu", "a2-context-restaurant", L("Please stand up.", "Per favore, alzati."), { speakerRole: "a2-role-friend" }),
    line("restaurant-problems-2-t2", "a2-family-request-tekudasai", "a2-value-tekudasai-taberu", "a2-context-restaurant", L("Please try the ramen.", "Per favore, prova il ramen."), { object: "a2-value-obj-raamen", speakerRole: "a2-role-colleague" }),
    line("restaurant-problems-2-t3", "a2-family-request-tekudasai", "a2-value-tekudasai-kesu", "a2-context-restaurant", L("Please turn off the lights.", "Per favore, spegni le luci."), { object: "a2-value-obj-denki", speakerRole: "a2-role-teacher" }),
...
const lesson4: A2BuiltLesson = buildA2InstructionalLesson({
  ...
  introducedSenseIds: [],
  models: [
    line("restaurant-problems-4-m1", "a2-family-te-sequence", "a2-value-seq-onegaishite-harau", "a2-context-restaurant", L("I asked for the check, then paid the money.", "Ho chiesto il conto, poi ho pagato i soldi."), { speakerRole: "a2-role-learner", form: A2_AFFIRMATIVE_PAST_POLITE }),
    line("restaurant-problems-4-m2", "a2-family-te-sequence", "a2-value-seq-tanonde-matsu", "a2-context-restaurant", L("I ask for the check, then wait.", "Chiedo il conto, poi aspetto."), { speakerRole: "a2-role-learner" }),
    line("restaurant-problems-4-m3", "a2-family-te-sequence", "a2-value-seq-kazoete-harau", "a2-context-restaurant", L("I counted the money, then paid.", "Ho contato i soldi, poi ho pagato."), { speakerRole: "a2-role-colleague", form: A2_AFFIRMATIVE_PAST_POLITE }),
    line("restaurant-problems-4-m4", "a2-family-te-sequence", "a2-value-seq-uketotte-kaeru", "a2-context-restaurant", L("I receive the change, then go home.", "Ricevo il resto, poi torno a casa."), { speakerRole: "a2-role-friend" }),
    line("restaurant-problems-4-m5", "a2-family-te-sequence", "a2-value-seq-tabete-harau", "a2-context-cafe", L("I ate the meal, then paid.", "Ho mangiato il pasto, poi ho pagato."), { speakerRole: "a2-role-learner", form: A2_AFFIRMATIVE_PAST_POLITE }),
    line("restaurant-problems-4-m6", "a2-family-te-sequence", "a2-value-seq-nonde-harau", "a2-context-cafe", L("I drank the tea, then paid.", "Ho bevuto il tè, poi ho pagato."), { speakerRole: "a2-role-sora", form: A2_AFFIRMATIVE_PAST_POLITE }),
    line("restaurant-problems-4-m7", "a2-family-te-sequence", "a2-value-seq-mite-tanomu", "a2-context-restaurant", L("I looked at the menu, then ordered.", "Ho guardato il menù, poi ho ordinato."), { speakerRole: "a2-role-teacher", form: A2_AFFIRMATIVE_PAST_POLITE }),
    line("restaurant-problems-4-m8", "a2-family-te-sequence", "a2-value-seq-tabete-kaeru", "a2-context-restaurant", L("I eat the meal, then go home.", "Mangio il pasto, poi torno a casa."), { speakerRole: "a2-role-emi" }),
  ],
  // Phase 3 Task 5 fix ("introduction before use"): every transfer here
  ...
  transfers: [
    line("restaurant-problems-4-t1", "a2-family-te-sequence", "a2-value-seq-onegaishite-harau", "a2-context-restaurant", L("Sora, I asked for the check, then paid the money.", "Sora, ho chiesto il conto, poi ho pagato i soldi."), { subjectReferent: "a2-referent-sora", form: A2_AFFIRMATIVE_PAST_POLITE }),
    line("restaurant-problems-4-t2", "a2-family-te-sequence", "a2-value-seq-tanonde-matsu", "a2-context-restaurant", L("Emi, I ask for the check, then wait.", "Emi, chiedo il conto, poi aspetto."), { subjectReferent: "a2-referent-emi" }),
