...
const a2AuthoredValuesM1: readonly SemanticValue[] = [
  ...
  { id: "a2-value-hanasu", kind: "predicate-sense", senseId: "a2-sense-hanasu", tokenFragments: kanaFragments([{ jp: "話", romaji: "hana", kind: "lexical", boundaryBefore: "attach", reading: "はな" }]) },
