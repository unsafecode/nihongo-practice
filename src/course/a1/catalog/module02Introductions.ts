...
const lesson3: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "introductions-3-m2", family: "a1-family-bare-action", context: "a1-context-bare-study-conversation", subjectReferent: "a1-referent-person", subjectRealization: "explicit", slots: bare("a1-value-taichi", "a1-value-study-bare"), translation: L("Taichi studies.", "Taichi studia.") },
    ...
    { id: "introductions-3-m5", family: "a1-family-bare-action", context: "a1-context-bare-study-conversation", subjectReferent: "a1-referent-person", subjectRealization: "explicit", slots: bare("a1-value-ano-hito", "a1-value-study-bare"), translation: L("That person over there studies.", "Quella persona laggiù studia.") },
    ...
    { id: "introductions-3-m8", family: "a1-family-bare-action", context: "a1-context-bare-study-conversation", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: bare("a1-value-yuki", "a1-value-study-bare"), translation: L("Yuki studies.", "Yuki studia.") },
  ],
  transfers: [
    { id: "introductions-3-t1", family: "a1-family-bare-action", context: "a1-context-bare-study-conversation", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", slots: bare("a1-value-mina", "a1-value-study-bare"), translation: L("Mina studies.", "Mina studia.") },
    ...
    { id: "introductions-3-t5", family: "a1-family-bare-action", context: "a1-context-bare-study-conversation", subjectReferent: "a1-referent-self", subjectRealization: "omitted", slots: bare("a1-value-watashi", "a1-value-study-bare"), translation: L("I study.", "Studio.") },
  ],
});
...
const lesson4: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "introductions-4-m5", family: "a1-family-bare-action", context: "a1-context-bare-study-conversation", subjectReferent: "a1-referent-classmate", subjectRealization: "explicit", slots: bare("a1-value-classmate-subject", "a1-value-study-bare"), translation: L("The classmate studies.", "Il compagno di classe studia.") },
    ...
    { id: "introductions-4-m8", family: "a1-family-bare-action", context: "a1-context-bare-study-conversation", subjectReferent: "a1-referent-self", subjectRealization: "omitted", slots: bare("a1-value-watashi", "a1-value-study-bare"), translation: L("I study.", "Studio.") },
  ],
  transfers: [
    ...
    { id: "introductions-4-t5", family: "a1-family-bare-action", context: "a1-context-bare-study-conversation", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: bare("a1-value-yuki", "a1-value-study-bare"), translation: L("Yuki studies.", "Yuki studia.") },
  ],
});
