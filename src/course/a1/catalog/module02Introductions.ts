...
const lesson2: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  introducedSenseIds: [],
  models: [
    { id: "introductions-2-m1", family: "a1-family-topic-copular", context: "a1-context-first-meeting", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", slots: cop("a1-value-mina", "a1-value-obj-japanese-person"), translation: a1Copular("a1-value-mina", "a1-value-obj-japanese-person") },
    { id: "introductions-2-m2", family: "a1-family-topic-copular", context: "a1-context-first-meeting", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: cop("a1-value-ken", "a1-value-obj-italian-person"), translation: a1Copular("a1-value-ken", "a1-value-obj-italian-person") },
    { id: "introductions-2-m3", family: "a1-family-topic-copular", context: "a1-context-first-meeting", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: cop("a1-value-yuki", "a1-value-obj-american-person"), translation: a1Copular("a1-value-yuki", "a1-value-obj-american-person") },
    { id: "introductions-2-m4", family: "a1-family-topic-copular", context: "a1-context-classroom", subjectReferent: "a1-referent-self", subjectRealization: "explicit", slots: cop("a1-value-watashi", "a1-value-obj-japanese-person"), translation: a1Copular("a1-value-watashi", "a1-value-obj-japanese-person") },
...
const lesson3: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    { id: "introductions-3-m1", family: "a1-family-bare-action", context: "a1-context-workplace", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: bare("a1-value-yuki", "a1-value-work-bare"), translation: L("Yuki works.", "Yuki lavora.") },
    { id: "introductions-3-m2", family: "a1-family-bare-action", context: "a1-context-first-meeting", subjectReferent: "a1-referent-self", subjectRealization: "omitted", slots: bare("a1-value-watashi", "a1-value-study-bare"), translation: L("I study.", "Studio.") },
    { id: "introductions-3-m3", family: "a1-family-bare-action", context: "a1-context-first-meeting", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: bare("a1-value-ken", "a1-value-do-bare"), translation: L("Ken will do it.", "Ken lo farà.") },
    { id: "introductions-3-m4", family: "a1-family-bare-action", context: "a1-context-first-meeting", subjectReferent: "a1-referent-self", subjectRealization: "omitted", slots: bare("a1-value-watashi", "a1-value-work-bare"), translation: L("I work.", "Lavoro.") },
