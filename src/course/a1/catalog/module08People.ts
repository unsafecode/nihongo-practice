...
const lesson2: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "people-2-m5", family: SCHED, context: "a1-context-classroom", subjectReferent: PERSON, subjectRealization: "explicit", speakerRole: R_KEN, slots: timed("a1-value-kin-younger-brother", "a1-value-study-routine", "a1-value-day-monday"), translation: L("My younger brother studies on Monday.", "Mio fratello minore studia il lunedì.") },
    { id: "people-2-m6", family: ADV, context: "a1-context-home", subjectReferent: PERSON, subjectRealization: "explicit", speakerRole: R_MINA, slots: timed("a1-value-kin-younger-sister", "a1-value-eat-routine", "a1-value-seq-morning"), translation: L("My younger sister eats in the morning.", "Mia sorella minore mangia la mattina.") },
    { id: "people-2-m7", family: ADV, context: "a1-context-home", subjectReferent: PERSON, subjectRealization: "explicit", slots: timed("a1-value-kin-father", "a1-value-read-routine", "a1-value-seq-night"), translation: L("My father reads at night.", "Mio padre legge la sera.") },
  ...
  transfers: [
    ...
    { id: "people-2-t4", family: ADV, context: "a1-context-home", subjectReferent: PERSON, subjectRealization: "explicit", speakerRole: R_KEN, slots: timed("a1-value-kin-younger-brother", "a1-value-eat-routine", "a1-value-seq-morning"), translation: L("My younger brother eats in the morning.", "Mio fratello minore mangia la mattina.") },
    { id: "people-2-t5", family: ADV, context: "a1-context-home", subjectReferent: PERSON, subjectRealization: "explicit", slots: timed("a1-value-kin-older-brother", "a1-value-read-routine", "a1-value-seq-night"), translation: L("My older brother reads at night.", "Mio fratello maggiore legge la sera.") },
  ],
});
...
const lesson3: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "people-3-m2", family: COMPF, context: "a1-context-town", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: comp("a1-value-yuki", "a1-value-companion-classmate"), translation: L("Yuki goes with a classmate.", "Yuki va con un compagno di classe.") },
    { id: "people-3-m3", family: RECF, context: "a1-context-classroom", subjectReferent: SELF, subjectRealization: "omitted", slots: ask(WATASHI, "a1-value-recipient-teacher"), translation: L("I ask the teacher.", "Chiedo all'insegnante.") },
    ...
    { id: "people-3-m5", family: COMPF, context: "a1-context-classroom", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", slots: comp("a1-value-mina", "a1-value-companion-teacher"), translation: L("Mina goes with the teacher.", "Mina va con l'insegnante.") },
  ...
  transfers: [
    ...
    { id: "people-3-t2", family: COMPF, context: "a1-context-town", subjectReferent: SELF, subjectRealization: "omitted", slots: comp(WATASHI, "a1-value-companion-classmate"), translation: L("I go with a classmate.", "Vado con un compagno di classe.") },
    { id: "people-3-t3", family: RECF, context: "a1-context-classroom", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", slots: ask("a1-value-mina", "a1-value-recipient-teacher"), translation: L("Mina asks the teacher.", "Mina chiede all'insegnante.") },
...
const lesson4: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    { id: "people-4-m1", family: OBJ, context: "a1-context-shop", subjectReferent: SELF, subjectRealization: "omitted", slots: obj(WATASHI, "a1-value-buy", "a1-value-obj-book"), translation: L("I buy a book.", "Compro un libro.") },
    { id: "people-4-m2", family: OBJ, context: "a1-context-shop", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: obj("a1-value-yuki", "a1-value-buy", "a1-value-obj-book"), translation: L("Yuki buys a book.", "Yuki compra un libro.") },
    ...
    { id: "people-4-m7", family: OBJ, context: "a1-context-shop", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: obj("a1-value-yuki", "a1-value-buy", "a1-value-obj-newspaper"), translation: L("Yuki buys a newspaper.", "Yuki compra un giornale.") },
    { id: "people-4-m8", family: OBJ, context: "a1-context-cafe", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", slots: obj("a1-value-mina", "a1-value-see", "a1-value-obj-movie"), translation: L("Mina watches a movie.", "Mina guarda un film.") },
  ],
  transfers: [
    { id: "people-4-t1", family: OBJ, context: "a1-context-shop", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: obj("a1-value-ken", "a1-value-buy", "a1-value-obj-book"), translation: L("Ken buys a book.", "Ken compra un libro.") },
    ...
    { id: "people-4-t4", family: OBJ, context: "a1-context-shop", subjectReferent: SELF, subjectRealization: "omitted", slots: obj(WATASHI, "a1-value-buy", "a1-value-obj-newspaper"), translation: L("I buy a newspaper.", "Compro un giornale.") },
