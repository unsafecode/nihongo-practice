...
const EXPECTED_SENTENCES: readonly (readonly [string, string, string])[] = [
    ["introductions-1-m1", "ゆきはがくせいです", "yuki wa gakuseidesu"],
    ["introductions-1-m2", "けんはいしゃです", "ken wa ishadesu"],
    ["introductions-1-m3", "みなはかいしゃいんです", "mina wa kaishaindesu"],
    ["introductions-1-m4", "がくせいです", "gakuseidesu"],
    ...
    ["introductions-1-t1", "けんはがくせいです", "ken wa gakuseidesu"],
    ["introductions-1-t2", "きょうとにすみます", "kyouto ni sumimasu"],
    ["introductions-1-t3", "みなはにほんごをべんきょうします", "mina wa nihongo o benkyoushimasu"],
    ["introductions-1-t4", "みなはせんせいです", "mina wa senseidesu"],
    ...
    ["introductions-2-t1", "みせではたらきます", "mise de hatarakimasu"],
    ...
    ["introductions-3-m1", "ゆきはにほんじんです", "yuki wa nihonjindesu"],
    ["introductions-3-m2", "けんはイタリアじんです", "ken wa itariajindesu"],
    ["introductions-3-m3", "みなはアメリカじんです", "mina wa amerikajindesu"],
    ...
    ["introductions-3-t1", "みなはにほんじんです", "mina wa nihonjindesu"],
    ["introductions-3-t2", "きょうとにすみます", "kyouto ni sumimasu"],
    ["introductions-3-t3", "ゆきはイタリアごをべんきょうします", "yuki wa itariago o benkyoushimasu"],
    ["introductions-3-t4", "けんはアメリカじんです", "ken wa amerikajindesu"],
    ["introductions-3-t5", "みなはおおさかにすみます", "mina wa oosaka ni sumimasu"],
    ["introductions-4-m1", "ゆきはがくせいです", "yuki wa gakuseidesu"],
    ["introductions-4-m2", "けんはエンジニアです", "ken wa enjiniadesu"],
    ...
    ["introductions-4-m8", "みなはかいしゃいんです", "mina wa kaishaindesu"],
    ["introductions-4-t1", "みなはエンジニアです", "mina wa enjiniadesu"],
    ...
    ["essential-questions-1-m1", "これはなんですか", "kore wa nandesu ka"],
    ["essential-questions-1-m2", "それはなんですか", "sore wa nandesu ka"],
    ["essential-questions-1-m3", "あのひとはだれですか", "ano hito wa daredesu ka"],
    ["essential-questions-1-m4", "どのほんですか", "dono hondesu ka"],
    ...
    ["essential-questions-1-m8", "ゆきはがくせいですか", "yuki wa gakuseidesu ka"],
    ["essential-questions-1-t1", "あれはなんですか", "are wa nandesu ka"],
    ["essential-questions-1-t2", "そのひとはだれですか", "sono hito wa daredesu ka"],
    ...
    ["essential-questions-2-m1", "トイレはどこですか", "toire wa dokodesu ka"],
    ["essential-questions-2-m2", "えきはどこですか", "eki wa dokodesu ka"],
    ["essential-questions-2-m3", "あのひとはだれですか", "ano hito wa daredesu ka"],
    ["essential-questions-2-m4", "そのひとはだれですか", "sono hito wa daredesu ka"],
    ["essential-questions-2-m5", "これはなんですか", "kore wa nandesu ka"],
    ["essential-questions-2-m6", "なにをしますか", "nani o shimasu ka"],
    ["essential-questions-2-m7", "なにをべんきょうしますか", "nani o benkyoushimasu ka"],
    ["essential-questions-2-m8", "けんはがくせいですか", "ken wa gakuseidesu ka"],
    ["essential-questions-2-t1", "それはなんですか", "sore wa nandesu ka"],
    ["essential-questions-2-t2", "どのほんですか", "dono hondesu ka"],
    ...
    ["essential-questions-2-t5", "みなはがくせいですか", "mina wa gakuseidesu ka"],
    ["essential-questions-3-m1", "パーティーはいつですか", "paatii wa itsudesu ka"],
    ["essential-questions-3-m2", "これはいくらですか", "kore wa ikuradesu ka"],
    ["essential-questions-3-m3", "それはいくらですか", "sore wa ikuradesu ka"],
    ["essential-questions-3-m4", "みかんはいくつですか", "mikan wa ikutsudesu ka"],
    ["essential-questions-3-m5", "あれはいくらですか", "are wa ikuradesu ka"],
    ...
    ["essential-questions-3-t1", "これはいくつですか", "kore wa ikutsudesu ka"],
    ...
    ["essential-questions-3-t5", "みかんはいくらですか", "mikan wa ikuradesu ka"],
    ["essential-questions-4-m1", "これはなんですか", "kore wa nandesu ka"],
    ["essential-questions-4-m2", "あのひとはだれですか", "ano hito wa daredesu ka"],
    ["essential-questions-4-m3", "トイレはどこですか", "toire wa dokodesu ka"],
    ["essential-questions-4-m4", "これはいくらですか", "kore wa ikuradesu ka"],
    ["essential-questions-4-m5", "パーティーはいつですか", "paatii wa itsudesu ka"],
    ["essential-questions-4-m6", "なにをしますか", "nani o shimasu ka"],
    ["essential-questions-4-m7", "なにをべんきょうしますか", "nani o benkyoushimasu ka"],
    ["essential-questions-4-m8", "ゆきはがくせいですか", "yuki wa gakuseidesu ka"],
    ["essential-questions-4-t1", "それはなんですか", "sore wa nandesu ka"],
    ["essential-questions-4-t2", "そのひとはだれですか", "sono hito wa daredesu ka"],
    ["essential-questions-4-t3", "えきはどこですか", "eki wa dokodesu ka"],
    ["essential-questions-4-t4", "みかんはいくつですか", "mikan wa ikutsudesu ka"],
    ...
    ["actions-1-t1", "みなはてがみをよみます", "mina wa tegami o yomimasu"],
