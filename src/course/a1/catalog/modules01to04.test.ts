...
const romajiOf = (tokens: readonly { readonly romaji: string }[]): string =>
  tokens.map((t) => t.romaji).join(" ");
...
const EXPECTED_SENTENCES: readonly (readonly [string, string, string])[] = [
    ...
    ["introductions-1-m5", "ゆきはとうきょうにすみます", "yuki wa toukyou ni sumi masu"],
    ["introductions-1-m6", "おおさかにすみます", "oosaka ni sumi masu"],
    ["introductions-1-m7", "ゆきはにほんごをべんきょうします", "yuki wa nihongo o benkyoushi masu"],
    ["introductions-1-m8", "えいごをべんきょうします", "eigo o benkyoushi masu"],
    ["introductions-1-t1", "けんはがくせいです", "ken wa gakusei desu"],
    ["introductions-1-t2", "きょうとにすみます", "kyouto ni sumi masu"],
    ["introductions-1-t3", "みなはにほんごをべんきょうします", "mina wa nihongo o benkyoushi masu"],
    ["introductions-1-t4", "みなはせんせいです", "mina wa sensei desu"],
    ["introductions-1-t5", "クラスメートはとうきょうにすみます", "kurasumeeto wa toukyou ni sumi masu"],
    ["introductions-2-m1", "けんはかいしゃではたらきます", "ken wa kaisha de hataraki masu"],
    ["introductions-2-m2", "みなはかいしゃではたらきます", "mina wa kaisha de hataraki masu"],
    ["introductions-2-m3", "レストランではたらきます", "resutoran de hataraki masu"],
    ["introductions-2-m4", "ゆきはにほんごがわかります", "yuki wa nihongo ga wakari masu"],
    ["introductions-2-m5", "えいごがわかります", "eigo ga wakari masu"],
    ["introductions-2-m6", "ゆきはしゅくだいをします", "yuki wa shukudai o shi masu"],
    ["introductions-2-m7", "しゅくだいをします", "shukudai o shi masu"],
    ["introductions-2-m8", "けんはにほんごをべんきょうします", "ken wa nihongo o benkyoushi masu"],
    ["introductions-2-t1", "みせではたらきます", "mise de hataraki masu"],
    ["introductions-2-t2", "けんはえいごがわかります", "ken wa eigo ga wakari masu"],
    ["introductions-2-t3", "にほんごがわかります", "nihongo ga wakari masu"],
    ["introductions-2-t4", "みなはしゅくだいをします", "mina wa shukudai o shi masu"],
    ["introductions-2-t5", "ゆきはえいごをべんきょうします", "yuki wa eigo o benkyoushi masu"],
    ...
    ["introductions-3-m4", "ゆきはとうきょうにすみます", "yuki wa toukyou ni sumi masu"],
    ["introductions-3-m5", "おおさかにすみます", "oosaka ni sumi masu"],
    ["introductions-3-m6", "ゆきはにほんごをべんきょうします", "yuki wa nihongo o benkyoushi masu"],
    ["introductions-3-m7", "イタリアごをべんきょうします", "itariago o benkyoushi masu"],
    ["introductions-3-m8", "けんはきょうとにすみます", "ken wa kyouto ni sumi masu"],
    ["introductions-3-t1", "みなはにほんじんです", "mina wa nihonjin desu"],
    ["introductions-3-t2", "きょうとにすみます", "kyouto ni sumi masu"],
    ["introductions-3-t3", "ゆきはイタリアごをべんきょうします", "yuki wa itariago o benkyoushi masu"],
    ["introductions-3-t4", "けんはアメリカじんです", "ken wa amerikajin desu"],
    ["introductions-3-t5", "みなはおおさかにすみます", "mina wa oosaka ni sumi masu"],
    ["introductions-4-m1", "ゆきはがくせいです", "yuki wa gakusei desu"],
    ["introductions-4-m2", "けんはエンジニアです", "ken wa enjinia desu"],
    ["introductions-4-m3", "ゆきはとうきょうにすみます", "yuki wa toukyou ni sumi masu"],
    ["introductions-4-m4", "けんはかいしゃではたらきます", "ken wa kaisha de hataraki masu"],
    ["introductions-4-m5", "ゆきはにほんごをべんきょうします", "yuki wa nihongo o benkyoushi masu"],
    ["introductions-4-m6", "にほんごがわかります", "nihongo ga wakari masu"],
    ["introductions-4-m7", "しゅくだいをします", "shukudai o shi masu"],
    ["introductions-4-m8", "みなはかいしゃいんです", "mina wa kaishain desu"],
    ["introductions-4-t1", "みなはエンジニアです", "mina wa enjinia desu"],
    ["introductions-4-t2", "けんはおおさかにすみます", "ken wa oosaka ni sumi masu"],
    ["introductions-4-t3", "みなはかいしゃではたらきます", "mina wa kaisha de hataraki masu"],
    ["introductions-4-t4", "えいごがわかります", "eigo ga wakari masu"],
    ["introductions-4-t5", "みなはしゅくだいをします", "mina wa shukudai o shi masu"],
    ...
    ["essential-questions-1-m5", "なにをしますか", "nani o shi masu ka"],
    ["essential-questions-1-m6", "なにをべんきょうしますか", "nani o benkyoushi masu ka"],
    ["essential-questions-1-m7", "なにがわかりますか", "nani ga wakari masu ka"],
    ["essential-questions-1-m8", "ゆきはがくせいですか", "yuki wa gakusei desu ka"],
    ["essential-questions-1-t1", "あれはなんですか", "are wa nan desu ka"],
    ["essential-questions-1-t2", "そのひとはだれですか", "sono hito wa dare desu ka"],
    ["essential-questions-1-t3", "ゆきはなにをしますか", "yuki wa nani o shi masu ka"],
    ["essential-questions-1-t4", "けんはなにをべんきょうしますか", "ken wa nani o benkyoushi masu ka"],
    ["essential-questions-1-t5", "みなはなにがわかりますか", "mina wa nani ga wakari masu ka"],
    ...
    ["essential-questions-2-m6", "なにをしますか", "nani o shi masu ka"],
    ["essential-questions-2-m7", "なにをべんきょうしますか", "nani o benkyoushi masu ka"],
    ...
    ["essential-questions-2-t3", "ゆきはなにをしますか", "yuki wa nani o shi masu ka"],
    ["essential-questions-2-t4", "みなはなにをべんきょうしますか", "mina wa nani o benkyoushi masu ka"],
    ...
    ["essential-questions-3-m6", "なにをしますか", "nani o shi masu ka"],
    ["essential-questions-3-m7", "なにをべんきょうしますか", "nani o benkyoushi masu ka"],
    ["essential-questions-3-m8", "なにがわかりますか", "nani ga wakari masu ka"],
    ["essential-questions-3-t1", "これはいくつですか", "kore wa ikutsu desu ka"],
    ["essential-questions-3-t2", "ゆきはなにをしますか", "yuki wa nani o shi masu ka"],
    ["essential-questions-3-t3", "けんはなにをべんきょうしますか", "ken wa nani o benkyoushi masu ka"],
    ["essential-questions-3-t4", "みなはなにがわかりますか", "mina wa nani ga wakari masu ka"],
    ...
    ["essential-questions-4-m6", "なにをしますか", "nani o shi masu ka"],
    ["essential-questions-4-m7", "なにをべんきょうしますか", "nani o benkyoushi masu ka"],
    ...
    ["essential-questions-4-t5", "ゆきはなにをしますか", "yuki wa nani o shi masu ka"],
    ["actions-1-m1", "ゆきはすしをたべます", "yuki wa sushi o tabe masu"],
    ["actions-1-m2", "ラーメンをたべます", "raamen o tabe masu"],
    ["actions-1-m3", "コーヒーをのみます", "koohii o nomi masu"],
    ["actions-1-m4", "みなはおちゃをのみます", "mina wa ocha o nomi masu"],
    ["actions-1-m5", "ゆきはほんをよみます", "yuki wa hon o yomi masu"],
    ["actions-1-m6", "しんぶんをよみます", "shinbun o yomi masu"],
    ["actions-1-m7", "けんはパンをたべます", "ken wa pan o tabe masu"],
    ["actions-1-m8", "みずをのみます", "mizu o nomi masu"],
    ["actions-1-t1", "みなはてがみをよみます", "mina wa tegami o yomi masu"],
    ["actions-1-t2", "すしをたべます", "sushi o tabe masu"],
    ["actions-1-t3", "けんはコーヒーをのみます", "ken wa koohii o nomi masu"],
    ["actions-1-t4", "ほんをよみます", "hon o yomi masu"],
    ["actions-1-t5", "みなはラーメンをたべます", "mina wa raamen o tabe masu"],
    ["actions-2-m1", "ゆきはえきにいきます", "yuki wa eki ni iki masu"],
    ["actions-2-m2", "がっこうにいきます", "gakkou ni iki masu"],
    ["actions-2-m3", "みなはとしょかんにきます", "mina wa toshokan ni ki masu"],
    ["actions-2-m4", "カフェにきます", "kafe ni ki masu"],
    ["actions-2-m5", "けんはみせにいきます", "ken wa mise ni iki masu"],
    ["actions-2-m6", "こうえんにきます", "kouen ni ki masu"],
    ["actions-2-m7", "けんはかいしゃではたらきます", "ken wa kaisha de hataraki masu"],
    ["actions-2-m8", "レストランではたらきます", "resutoran de hataraki masu"],
    ["actions-2-t1", "みせにいきます", "mise ni iki masu"],
    ["actions-2-t2", "ゆきはとしょかんにきます", "yuki wa toshokan ni ki masu"],
    ["actions-2-t3", "みなはえきにいきます", "mina wa eki ni iki masu"],
    ["actions-2-t4", "レストランにいきます", "resutoran ni iki masu"],
    ["actions-2-t5", "みなはかいしゃではたらきます", "mina wa kaisha de hataraki masu"],
    ["actions-3-m1", "ゆきはともだちといきます", "yuki wa tomodachi to iki masu"],
    ["actions-3-m2", "クラスメートといきます", "kurasumeeto to iki masu"],
    ["actions-3-m3", "みなはせんせいにききます", "mina wa sensei ni kiki masu"],
    ["actions-3-m4", "てんいんにききます", "ten'in ni kiki masu"],
    ["actions-3-m5", "けんはほんをかいます", "ken wa hon o kai masu"],
    ["actions-3-m6", "パンをかいます", "pan o kai masu"],
    ["actions-3-m7", "けんはともだちといきます", "ken wa tomodachi to iki masu"],
    ["actions-3-m8", "コーヒーをかいます", "koohii o kai masu"],
    ["actions-3-t1", "みなはクラスメートといきます", "mina wa kurasumeeto to iki masu"],
    ["actions-3-t2", "せんせいにききます", "sensei ni kiki masu"],
    ["actions-3-t3", "みなはしんぶんをかいます", "mina wa shinbun o kai masu"],
    ["actions-3-t4", "ともだちといきます", "tomodachi to iki masu"],
    ["actions-3-t5", "ほんをかいます", "hon o kai masu"],
    ["actions-4-m1", "ゆきはえいがをみます", "yuki wa eiga o mi masu"],
    ["actions-4-m2", "テレビをみます", "terebi o mi masu"],
    ["actions-4-m3", "みなはおんがくをききます", "mina wa ongaku o kiki masu"],
    ["actions-4-m4", "おんがくをききます", "ongaku o kiki masu"],
    ["actions-4-m5", "けんはてがみをかきます", "ken wa tegami o kaki masu"],
    ["actions-4-m6", "てがみをかきます", "tegami o kaki masu"],
    ["actions-4-m7", "ゆきはほんをよみます", "yuki wa hon o yomi masu"],
    ["actions-4-m8", "えいがをみます", "eiga o mi masu"],
    ["actions-4-t1", "けんはおんがくをききます", "ken wa ongaku o kiki masu"],
    ["actions-4-t2", "みなはテレビをみます", "mina wa terebi o mi masu"],
    ["actions-4-t3", "ゆきはてがみをかきます", "yuki wa tegami o kaki masu"],
    ["actions-4-t4", "しんぶんをよみます", "shinbun o yomi masu"],
    ["actions-4-t5", "みなはえいがをみます", "mina wa eiga o mi masu"],
];
