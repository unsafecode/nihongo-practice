...
const lesson1: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "existence-needs-1-m2", family: EXIST, context: "a1-context-home", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-learner", slots: exist("a1-value-ex-book", ARU, "a1-value-loc-school"), translation: L("There is a book at school.", "C'è un libro a scuola.") },
    ...
    { id: "existence-needs-1-m4", family: EXIST, context: "a1-context-home", subjectReferent: CREATURE, subjectRealization: "explicit", speakerRole: "a1-role-learner", slots: exist("a1-value-ex-cat", IRU, "a1-value-loc-cafe"), translation: L("There is a cat at the café.", "C'è un gatto al bar.") },
    { id: "existence-needs-1-m5", family: EXIST, context: "a1-context-classroom", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-ken", slots: exist("a1-value-ex-flower", ARU), translation: L("There is a flower.", "C'è un fiore.") },
    ...
    { id: "existence-needs-1-m8", family: EXIST, context: "a1-context-classroom", subjectReferent: CREATURE, subjectRealization: "explicit", speakerRole: "a1-role-learner", slots: exist("a1-value-ex-bird", IRU), translation: L("There is a bird.", "C'è un uccello.") },
  ],
  transfers: [
    { id: "existence-needs-1-t1", family: EXIST, context: "a1-context-home", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-learner", slots: exist("a1-value-ex-book", ARU, "a1-value-loc-cafe"), translation: L("There is a book at the café.", "C'è un libro al bar.") },
    { id: "existence-needs-1-t2", family: EXIST, context: "a1-context-home", subjectReferent: CREATURE, subjectRealization: "explicit", speakerRole: "a1-role-yuki", slots: exist("a1-value-ex-cat", IRU, "a1-value-loc-cafe"), translation: L("There is a cat at the café.", "C'è un gatto al bar.") },
    { id: "existence-needs-1-t3", family: EXIST, context: "a1-context-classroom", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-learner", slots: exist("a1-value-ex-flower", ARU, "a1-value-loc-school"), translation: L("There is a flower at school.", "C'è un fiore a scuola.") },
    { id: "existence-needs-1-t4", family: EXIST, context: "a1-context-town", subjectReferent: CREATURE, subjectRealization: "explicit", speakerRole: "a1-role-friend", slots: exist("a1-value-ex-dog", IRU, "a1-value-loc-cafe"), translation: L("There is a dog at the café.", "C'è un cane al bar.") },
    { id: "existence-needs-1-t5", family: EXIST, context: "a1-context-classroom", subjectReferent: CREATURE, subjectRealization: "explicit", speakerRole: "a1-role-classmate", slots: exist("a1-value-ex-bird", IRU, "a1-value-loc-school"), translation: L("There is a bird at school.", "C'è un uccello a scuola.") },
  ],
});
...
const lesson3: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "existence-needs-3-m2", family: PREF, context: "a1-context-cafe", subjectReferent: SELF, subjectRealization: "omitted", slots: pref("a1-value-watashi", "a1-value-want", "a1-value-obj-medicine"), translation: L("I want medicine.", "Voglio della medicina.") },
    { id: "existence-needs-3-m3", family: PREF, context: "a1-context-station", subjectReferent: SELF, subjectRealization: "explicit", slots: pref("a1-value-watashi", "a1-value-want", "a1-value-obj-passport"), translation: L("I want a passport.", "Voglio un passaporto.") },
    ...
    { id: "existence-needs-3-m8", family: PREF, context: "a1-context-shop", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", interrogative: true, slots: pref("a1-value-yuki", "a1-value-want", "a1-value-obj-passport"), translation: L("Does Yuki want a passport?", "Yuki vuole un passaporto?") },
  ],
  transfers: [
...
// ---------------------------------------------------------------------------
// Lesson existence-needs-4 — locate and resolve with practical travel items
// ---------------------------------------------------------------------------
...
const lesson4: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  introducedSenseIds: [],
  models: [
    { id: "existence-needs-4-m1", family: EXIST, context: "a1-context-home", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-learner", slots: exist("a1-value-ex-umbrella", ARU, "a1-value-loc-on-desk"), translation: L("The umbrella is on the desk.", "L'ombrello è sulla scrivania.") },
    ...
    { id: "existence-needs-4-m3", family: PREF, context: "a1-context-station", subjectReferent: SELF, subjectRealization: "explicit", slots: pref("a1-value-watashi", "a1-value-want", "a1-value-obj-map"), translation: L("I want a map.", "Voglio una mappa.") },
    { id: "existence-needs-4-m4", family: EXIST, context: "a1-context-home", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-ken", slots: exist("a1-value-ex-phone", ARU, "a1-value-loc-in-bag"), translation: L("The mobile phone is in the bag.", "Il telefono cellulare è nella borsa.") },
    ...
    { id: "existence-needs-4-m6", family: PREF, context: "a1-context-shop", subjectReferent: SELF, subjectRealization: "explicit", slots: pref("a1-value-watashi", "a1-value-want", "a1-value-obj-dictionary"), translation: L("I want a dictionary.", "Voglio un dizionario.") },
  ...
  transfers: [
    { id: "existence-needs-4-t1", family: EXIST, context: "a1-context-home", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-learner", slots: exist("a1-value-ex-umbrella", ARU, "a1-value-loc-in-bag"), translation: L("The umbrella is in the bag.", "L'ombrello è nella borsa.") },
    ...
    { id: "existence-needs-4-t3", family: EXIST, context: "a1-context-home", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-learner", slots: exist("a1-value-ex-phone", ARU, "a1-value-loc-on-desk"), translation: L("The mobile phone is on the desk.", "Il telefono cellulare è sulla scrivania.") },
