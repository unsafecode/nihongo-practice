...
const EXPECTED_SENTENCES: readonly (readonly [string, string, string])[] = [
  ...
  ["routines-2-m7", "げつようびにでかけます", "getsuyoubi ni dekakemasu"],
  ...
  ["past-negative-1-m5", "みなはクラスメートといきました", "mina wa kurasumeeto to ikimashita"],
  ...
  ["past-negative-1-t3", "クラスメートといきました", "kurasumeeto to ikimashita"],
  ...
  ["people-3-m2", "ゆきはこどもといきます", "yuki wa kodomo to ikimasu"],
  ...
  ["people-3-t2", "こどもといきます", "kodomo to ikimasu"],
  ...
  ["people-4-m1", "ラーメンをかいます", "raamen o kaimasu"],
