...
const lesson4: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: withSpeakers([
    ...
    q({ id: "essential-questions-4-m2", family: "a1-family-topic-copular", context: "a1-context-first-meeting", subjectReferent: "a1-referent-person", subjectRealization: "explicit", slots: copQ("a1-value-ano-hito", "a1-value-q-dare"), translation: L("Who is that person over there?", "Chi è quella persona là?") }),
