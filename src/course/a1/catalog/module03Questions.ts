...
const lesson1: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: withSpeakers([
    ...
    q({ id: "essential-questions-1-m3", family: "a1-family-topic-copular", context: "a1-context-classroom", subjectReferent: "a1-referent-thing", subjectRealization: "explicit", slots: copQ("a1-value-kore", "a1-value-q-nani"), translation: L("What is this, exactly?", "Che cos'è esattamente questo?") }),
    q({ id: "essential-questions-1-m4", family: "a1-family-topic-copular", context: "a1-context-classroom", subjectReferent: "a1-referent-thing", subjectRealization: "explicit", slots: copQ("a1-value-sore", "a1-value-q-nani"), translation: L("What is that, exactly?", "Che cos'è esattamente quello?") }),
...
const lesson2: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: withSpeakers([
    ...
    q({ id: "essential-questions-2-m3", family: "a1-family-topic-copular", context: "a1-context-first-meeting", subjectReferent: "a1-referent-person", subjectRealization: "explicit", slots: copQ("a1-value-ano-hito", "a1-value-q-dare"), translation: L("Who is that person over there?", "Chi è quella persona laggiù?") }),
...
const lesson4: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: withSpeakers([
    q({ id: "essential-questions-4-m1", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-self", subjectRealization: "omitted", slots: actQ("a1-value-watashi", "a1-value-obj-japanese"), translation: L("Do you understand Japanese?", "Capisci il giapponese?") }),
    q({ id: "essential-questions-4-m2", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: actQ("a1-value-yuki", "a1-value-obj-english"), translation: L("Does Yuki understand English?", "Yuki capisce l'inglese?") }),
    q({ id: "essential-questions-4-m3", family: "a1-family-nominative-action", context: "a1-context-first-meeting", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: actQ("a1-value-ken", "a1-value-obj-italian"), translation: L("Does Ken understand Italian?", "Ken capisce l'italiano?") }),
    q({ id: "essential-questions-4-m4", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", slots: actQ("a1-value-mina", "a1-value-obj-japanese"), translation: L("Does Mina understand Japanese?", "Mina capisce il giapponese?") }),
