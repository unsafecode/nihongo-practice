...
const lesson1: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  introducedSenseIds: ["a1-sense-be", "a1-sense-understand"],
  models: withSpeakers([
    ...
    q({ id: "essential-questions-1-m3", family: "a1-family-nominative-action", context: "a1-context-first-meeting", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: actQ("a1-value-yuki", "a1-value-understand", "a1-value-q-nani"), translation: L("What does Yuki understand?", "Che cosa capisce Yuki?") }),
    q({ id: "essential-questions-1-m4", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: actQ("a1-value-ken", "a1-value-understand", "a1-value-q-nani"), translation: L("What does Ken understand?", "Che cosa capisce Ken?") }),
    q({ id: "essential-questions-1-m5", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-self", subjectRealization: "omitted", slots: actQ("a1-value-watashi", "a1-value-understand", "a1-value-q-nani"), translation: L("What do you understand?", "Che cosa capisci?") }),
    q({ id: "essential-questions-1-m6", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-self", subjectRealization: "explicit", slots: actQ("a1-value-watashi", "a1-value-understand", "a1-value-q-nani"), translation: L("What do you understand?", "Che cosa capisci?") }),
    q({ id: "essential-questions-1-m7", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: actQ("a1-value-yuki", "a1-value-understand", "a1-value-q-nani"), translation: L("What does Yuki understand?", "Che cosa capisce Yuki?") }),
    q({ id: "essential-questions-1-m8", family: "a1-family-nominative-action", context: "a1-context-first-meeting", subjectReferent: "a1-referent-teacher", subjectRealization: "explicit", slots: actQ("a1-value-teacher-subject", "a1-value-understand", "a1-value-q-nani"), translation: L("What does the teacher understand?", "Che cosa capisce l'insegnante?") }),
  ], L1_SPEAKERS),
  transfers: [
    q({ id: "essential-questions-1-t1", family: "a1-family-topic-copular", context: "a1-context-shop", subjectReferent: "a1-referent-thing", subjectRealization: "explicit", slots: ynQ("a1-value-sore", "a1-value-obj-teacher"), translation: L("Is that a teacher?", "Quello è un insegnante?") }),
    q({ id: "essential-questions-1-t2", family: "a1-family-topic-copular", context: "a1-context-first-meeting", subjectReferent: "a1-referent-thing", subjectRealization: "omitted", slots: ynQ("a1-value-kore", "a1-value-obj-student"), translation: L("Is this a student?", "Questo è uno studente?") }),
    q({ id: "essential-questions-1-t3", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: actQ("a1-value-ken", "a1-value-understand", "a1-value-q-nani"), translation: L("What does Ken understand?", "Che cosa capisce Ken?") }),
    q({ id: "essential-questions-1-t4", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-teacher", subjectRealization: "explicit", slots: actQ("a1-value-teacher-subject", "a1-value-understand", "a1-value-q-nani"), translation: L("What does the teacher understand?", "Che cosa capisce l'insegnante?") }),
...
const lesson2: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: withSpeakers([
    ...
    q({ id: "essential-questions-2-m4", family: "a1-family-topic-copular", context: "a1-context-first-meeting", subjectReferent: "a1-referent-classmate", subjectRealization: "explicit", slots: copQ("a1-value-classmate-subject", "a1-value-q-dare"), translation: L("Who is the classmate?", "Chi è il compagno di classe?") }),
    q({ id: "essential-questions-2-m5", family: "a1-family-nominative-action", context: "a1-context-shop", subjectReferent: "a1-referent-self", subjectRealization: "omitted", slots: actQ("a1-value-watashi", "a1-value-understand", "a1-value-q-nani"), translation: L("What do you understand?", "Che cosa capisci?") }),
    q({ id: "essential-questions-2-m6", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-self", subjectRealization: "omitted", slots: actQ("a1-value-watashi", "a1-value-understand", "a1-value-q-nani"), translation: L("What do you understand?", "Che cosa capisci?") }),
    q({ id: "essential-questions-2-m7", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-teacher", subjectRealization: "explicit", slots: actQ("a1-value-teacher-subject", "a1-value-understand", "a1-value-q-nani"), translation: L("What does the teacher understand?", "Che cosa capisce l'insegnante?") }),
    q({ id: "essential-questions-2-m8", family: "a1-family-nominative-action", context: "a1-context-first-meeting", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: actQ("a1-value-ken", "a1-value-understand", "a1-value-q-nani"), translation: L("What does Ken understand?", "Che cosa capisce Ken?") }),
  ], L2_SPEAKERS),
  transfers: [
    ...
    q({ id: "essential-questions-2-t2", family: "a1-family-topic-copular", context: "a1-context-classroom", subjectReferent: "a1-referent-thing", subjectRealization: "omitted", slots: copQ("a1-value-kore", "a1-value-q-nan"), translation: L("What is this?", "Che cos'è questo?") }),
    q({ id: "essential-questions-2-t3", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: actQ("a1-value-yuki", "a1-value-understand", "a1-value-q-nani"), translation: L("What does Yuki understand?", "Che cosa capisce Yuki?") }),
    q({ id: "essential-questions-2-t4", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", slots: actQ("a1-value-mina", "a1-value-understand", "a1-value-q-nani"), translation: L("What does Mina understand?", "Che cosa capisce Mina?") }),
...
const lesson3: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: withSpeakers([
    ...
    q({ id: "essential-questions-3-m5", family: "a1-family-topic-copular", context: "a1-context-shop", subjectReferent: "a1-referent-thing", subjectRealization: "explicit", slots: copQ("a1-value-kore", "a1-value-q-ikura"), translation: L("How much is this?", "Quanto costa questo?") }),
    q({ id: "essential-questions-3-m6", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-self", subjectRealization: "omitted", slots: actQ("a1-value-watashi", "a1-value-understand", "a1-value-q-nani"), translation: L("What do you understand?", "Cosa capisci?") }),
    q({ id: "essential-questions-3-m7", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-self", subjectRealization: "omitted", slots: actQ("a1-value-watashi", "a1-value-understand", "a1-value-q-nani"), translation: L("What do you understand?", "Che cosa capisci?") }),
    q({ id: "essential-questions-3-m8", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: actQ("a1-value-ken", "a1-value-understand", "a1-value-q-nani"), translation: L("What does Ken understand?", "Che cosa capisce Ken?") }),
  ], L3_SPEAKERS),
  transfers: [
    ...
    q({ id: "essential-questions-3-t2", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: actQ("a1-value-yuki", "a1-value-understand", "a1-value-q-nani"), translation: L("What does Yuki understand?", "Che cosa capisce Yuki?") }),
    q({ id: "essential-questions-3-t3", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: actQ("a1-value-ken", "a1-value-understand", "a1-value-q-nani"), translation: L("What does Ken understand?", "Che cosa capisce Ken?") }),
...
const lesson4: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: withSpeakers([
    ...
    q({ id: "essential-questions-4-m2", family: "a1-family-topic-copular", context: "a1-context-first-meeting", subjectReferent: "a1-referent-person", subjectRealization: "explicit", slots: ynQ("a1-value-ano-hito", "a1-value-companion-child"), translation: L("Is that person a child?", "Quella persona è un bambino?") }),
    ...
    q({ id: "essential-questions-4-m4", family: "a1-family-topic-copular", context: "a1-context-shop", subjectReferent: "a1-referent-thing", subjectRealization: "explicit", slots: copQ("a1-value-mikan-subject", "a1-value-q-dore"), translation: L("Which one is the tangerine?", "Qual è il mandarino?") }),
    q({ id: "essential-questions-4-m5", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: actQ("a1-value-yuki", "a1-value-understand", "a1-value-q-nani"), translation: L("What does Yuki understand?", "Che cosa capisce Yuki?") }),
    q({ id: "essential-questions-4-m6", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-self", subjectRealization: "omitted", slots: actQ("a1-value-watashi", "a1-value-understand", "a1-value-q-nani"), translation: L("What do you understand?", "Che cosa capisci?") }),
    q({ id: "essential-questions-4-m7", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: actQ("a1-value-ken", "a1-value-understand", "a1-value-q-nani"), translation: L("What does Ken understand?", "Che cosa capisce Ken?") }),
  ...
  transfers: [
    ...
    q({ id: "essential-questions-4-t5", family: "a1-family-nominative-action", context: "a1-context-classroom", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: actQ("a1-value-yuki", "a1-value-understand", "a1-value-q-nani"), translation: L("What does Yuki understand?", "Che cosa capisce Yuki?") }),
  ],
});
