...
const lesson1: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: withSpeakers([
    ...
    q({ id: "essential-questions-1-m3", family: "a1-family-topic-copular", context: "a1-context-first-meeting", subjectReferent: "a1-referent-person", subjectRealization: "explicit", slots: copQ("a1-value-ano-hito", "a1-value-q-dare"), translation: L("Who is that person?", "Chi è quella persona?") }),
    ...
    q({ id: "essential-questions-1-m8", family: "a1-family-topic-copular", context: "a1-context-first-meeting", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: ynQ("a1-value-yuki", "a1-value-obj-student"), translation: L("Is Yuki a student?", "Yuki è uno studente?") }),
  ], L1_SPEAKERS),
  transfers: [
    q({ id: "essential-questions-1-t1", family: "a1-family-topic-copular", context: "a1-context-shop", subjectReferent: "a1-referent-thing", subjectRealization: "explicit", slots: copQ("a1-value-are", "a1-value-q-nan"), translation: L("What is that over there?", "Che cos'è quello là?") }),
    q({ id: "essential-questions-1-t2", family: "a1-family-topic-copular", context: "a1-context-first-meeting", subjectReferent: "a1-referent-person", subjectRealization: "explicit", slots: copQ("a1-value-sono-hito", "a1-value-q-dare"), translation: L("Who is that person?", "Chi è quella persona?") }),
...
const lesson2: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: withSpeakers([
    ...
    q({ id: "essential-questions-2-m3", family: "a1-family-topic-copular", context: "a1-context-first-meeting", subjectReferent: "a1-referent-person", subjectRealization: "explicit", slots: copQ("a1-value-ano-hito", "a1-value-q-dare"), translation: L("Who is that person?", "Chi è quella persona?") }),
  ...
  transfers: [
    ...
    q({ id: "essential-questions-2-t5", family: "a1-family-topic-copular", context: "a1-context-first-meeting", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", slots: ynQ("a1-value-mina", "a1-value-obj-student"), translation: L("Is Mina a student?", "Mina è uno studente?") }),
  ],
});
...
const lesson4: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  introducedSenseIds: ["a1-sense-be", "a1-sense-do", "a1-sense-study"],
  models: withSpeakers([
    q({ id: "essential-questions-4-m1", family: "a1-family-topic-copular", context: "a1-context-shop", subjectReferent: "a1-referent-thing", subjectRealization: "explicit", slots: copQ("a1-value-kore", "a1-value-q-nan"), translation: L("What is this?", "Che cos'è questo?") }),
    q({ id: "essential-questions-4-m2", family: "a1-family-topic-copular", context: "a1-context-first-meeting", subjectReferent: "a1-referent-person", subjectRealization: "explicit", slots: copQ("a1-value-ano-hito", "a1-value-q-dare"), translation: L("Who is that person?", "Chi è quella persona?") }),
    ...
    q({ id: "essential-questions-4-m4", family: "a1-family-topic-copular", context: "a1-context-shop", subjectReferent: "a1-referent-thing", subjectRealization: "explicit", slots: copQ("a1-value-kore", "a1-value-q-ikura"), translation: L("How much is this?", "Quanto costa questo?") }),
    q({ id: "essential-questions-4-m5", family: "a1-family-topic-copular", context: "a1-context-cafe", subjectReferent: "a1-referent-thing", subjectRealization: "explicit", slots: copQ("a1-value-paatii-subject", "a1-value-q-itsu"), translation: L("When is the party?", "Quand'è la festa?") }),
    ...
    q({ id: "essential-questions-4-m8", family: "a1-family-topic-copular", context: "a1-context-first-meeting", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: ynQ("a1-value-yuki", "a1-value-obj-student"), translation: L("Is Yuki a student?", "Yuki è uno studente?") }),
  ], L4_SPEAKERS),
  transfers: [
    ...
    q({ id: "essential-questions-4-t2", family: "a1-family-topic-copular", context: "a1-context-first-meeting", subjectReferent: "a1-referent-person", subjectRealization: "explicit", slots: copQ("a1-value-sono-hito", "a1-value-q-dare"), translation: L("Who is that person?", "Chi è quella persona?") }),
