...
const lesson2: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "shopping-2-m4", family: QUANT, context: "a1-context-cafe", subjectReferent: SELF, subjectRealization: "omitted", slots: qa("a1-value-watashi", "a1-value-drink", "a1-value-obj-water", "a1-value-qty-2"), translation: L("I drink two waters.", "Bevo due acque.") },
  ...
  transfers: [
    ...
    { id: "shopping-2-t3", family: QUANT, context: "a1-context-cafe", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: qa("a1-value-yuki", "a1-value-drink", "a1-value-obj-coffee", "a1-value-qty-2"), translation: L("Yuki drinks two coffees.", "Yuki beve due caffè.") },
