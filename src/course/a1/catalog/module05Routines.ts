...
const lesson2: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    { id: "routines-2-m1", family: SCHED, context: "a1-context-classroom", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-study-routine", "a1-value-day-monday"), translation: L("I study on Monday.", "Studio il lunedì.") },
    { id: "routines-2-m2", family: SCHED, context: "a1-context-classroom", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: timed("a1-value-yuki", "a1-value-study-routine", "a1-value-day-wednesday"), translation: L("Yuki studies on Wednesday.", "Yuki studia il mercoledì.") },
    { id: "routines-2-m3", family: ADV, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-eat-routine", "a1-value-seq-morning"), translation: L("I eat in the morning.", "Mangio la mattina.") },
    { id: "routines-2-m4", family: ADV, context: "a1-context-home", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", slots: timed("a1-value-mina", "a1-value-eat-routine", "a1-value-seq-night"), translation: L("Mina eats at night.", "Mina mangia la sera.") },
    { id: "routines-2-m5", family: ADV, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-read-routine", "a1-value-seq-night"), translation: L("I read at night.", "Leggo la sera.") },
    { id: "routines-2-m6", family: SCHED, context: "a1-context-classroom", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: timed("a1-value-ken", "a1-value-read-routine", "a1-value-day-sunday"), translation: L("Ken reads on Sunday.", "Ken legge la domenica.") },
  ...
  transfers: [
    { id: "routines-2-t1", family: SCHED, context: "a1-context-classroom", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", slots: timed("a1-value-mina", "a1-value-study-routine", "a1-value-day-monday"), translation: L("Mina studies on Monday.", "Mina studia il lunedì.") },
    { id: "routines-2-t2", family: ADV, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-eat-routine", "a1-value-seq-night"), translation: L("I eat at night.", "Mangio la sera.") },
    { id: "routines-2-t3", family: ADV, context: "a1-context-home", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: timed("a1-value-ken", "a1-value-read-routine", "a1-value-seq-night"), translation: L("Ken reads at night.", "Ken legge la sera.") },
    { id: "routines-2-t4", family: SCHED, context: "a1-context-classroom", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-read-routine", "a1-value-day-sunday"), translation: L("I read on Sunday.", "Leggo la domenica.") },
...
const lesson3: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    { id: "routines-3-m1", family: ADV, context: "a1-context-classroom", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-study-routine", "a1-value-freq-everyday"), translation: L("I study every day.", "Studio ogni giorno.") },
    { id: "routines-3-m2", family: ADV, context: "a1-context-classroom", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: timed("a1-value-yuki", "a1-value-study-routine", "a1-value-freq-often"), translation: L("Yuki often studies.", "Yuki studia spesso.") },
    { id: "routines-3-m3", family: ADV, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-read-routine", "a1-value-freq-often"), translation: L("I often read.", "Leggo spesso.") },
    { id: "routines-3-m4", family: ADV, context: "a1-context-home", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: timed("a1-value-ken", "a1-value-read-routine", "a1-value-freq-sometimes"), translation: L("Ken sometimes reads.", "Ken legge a volte.") },
    { id: "routines-3-m5", family: ADV, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-eat-routine", "a1-value-freq-everyday"), translation: L("I eat every day.", "Mangio ogni giorno.") },
    ...
    { id: "routines-3-m8", family: ADV, context: "a1-context-classroom", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: timed("a1-value-yuki", "a1-value-study-routine", "a1-value-freq-always"), translation: L("Yuki always studies.", "Yuki studia sempre.") },
  ],
  transfers: [
    { id: "routines-3-t1", family: ADV, context: "a1-context-classroom", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", slots: timed("a1-value-mina", "a1-value-study-routine", "a1-value-freq-everyday"), translation: L("Mina studies every day.", "Mina studia ogni giorno.") },
    { id: "routines-3-t2", family: ADV, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-read-routine", "a1-value-freq-everyday"), translation: L("I read every day.", "Leggo ogni giorno.") },
    { id: "routines-3-t3", family: ADV, context: "a1-context-home", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: timed("a1-value-ken", "a1-value-eat-routine", "a1-value-freq-often"), translation: L("Ken often eats.", "Ken mangia spesso.") },
...
const lesson4: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "routines-4-m4", family: ADV, context: "a1-context-classroom", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-study-routine", "a1-value-freq-everyday"), translation: L("I study every day.", "Studio ogni giorno.") },
