...
const lesson1: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "routines-1-m7", family: SCHED, context: "a1-context-home", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: timed("a1-value-yuki", "a1-value-return", "a1-value-time-9"), translation: L("Yuki comes home at nine.", "Yuki torna a casa alle nove.") },
    { id: "routines-1-m8", family: SCHED, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-go-out", "a1-value-time-6"), translation: L("I go out at six.", "Esco alle sei.") },
  ],
  transfers: [
    ...
    { id: "routines-1-t2", family: SCHED, context: "a1-context-town", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", slots: timed("a1-value-mina", "a1-value-go-out", "a1-value-time-6"), translation: L("Mina goes out at six.", "Mina esce alle sei.") },
    { id: "routines-1-t3", family: SCHED, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-return", "a1-value-time-9"), translation: L("I come home at nine.", "Torno a casa alle nove.") },
    ...
    { id: "routines-1-t5", family: SCHED, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-wake", "a1-value-time-6"), translation: L("I wake up at six.", "Mi sveglio alle sei.") },
  ],
});
...
const lesson2: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    { id: "routines-2-m1", family: SCHED, context: "a1-context-routine-study-schedule", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-study-routine", "a1-value-day-monday"), translation: L("I study on Monday.", "Studio il lunedì.") },
    { id: "routines-2-m2", family: SCHED, context: "a1-context-routine-study-schedule", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: timed("a1-value-yuki", "a1-value-study-routine", "a1-value-day-wednesday"), translation: L("Yuki studies on Wednesday.", "Yuki studia il mercoledì.") },
  ...
  transfers: [
    { id: "routines-2-t1", family: SCHED, context: "a1-context-routine-study-schedule", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", slots: timed("a1-value-mina", "a1-value-study-routine", "a1-value-day-monday"), translation: L("Mina studies on Monday.", "Mina studia il lunedì.") },
    { id: "routines-2-t2", family: ADV, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-eat-routine", "a1-value-seq-morning"), translation: L("I eat in the morning.", "Mangio la mattina.") },
    { id: "routines-2-t3", family: ADV, context: "a1-context-evening-reading", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: timed("a1-value-ken", "a1-value-read-routine", "a1-value-seq-morning"), translation: L("Ken reads in the morning.", "Ken legge la mattina.") },
    { id: "routines-2-t4", family: SCHED, context: "a1-context-evening-reading", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-read-routine", "a1-value-day-monday"), translation: L("I read on Monday.", "Leggo il lunedì.") },
...
const lesson3: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    { id: "routines-3-m1", family: ADV, context: "a1-context-routine-study-schedule", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-study-routine", "a1-value-freq-everyday"), translation: L("I study every day.", "Studio ogni giorno.") },
    { id: "routines-3-m2", family: ADV, context: "a1-context-routine-study-schedule", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: timed("a1-value-yuki", "a1-value-study-routine", "a1-value-freq-often"), translation: L("Yuki often studies.", "Yuki studia spesso.") },
    ...
    { id: "routines-3-m7", family: ADV, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-wake", "a1-value-freq-everyday"), translation: L("I wake up every day.", "Mi sveglio ogni giorno.") },
    { id: "routines-3-m8", family: ADV, context: "a1-context-routine-study-schedule", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: timed("a1-value-yuki", "a1-value-study-routine", "a1-value-freq-always"), translation: L("Yuki always studies.", "Yuki studia sempre.") },
  ],
  transfers: [
    { id: "routines-3-t1", family: ADV, context: "a1-context-routine-study-schedule", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", slots: timed("a1-value-mina", "a1-value-study-routine", "a1-value-freq-everyday"), translation: L("Mina studies every day.", "Mina studia ogni giorno.") },
    ...
    { id: "routines-3-t5", family: ADV, context: "a1-context-home", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: timed("a1-value-yuki", "a1-value-wake", "a1-value-freq-everyday"), translation: L("Yuki wakes up every day.", "Yuki si sveglia ogni giorno.") },
  ],
});
...
const lesson4: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "routines-4-m2", family: BARE, context: "a1-context-bare-study-conversation", subjectReferent: SELF, subjectRealization: "omitted", slots: bare(WATASHI, "a1-value-study-bare"), translation: L("I study.", "Studio.") },
