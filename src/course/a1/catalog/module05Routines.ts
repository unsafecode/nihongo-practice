...
const lesson4: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "routines-4-m4", family: ADV, context: "a1-context-weekday-study", subjectReferent: SELF, subjectRealization: "omitted", slots: timed(WATASHI, "a1-value-study-routine", "a1-value-freq-every-morning"), translation: L("I study every morning.", "Studio ogni mattina.") },
