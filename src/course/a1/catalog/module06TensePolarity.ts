...
const lesson1: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    { id: "past-negative-1-m1", family: OBJ, context: "a1-context-cafe", subjectReferent: SELF, subjectRealization: "omitted", form: A1_AFFIRMATIVE_PAST_POLITE, slots: obj(WATASHI, "a1-value-eat", "a1-value-obj-sushi"), translation: L("I ate sushi.", "Ho mangiato il sushi.") },
    ...
    { id: "past-negative-1-m3", family: OBJ, context: "a1-context-shop", subjectReferent: SELF, subjectRealization: "omitted", form: A1_AFFIRMATIVE_PAST_POLITE, slots: obj(WATASHI, "a1-value-buy", "a1-value-obj-book"), translation: L("I bought a book.", "Ho comprato un libro.") },
    ...
    { id: "past-negative-1-m8", family: SCHED, context: "a1-context-town", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", form: A1_AFFIRMATIVE_PAST_POLITE, slots: timed("a1-value-ken", "a1-value-return", "a1-value-time-6"), translation: L("Ken came home at six.", "Ken è tornato a casa alle sei.") },
  ],
  transfers: [
    { id: "past-negative-1-t1", family: OBJ, context: "a1-context-cafe", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", form: A1_AFFIRMATIVE_PAST_POLITE, slots: obj("a1-value-ken", "a1-value-eat", "a1-value-obj-sushi"), translation: L("Ken ate sushi.", "Ken ha mangiato il sushi.") },
    { id: "past-negative-1-t2", family: OBJ, context: "a1-context-shop", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", form: A1_AFFIRMATIVE_PAST_POLITE, slots: obj("a1-value-mina", "a1-value-buy", "a1-value-obj-book"), translation: L("Mina bought a book.", "Mina ha comprato un libro.") },
    ...
    { id: "past-negative-1-t5", family: SCHED, context: "a1-context-town", subjectReferent: SELF, subjectRealization: "omitted", form: A1_AFFIRMATIVE_PAST_POLITE, slots: timed(WATASHI, "a1-value-return", "a1-value-time-6"), translation: L("I came home at six.", "Sono tornato a casa alle sei.") },
  ],
});
...
const lesson2: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    { id: "past-negative-2-m1", family: OBJ, context: "a1-context-cafe", subjectReferent: SELF, subjectRealization: "omitted", form: A1_NEGATIVE_PRESENT_POLITE, slots: obj(WATASHI, "a1-value-drink", "a1-value-obj-coffee"), translation: L("I don't drink coffee.", "Non bevo il caffè.") },
    { id: "past-negative-2-m2", family: LOCF, context: "a1-context-workplace", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", form: A1_NEGATIVE_PRESENT_POLITE, slots: loc("a1-value-yuki", "a1-value-work", "a1-value-loc-company"), translation: L("Yuki doesn't work at the company.", "Yuki non lavora in azienda.") },
    ...
    { id: "past-negative-2-m7", family: SCHED, context: "a1-context-town", subjectReferent: SELF, subjectRealization: "omitted", form: A1_NEGATIVE_PRESENT_POLITE, slots: timed(WATASHI, "a1-value-go-out", "a1-value-time-8"), translation: L("I don't go out at eight.", "Non esco alle otto.") },
    { id: "past-negative-2-m8", family: SCHED, context: "a1-context-town", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", form: A1_NEGATIVE_PRESENT_POLITE, slots: timed("a1-value-mina", "a1-value-return", "a1-value-time-6"), translation: L("Mina doesn't come home at six.", "Mina non torna a casa alle sei.") },
  ],
  transfers: [
    { id: "past-negative-2-t1", family: OBJ, context: "a1-context-cafe", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", form: A1_NEGATIVE_PRESENT_POLITE, slots: obj("a1-value-ken", "a1-value-drink", "a1-value-obj-coffee"), translation: L("Ken doesn't drink coffee.", "Ken non beve il caffè.") },
    ...
    { id: "past-negative-2-t5", family: SCHED, context: "a1-context-town", subjectReferent: SELF, subjectRealization: "omitted", form: A1_NEGATIVE_PRESENT_POLITE, slots: timed(WATASHI, "a1-value-return", "a1-value-time-6"), translation: L("I don't come home at six.", "Non torno a casa alle sei.") },
  ],
});
...
const lesson3: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    { id: "past-negative-3-m1", family: OBJ, context: "a1-context-classroom", subjectReferent: SELF, subjectRealization: "omitted", form: A1_NEGATIVE_PAST_POLITE, slots: obj(WATASHI, "a1-value-study", "a1-value-obj-japanese"), translation: L("I didn't study Japanese.", "Non ho studiato il giapponese.") },
    { id: "past-negative-3-m2", family: OBJ, context: "a1-context-classroom", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", form: A1_NEGATIVE_PAST_POLITE, slots: obj("a1-value-yuki", "a1-value-read", "a1-value-obj-book"), translation: L("Yuki didn't read the book.", "Yuki non ha letto il libro.") },
    ...
    { id: "past-negative-3-m6", family: SCHED, context: "a1-context-classroom", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", form: A1_NEGATIVE_PAST_POLITE, slots: timed("a1-value-mina", "a1-value-study-routine", "a1-value-day-monday"), translation: L("Mina didn't study on Monday.", "Mina non ha studiato il lunedì.") },
    { id: "past-negative-3-m7", family: ADV, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", form: A1_NEGATIVE_PAST_POLITE, slots: timed(WATASHI, "a1-value-read-routine", "a1-value-seq-night"), translation: L("I didn't read at night.", "Non ho letto la sera.") },
    { id: "past-negative-3-m8", family: ADV, context: "a1-context-home", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", form: A1_NEGATIVE_PAST_POLITE, slots: timed("a1-value-yuki", "a1-value-eat-routine", "a1-value-seq-morning"), translation: L("Yuki didn't eat in the morning.", "Yuki non ha mangiato la mattina.") },
  ],
  transfers: [
    { id: "past-negative-3-t1", family: OBJ, context: "a1-context-classroom", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", form: A1_NEGATIVE_PAST_POLITE, slots: obj("a1-value-yuki", "a1-value-study", "a1-value-obj-japanese"), translation: L("Yuki didn't study Japanese.", "Yuki non ha studiato il giapponese.") },
    { id: "past-negative-3-t2", family: OBJ, context: "a1-context-classroom", subjectReferent: SELF, subjectRealization: "omitted", form: A1_NEGATIVE_PAST_POLITE, slots: obj(WATASHI, "a1-value-read", "a1-value-obj-book"), translation: L("I didn't read the book.", "Non ho letto il libro.") },
    ...
    { id: "past-negative-3-t4", family: SCHED, context: "a1-context-classroom", subjectReferent: SELF, subjectRealization: "omitted", form: A1_NEGATIVE_PAST_POLITE, slots: timed(WATASHI, "a1-value-study-routine", "a1-value-day-monday"), translation: L("I didn't study on Monday.", "Non ho studiato il lunedì.") },
    { id: "past-negative-3-t5", family: ADV, context: "a1-context-home", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", form: A1_NEGATIVE_PAST_POLITE, slots: timed("a1-value-ken", "a1-value-read-routine", "a1-value-seq-night"), translation: L("Ken didn't read at night.", "Ken non ha letto la sera.") },
  ],
});
...
const lesson4: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    { id: "past-negative-4-m1", family: COP, context: "a1-context-classroom", subjectReferent: SELF, subjectRealization: "omitted", form: A1_AFFIRMATIVE_PAST_POLITE, slots: cop(WATASHI, "a1-value-obj-student"), translation: L("I was a student.", "Ero uno studente.") },
    { id: "past-negative-4-m2", family: COP, context: "a1-context-workplace", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", form: A1_AFFIRMATIVE_PAST_POLITE, slots: cop("a1-value-ken", "a1-value-obj-doctor"), translation: L("Ken was a doctor.", "Ken era un medico.") },
    { id: "past-negative-4-m3", family: COP, context: "a1-context-classroom", subjectReferent: SELF, subjectRealization: "omitted", form: A1_NEGATIVE_PRESENT_POLITE, slots: cop(WATASHI, "a1-value-obj-teacher"), translation: L("I am not a teacher.", "Non sono un insegnante.") },
    { id: "past-negative-4-m4", family: COP, context: "a1-context-workplace", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", form: A1_NEGATIVE_PRESENT_POLITE, slots: cop("a1-value-mina", "a1-value-obj-office-worker"), translation: L("Mina is not an office worker.", "Mina non è un'impiegata.") },
    { id: "past-negative-4-m5", family: COP, context: "a1-context-classroom", subjectReferent: SELF, subjectRealization: "omitted", form: A1_NEGATIVE_PAST_POLITE, slots: cop(WATASHI, "a1-value-obj-student"), translation: L("I was not a student.", "Non ero uno studente.") },
    { id: "past-negative-4-m6", family: COP, context: "a1-context-first-meeting", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", form: A1_NEGATIVE_PAST_POLITE, slots: cop("a1-value-yuki", "a1-value-obj-japanese-person"), translation: L("Yuki was not Japanese.", "Yuki non era giapponese.") },
  ...
  transfers: [
    { id: "past-negative-4-t1", family: COP, context: "a1-context-classroom", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", form: A1_AFFIRMATIVE_PAST_POLITE, slots: cop("a1-value-ken", "a1-value-obj-student"), translation: L("Ken was a student.", "Ken era uno studente.") },
    { id: "past-negative-4-t2", family: COP, context: "a1-context-workplace", subjectReferent: SELF, subjectRealization: "omitted", form: A1_NEGATIVE_PRESENT_POLITE, slots: cop(WATASHI, "a1-value-obj-doctor"), translation: L("I am not a doctor.", "Non sono un medico.") },
    { id: "past-negative-4-t3", family: COP, context: "a1-context-classroom", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", form: A1_NEGATIVE_PAST_POLITE, slots: cop("a1-value-mina", "a1-value-obj-student"), translation: L("Mina was not a student.", "Mina non era una studentessa.") },
    { id: "past-negative-4-t4", family: NOM, context: "a1-context-classroom", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", form: A1_NEGATIVE_PRESENT_POLITE, slots: { subject: "a1-value-yuki", predicate: "a1-value-understand", object: "a1-value-obj-english" }, translation: L("Yuki doesn't understand English.", "Yuki non capisce l'inglese.") },
    { id: "past-negative-4-t5", family: COP, context: "a1-context-classroom", subjectReferent: SELF, subjectRealization: "omitted", form: A1_NEGATIVE_PAST_POLITE, slots: cop(WATASHI, "a1-value-obj-teacher"), translation: L("I was not a teacher.", "Non ero un insegnante.") },
  ],
});
