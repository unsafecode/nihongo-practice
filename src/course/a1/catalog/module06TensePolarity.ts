...
const lesson1: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "past-negative-1-m6", family: SCHED, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", form: A1_AFFIRMATIVE_PAST_POLITE, slots: timed(WATASHI, "a1-value-wake", "a1-value-time-1030"), translation: L("I woke up at ten thirty.", "Mi sono svegliato alle dieci e mezza.") },
  ...
  transfers: [
    ...
    { id: "past-negative-1-t3", family: SCHED, context: "a1-context-home", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", form: A1_AFFIRMATIVE_PAST_POLITE, slots: timed("a1-value-yuki", "a1-value-wake", "a1-value-time-1030"), translation: L("Yuki woke up at ten thirty.", "Yuki si è svegliata alle dieci e mezza.") },
    { id: "past-negative-1-t4", family: SCHED, context: "a1-context-home", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", form: A1_AFFIRMATIVE_PAST_POLITE, slots: timed("a1-value-yuki", "a1-value-wake", "a1-value-time-1030"), translation: L("Yuki woke up at ten thirty.", "Yuki si è svegliata alle dieci e mezza.") },
...
const lesson3: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "past-negative-3-m3", family: ADV, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", form: A1_NEGATIVE_PAST_POLITE, slots: timed(WATASHI, "a1-value-wake", "a1-value-time-yesterday-morning"), translation: L("I didn't wake up yesterday morning.", "Non mi sono svegliato ieri mattina.") },
    ...
    { id: "past-negative-3-m5", family: ADV, context: "a1-context-town", subjectReferent: SELF, subjectRealization: "omitted", form: A1_NEGATIVE_PAST_POLITE, slots: timed(WATASHI, "a1-value-go-out", "a1-value-time-yesterday-afternoon"), translation: L("I didn't go out yesterday afternoon.", "Non sono uscito ieri pomeriggio.") },
    { id: "past-negative-3-m6", family: SCHED, context: "a1-context-routine-study-schedule", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", form: A1_NEGATIVE_PAST_POLITE, slots: timed("a1-value-mina", "a1-value-study-routine", "a1-value-day-monday"), translation: L("Mina didn't study on Monday.", "Mina non ha studiato il lunedì.") },
    { id: "past-negative-3-m7", family: ADV, context: "a1-context-evening-reading", subjectReferent: SELF, subjectRealization: "omitted", form: A1_NEGATIVE_PAST_POLITE, slots: timed(WATASHI, "a1-value-read-routine", "a1-value-time-last-night"), translation: L("I didn't read last night.", "Non ho letto ieri sera.") },
  ...
  transfers: [
    ...
    { id: "past-negative-3-t3", family: ADV, context: "a1-context-home", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", form: A1_NEGATIVE_PAST_POLITE, slots: timed("a1-value-mina", "a1-value-wake", "a1-value-time-yesterday-morning"), translation: L("Mina didn't wake up yesterday morning.", "Mina non si è svegliata ieri mattina.") },
    { id: "past-negative-3-t4", family: SCHED, context: "a1-context-routine-study-schedule", subjectReferent: SELF, subjectRealization: "omitted", form: A1_NEGATIVE_PAST_POLITE, slots: timed(WATASHI, "a1-value-study-routine", "a1-value-day-monday"), translation: L("I didn't study on Monday.", "Non ho studiato il lunedì.") },
    { id: "past-negative-3-t5", family: ADV, context: "a1-context-evening-reading", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", form: A1_NEGATIVE_PAST_POLITE, slots: timed("a1-value-ken", "a1-value-read-routine", "a1-value-time-last-night"), translation: L("Ken didn't read last night.", "Ken non ha letto ieri sera.") },
  ],
});
