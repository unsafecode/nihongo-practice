...
const lesson3: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "places-3-m4", family: ROUTE, context: "a1-context-station", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: route("a1-value-ken", "a1-value-go", "a1-value-loc-room", "a1-value-loc-town"), translation: L("Ken goes from the room to the town.", "Ken va dalla stanza alla città.") },
