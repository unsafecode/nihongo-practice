...
const lesson1: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    { id: "places-1-m1", family: LOCF, context: "a1-context-station", subjectReferent: SELF, subjectRealization: "omitted", slots: dest(WATASHI, "a1-value-go", "a1-value-loc-station"), translation: L("I go to the station.", "Vado alla stazione.") },
    { id: "places-1-m2", family: DIR, context: "a1-context-station", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: dest("a1-value-yuki", "a1-value-go", "a1-value-loc-station"), translation: L("Yuki goes toward the station.", "Yuki va verso la stazione.") },
    { id: "places-1-m3", family: LOCF, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", slots: dest(WATASHI, "a1-value-come", "a1-value-loc-home"), translation: L("I come home.", "Vengo a casa.") },
    { id: "places-1-m4", family: DIR, context: "a1-context-home", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: dest("a1-value-ken", "a1-value-come", "a1-value-loc-home"), translation: L("Ken comes toward home.", "Ken viene verso casa.") },
  ...
  transfers: [
    { id: "places-1-t1", family: DIR, context: "a1-context-station", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: dest("a1-value-ken", "a1-value-go", "a1-value-loc-station"), translation: L("Ken goes toward the station.", "Ken va verso la stazione.") },
    { id: "places-1-t2", family: DIR, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", slots: dest(WATASHI, "a1-value-come", "a1-value-loc-home"), translation: L("I come toward home.", "Vengo verso casa.") },
...
const lesson2: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    { id: "places-2-m1", family: TRANS, context: "a1-context-station", subjectReferent: SELF, subjectRealization: "omitted", slots: via(WATASHI, "a1-value-go", "a1-value-transport-train", "a1-value-loc-station"), translation: L("I go to the station by train.", "Vado alla stazione in treno.") },
    { id: "places-2-m2", family: TRANS, context: "a1-context-town", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: via("a1-value-yuki", "a1-value-go", "a1-value-transport-bus", "a1-value-loc-school"), translation: L("Yuki goes to school by bus.", "Yuki va a scuola in autobus.") },
    { id: "places-2-m3", family: TRANS, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", slots: via(WATASHI, "a1-value-come", "a1-value-transport-train", "a1-value-loc-home"), translation: L("I come home by train.", "Vengo a casa in treno.") },
    ...
    { id: "places-2-m7", family: TRANS, context: "a1-context-town", subjectReferent: SELF, subjectRealization: "omitted", slots: via(WATASHI, "a1-value-go", "a1-value-transport-bicycle", "a1-value-loc-school"), translation: L("I go to school by bicycle.", "Vado a scuola in bicicletta.") },
    { id: "places-2-m8", family: LOCF, context: "a1-context-workplace", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: dest("a1-value-yuki", "a1-value-work", "a1-value-loc-shop"), translation: L("Yuki works at the shop.", "Yuki lavora in negozio.") },
  ],
  transfers: [
    ...
    { id: "places-2-t2", family: TRANS, context: "a1-context-town", subjectReferent: SELF, subjectRealization: "omitted", slots: via(WATASHI, "a1-value-come", "a1-value-transport-bus", "a1-value-loc-school"), translation: L("I come to school by bus.", "Vengo a scuola in autobus.") },
...
const lesson3: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "places-3-m4", family: ROUTE, context: "a1-context-station", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: route("a1-value-ken", "a1-value-go", "a1-value-loc-tokyo", "a1-value-loc-kyoto"), translation: L("Ken goes from Tokyo to Kyoto.", "Ken va da Tokyo a Kyoto.") },
    { id: "places-3-m5", family: ROUTE, context: "a1-context-town", subjectReferent: SELF, subjectRealization: "omitted", slots: route(WATASHI, "a1-value-come", "a1-value-loc-station", "a1-value-loc-school"), translation: L("I come from the station to school.", "Vengo dalla stazione alla scuola.") },
...
const lesson4: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  introducedSenseIds: ["a1-sense-go", "a1-sense-come", "a1-sense-work"],
  models: [
    { id: "places-4-m1", family: LOCF, context: "a1-context-station", subjectReferent: SELF, subjectRealization: "omitted", slots: dest(WATASHI, "a1-value-go", "a1-value-loc-station"), translation: L("I go to the station.", "Vado alla stazione.") },
    { id: "places-4-m2", family: TRANS, context: "a1-context-town", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: via("a1-value-yuki", "a1-value-go", "a1-value-transport-train", "a1-value-loc-school"), translation: L("Yuki goes to school by train.", "Yuki va a scuola in treno.") },
    ...
    { id: "places-4-m4", family: DIR, context: "a1-context-home", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: dest("a1-value-ken", "a1-value-come", "a1-value-loc-home"), translation: L("Ken comes toward home.", "Ken viene verso casa.") },
    ...
    { id: "places-4-m6", family: DIR, context: "a1-context-town", subjectReferent: "a1-referent-mina", subjectRealization: "explicit", slots: dest("a1-value-mina", "a1-value-go", "a1-value-loc-school"), translation: L("Mina goes toward school.", "Mina va verso la scuola.") },
    { id: "places-4-m7", family: TRANS, context: "a1-context-station", subjectReferent: SELF, subjectRealization: "omitted", slots: via(WATASHI, "a1-value-come", "a1-value-transport-bus", "a1-value-loc-station"), translation: L("I come to the station by bus.", "Vengo alla stazione in autobus.") },
  ...
  transfers: [
    ...
    { id: "places-4-t2", family: TRANS, context: "a1-context-town", subjectReferent: SELF, subjectRealization: "omitted", slots: via(WATASHI, "a1-value-go", "a1-value-transport-train", "a1-value-loc-school"), translation: L("I go to school by train.", "Vado a scuola in treno.") },
    ...
    { id: "places-4-t4", family: DIR, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", slots: dest(WATASHI, "a1-value-come", "a1-value-loc-home"), translation: L("I come toward home.", "Vengo verso casa.") },
