...
const lesson1: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "descriptions-1-m3", family: DESC, context: "a1-context-home", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-yuki", slots: desc("a1-value-heya", "a1-value-cold"), translation: L("The room is cold.", "La stanza è fredda.") },
    ...
    { id: "descriptions-1-m4", family: DESC, context: "a1-context-home", subjectReferent: THING, subjectRealization: "omitted", speakerRole: "a1-role-learner", slots: desc("a1-value-heya", "a1-value-cold"), translation: L("It's cold.", "È fredda.") },
    ...
    { id: "descriptions-1-m8", family: DESC, context: "a1-context-home", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-teacher", slots: desc("a1-value-heya", "a1-value-quiet"), translation: L("The room is quiet.", "La stanza è tranquilla.") },
  ],
  transfers: [
    { id: "descriptions-1-t1", family: DESC, context: "a1-context-home", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-learner", slots: desc("a1-value-heya", "a1-value-hot"), translation: L("The room is hot.", "La stanza è calda.") },
...
const lesson2: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "descriptions-2-m3", family: PREF, context: "a1-context-home", subjectReferent: "a1-referent-yuki", subjectRealization: "explicit", slots: pref("a1-value-yuki", "a1-value-like", "a1-value-obj-music"), translation: L("Yuki likes music.", "A Yuki piace la musica.") },
    ...
    { id: "descriptions-2-m6", family: PREF, context: "a1-context-cafe", subjectReferent: SELF, subjectRealization: "omitted", slots: pref("a1-value-watashi", "a1-value-dislike", "a1-value-obj-ramen"), translation: L("I dislike ramen.", "Non mi piace il ramen.") },
    { id: "descriptions-2-m7", family: PREF, context: "a1-context-classroom", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: pref("a1-value-ken", "a1-value-dislike", "a1-value-obj-book"), translation: L("Ken dislikes books.", "A Ken non piacciono i libri.") },
    { id: "descriptions-2-m8", family: DESC, context: "a1-context-cafe", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-mina", slots: desc("a1-value-heya", "a1-value-hot"), translation: L("The room is hot.", "La stanza è calda.") },
  ],
  transfers: [
    { id: "descriptions-2-t1", family: PREF, context: "a1-context-cafe", subjectReferent: SELF, subjectRealization: "explicit", slots: pref("a1-value-watashi", "a1-value-like", "a1-value-obj-music"), translation: L("I like music.", "Mi piace la musica.") },
    ...
    { id: "descriptions-2-t4", family: PREF, context: "a1-context-home", subjectReferent: SELF, subjectRealization: "omitted", slots: pref("a1-value-watashi", "a1-value-like", "a1-value-obj-book"), translation: L("I like books.", "Mi piacciono i libri.") },
    { id: "descriptions-2-t5", family: PREF, context: "a1-context-cafe", subjectReferent: SELF, subjectRealization: "explicit", slots: pref("a1-value-watashi", "a1-value-dislike", "a1-value-obj-ramen"), translation: L("I dislike ramen.", "Non mi piace il ramen.") },
  ],
});
...
const lesson3: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "descriptions-3-m2", family: COMP, context: "a1-context-home", subjectReferent: CREATURE, subjectRealization: "omitted", speakerRole: "a1-role-learner", slots: comp("a1-value-ex-cat", "a1-value-big", "a1-value-obj-apple"), translation: L("It's bigger than an apple.", "È più grande di una mela.") },
    ...
    { id: "descriptions-3-m5", family: COMP, context: "a1-context-home", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-ken", slots: comp("a1-value-heya", "a1-value-cold", "a1-value-obj-are"), translation: L("This room is colder than that one.", "Questa stanza è più fredda di quella.") },
    { id: "descriptions-3-m6", family: COMP, context: "a1-context-home", subjectReferent: THING, subjectRealization: "omitted", speakerRole: "a1-role-learner", slots: comp("a1-value-heya", "a1-value-cold", "a1-value-obj-are"), translation: L("It's colder than that one.", "È più fredda di quella.") },
    ...
    { id: "descriptions-3-m8", family: COMP, context: "a1-context-classroom", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-teacher", slots: comp("a1-value-ex-pen", "a1-value-small", "a1-value-obj-mikan"), translation: L("The pen is smaller than the tangerine.", "La penna è più piccola del mandarino.") },
  ],
  transfers: [
    ...
    { id: "descriptions-3-t3", family: COMP, context: "a1-context-home", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-learner", slots: comp("a1-value-heya", "a1-value-cold", "a1-value-obj-are"), translation: L("This room is colder than that one.", "Questa stanza è più fredda di quella.") },
    { id: "descriptions-3-t4", family: COMP, context: "a1-context-classroom", subjectReferent: THING, subjectRealization: "omitted", speakerRole: "a1-role-learner", slots: comp("a1-value-ex-pen", "a1-value-small", "a1-value-obj-mikan"), translation: L("It's smaller than the tangerine.", "È più piccolo del mandarino.") },
    { id: "descriptions-3-t5", family: COMP, context: "a1-context-classroom", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-classmate", slots: comp("a1-value-ex-pen", "a1-value-small", "a1-value-obj-mikan"), translation: L("The pen is smaller than the tangerine.", "La penna è più piccola del mandarino.") },
  ],
});

// ---------------------------------------------------------------------------
// Lesson descriptions-4 — weather & states recap (reuse only; no new content)
// ---------------------------------------------------------------------------
...
const lesson4: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  introducedSenseIds: [],
  models: [
    { id: "descriptions-4-m1", family: DESC, context: "a1-context-weather", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-learner", slots: desc("a1-value-today", "a1-value-hot"), translation: L("Today is hot.", "Oggi fa caldo.") },
    { id: "descriptions-4-m2", family: DESC, context: "a1-context-weather", subjectReferent: THING, subjectRealization: "omitted", speakerRole: "a1-role-learner", slots: desc("a1-value-today", "a1-value-cold"), translation: L("It's cold.", "Fa freddo.") },
    { id: "descriptions-4-m3", family: DESC, context: "a1-context-town", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-yuki", slots: desc("a1-value-machi", "a1-value-quiet"), translation: L("The town is quiet.", "La città è tranquilla.") },
    { id: "descriptions-4-m4", family: DESC, context: "a1-context-home", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-ken", slots: desc("a1-value-heya", "a1-value-big"), translation: L("The room is big.", "La stanza è grande.") },
    { id: "descriptions-4-m5", family: DESC, context: "a1-context-home", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-mina", slots: desc("a1-value-heya", "a1-value-small"), translation: L("The room is small.", "La stanza è piccola.") },
    { id: "descriptions-4-m6", family: DESC, context: "a1-context-town", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-teacher", slots: desc("a1-value-machi", "a1-value-big"), translation: L("The town is big.", "La città è grande.") },
    { id: "descriptions-4-m7", family: DESC, context: "a1-context-weather", subjectReferent: THING, subjectRealization: "omitted", speakerRole: "a1-role-learner", slots: desc("a1-value-today", "a1-value-hot"), translation: L("It's hot.", "Fa caldo.") },
    { id: "descriptions-4-m8", family: DESC, context: "a1-context-home", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-friend", slots: desc("a1-value-heya", "a1-value-quiet"), translation: L("The room is quiet.", "La stanza è tranquilla.") },
  ],
  transfers: [
    ...
    { id: "descriptions-4-t2", family: DESC, context: "a1-context-home", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-classmate", slots: desc("a1-value-heya", "a1-value-big"), translation: L("The room is big.", "La stanza è grande.") },
    ...
    { id: "descriptions-4-t4", family: DESC, context: "a1-context-home", subjectReferent: THING, subjectRealization: "omitted", speakerRole: "a1-role-learner", slots: desc("a1-value-heya", "a1-value-small"), translation: L("It's small.", "È piccola.") },
