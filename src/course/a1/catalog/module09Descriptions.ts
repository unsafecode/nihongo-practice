...
const lesson4: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "descriptions-4-m4", family: DESC, context: "a1-context-town", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-ken", slots: desc("a1-value-machi", "a1-value-big"), translation: L("The town is big.", "La città è grande.") },
    { id: "descriptions-4-m5", family: DESC, context: "a1-context-town", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-mina", slots: desc("a1-value-machi", "a1-value-small"), translation: L("The town is small.", "La città è piccola.") },
    { id: "descriptions-4-m6", family: DESC, context: "a1-context-weather", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-teacher", slots: desc("a1-value-today", "a1-value-quiet"), translation: L("Today is calm.", "Oggi è tranquillo.") },
    ...
    { id: "descriptions-4-m8", family: DESC, context: "a1-context-town", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-friend", slots: desc("a1-value-machi", "a1-value-quiet"), translation: L("The town is quiet.", "La città è tranquilla.") },
  ],
  transfers: [
