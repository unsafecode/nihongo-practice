...
const lesson1: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "descriptions-1-m3", family: DESC, context: "a1-context-classroom", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-yuki", slots: desc("a1-value-garden", "a1-value-quiet"), translation: L("The garden is quiet.", "Il giardino è tranquillo.") },
    ...
    { id: "descriptions-1-m5", family: DESC, context: "a1-context-town", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-ken", slots: desc("a1-value-river", "a1-value-quiet"), translation: L("The river is quiet.", "Il fiume è tranquillo.") },
    ...
    { id: "descriptions-1-m8", family: DESC, context: "a1-context-station", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-teacher", slots: desc("a1-value-eki-subject", "a1-value-quiet"), translation: L("The station is quiet.", "La stazione è tranquilla.") },
  ],
  transfers: [
...
const lesson2: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    { id: "descriptions-2-m1", family: PREF, context: "a1-context-cafe", subjectReferent: SELF, subjectRealization: "explicit", slots: pref("a1-value-watashi", "a1-value-like", "a1-value-obj-camera"), translation: L("I like cameras.", "Mi piacciono le fotocamere.") },
  ...
  transfers: [
    ...
    { id: "descriptions-2-t3", family: PREF, context: "a1-context-home", subjectReferent: "a1-referent-ken", subjectRealization: "explicit", slots: pref("a1-value-ken", "a1-value-like", "a1-value-obj-camera"), translation: L("Ken likes cameras.", "A Ken piacciono le fotocamere.") },
...
const lesson3: A1BuiltLesson = buildA1InstructionalLesson({
  ...
  models: [
    ...
    { id: "descriptions-3-m3", family: COMP, context: "a1-context-classroom", subjectReferent: THING, subjectRealization: "explicit", speakerRole: "a1-role-yuki", slots: comp("a1-value-ex-book", "a1-value-small", "a1-value-obj-backpack"), translation: L("The book is smaller than the backpack.", "Il libro è più piccolo dello zaino.") },
