...
export const a1Modules05to08LessonContent: readonly A1LessonContent[] = [
  ...
  content(
    ...
    ["routines-4-m5", "routines-4-m6", "routines-4-m7"],
    "transformation",
    {
      en: "You exchange a short end-of-day routine update with a housemate.",
      it: "Scambi un breve aggiornamento sulla routine di fine giornata con un coinquilino.",
    },
    {
    ...
    { turnVariantIds: ["routines-4-m5", "routines-4-m6", "routines-4-m7"] },
  ),
  content(
    "past-negative-1",
    "routines-4",
    ...
    "a1-note-mashita",
    ["past-negative-1-m5", "past-negative-1-m6", "past-negative-1-m7"],
    "contextual-response",
    {
      en: "You report what happened yesterday after meeting a friend and following your evening routine.",
      it: "Racconti che cosa è successo ieri dopo aver incontrato un amico e seguito la routine serale.",
    },
    {
  ...
  content(
    ...
    ["past-negative-3-m1", "past-negative-3-m2", "past-negative-3-m6"],
    "contextual-response",
    {
  ...
  content(
    ...
    "transformation",
    {
      en: "You clarify a past and present personal detail in a polite introduction.",
      it: "Chiarisci un dettaglio personale passato e presente in una presentazione cortese.",
    },
    {
      en: "After a noun, choose the copula ending for present, past, negative, or past negative.",
      it: "Dopo un nome, scegli la finale della copula per presente, passato, negativo o negativo passato.",
    },
  ),
  content(
    "places-1",
  ...
  content(
    ...
    ["places-2-m1", "places-2-m2", "places-2-m4"],
    "transformation",
    {
  ...
  content(
    ...
    ["places-3-m1", "places-3-m2", "places-3-m3"],
    "contextual-response",
    {
  ...
  content(
    ...
    ["people-3-m1", "people-3-m3", "people-3-m4"],
    "contextual-response",
    {
