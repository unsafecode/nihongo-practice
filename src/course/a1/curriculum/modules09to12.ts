...
export const a1Modules09to12LessonContent: readonly A1LessonContent[] = [
  instructionalContent(
    ...
    "a1-note-adjectives",
    ["descriptions-1-m1", "descriptions-1-m5", "descriptions-1-m7"],
    "contextual-response",
    {
  ...
  instructionalContent(
    ...
    ["descriptions-4-m1", "descriptions-4-m3", "descriptions-4-m7"],
    "transformation",
    {
      en: "You give an immediate weather update and add one familiar description.",
      it: "Dai un aggiornamento immediato sul tempo e aggiungi una descrizione familiare.",
    },
    {
      en: "Reuse a known topic and adjective together; no new pattern is needed for a short update.",
      it: "Riusa insieme un tema e un aggettivo noti; per un breve aggiornamento non serve una nuova struttura.",
    },
  ),
  instructionalContent(
    "shopping-1",
  ...
  instructionalContent(
    ...
    ["shopping-3-m1", "shopping-3-m2", "shopping-3-m4"],
    "contextual-response",
    {
  ...
  instructionalContent(
    ...
    "a1-note-synthesis-recombine",
    ["shopping-4-m1", "shopping-4-m3", "shopping-4-m8"],
    "transformation",
    {
      en: "You complete a short purchase by combining a price, quantity, and request.",
      it: "Completi un breve acquisto combinando un prezzo, una quantità e una richiesta.",
    },
    {
      en: "Choose familiar purchase pieces for the situation instead of adding a new transaction pattern.",
      it: "Scegli elementi di acquisto familiari per la situazione invece di aggiungere una nuova struttura di transazione.",
    },
    {
      turnVariantIds: ["shopping-4-m3", "shopping-4-m1", "shopping-4-m6"],
    },
  ),
  instructionalContent(
    "existence-needs-1",
    ...
    ["existence-needs-1-m1", "existence-needs-1-m3", "existence-needs-1-m6"],
    "contextual-response",
    {
  ...
  instructionalContent(
    ...
    "a1-note-needs-wants",
    ["existence-needs-3-m1", "existence-needs-3-m7", "existence-needs-3-m8"],
    "contextual-response",
    {
  ...
  instructionalContent(
    ...
    "a1-note-synthesis-recombine",
    ["existence-needs-4-m1", "existence-needs-4-m2", "existence-needs-4-m3"],
    "transformation",
    {
      en: "You locate something, identify who is nearby, and say what you need.",
      it: "Localizzi qualcosa, identifichi chi è vicino e dici ciò di cui hai bisogno.",
    },
    {
      en: "Recombine the known location, existence, and need patterns to resolve the practical situation.",
      it: "Ricombina le strutture note di luogo, esistenza e bisogno per risolvere la situazione pratica.",
    },
    {
      turnVariantIds: [
