...
export const a1Lexemes: readonly A1Lexeme[] = deepFreeze([
  ...
  defineA1Lexeme({ id: "a1-lexeme-heya", valueIds: ["a1-value-heya"], kana: "へや", romaji: "heya", category: "noun", meaning: { en: "room", it: "stanza" } }),
  defineA1Lexeme({ id: "a1-lexeme-machi", valueIds: ["a1-value-machi"], kana: "まち", romaji: "machi", category: "noun", meaning: { en: "town", it: "città; paese" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-kodomo", valueIds: ["a1-value-ex-child"], kana: "こども", romaji: "kodomo", category: "person", meaning: { en: "child", it: "bambino; bambina" } }),
  defineA1Lexeme({ id: "a1-lexeme-hito", valueIds: ["a1-value-ex-person"], kana: "ひと", romaji: "hito", category: "person", meaning: { en: "person", it: "persona" } }),
