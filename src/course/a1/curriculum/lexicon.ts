...
export const a1Lexemes: readonly A1Lexeme[] = deepFreeze([
  ...
  defineA1Lexeme({ id: "a1-lexeme-douryou", valueIds: ["a1-value-companion-colleague"], kana: "どうりょう", romaji: "douryou", category: "person", meaning: { en: "colleague", it: "collega" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-hataraku", valueIds: ["a1-value-work", "a1-value-work-bare"], kana: "はたらく", romaji: "hataraku", category: "verb", meaning: { en: "to work", it: "lavorare" }, verb: { dictionary: { kana: "はたらく", romaji: "hataraku" }, polite: { kana: "はたらきます", romaji: "hatarakimasu" }, class: "godan" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-iku", valueIds: ["a1-value-go", "a1-value-accompany", "a1-value-go-bare"], kana: "いく", romaji: "iku", category: "verb", meaning: { en: "to go", it: "andare" }, verb: { dictionary: { kana: "いく", romaji: "iku" }, polite: { kana: "いきます", romaji: "ikimasu" }, class: "godan" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-kaeru", valueIds: ["a1-value-return", "a1-value-return-bare", "a1-value-return-location"], kana: "かえる", romaji: "kaeru", category: "verb", meaning: { en: "to return; go home", it: "tornare" }, verb: { dictionary: { kana: "かえる", romaji: "kaeru" }, polite: { kana: "かえります", romaji: "kaerimasu" }, class: "godan" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-furansugo", valueIds: ["a1-value-obj-french-language"], kana: "フランスご", romaji: "furansugo", category: "noun", meaning: { en: "French language", it: "lingua francese" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-umi", valueIds: ["a1-value-phonetic-umi"], kana: "うみ", romaji: "umi", category: "noun", meaning: { en: "sea", it: "mare" } }),
  defineA1Lexeme({ id: "a1-lexeme-happa", valueIds: ["a1-value-phonetic-happa"], kana: "はっぱ", romaji: "happa", category: "noun", meaning: { en: "leaf", it: "foglia" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-koppu", valueIds: ["a1-value-obj-cup"], kana: "コップ", romaji: "koppu", category: "noun", meaning: { en: "cup", it: "tazza; bicchiere" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-doko", valueIds: ["a1-value-q-doko", "a1-value-loc-doko"], kana: "どこ", romaji: "doko", category: "question-word", meaning: { en: "where", it: "dove" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-dore", valueIds: ["a1-value-q-dore", "a1-value-dore"], kana: "どれ", romaji: "dore", category: "question-word", meaning: { en: "which one", it: "quale" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-gogo", valueIds: ["a1-value-seq-afternoon"], kana: "ごご", romaji: "gogo", category: "time", meaning: { en: "afternoon", it: "pomeriggio" } }),
  defineA1Lexeme({ id: "a1-lexeme-yoru", valueIds: ["a1-value-seq-night"], kana: "よる", romaji: "yoru", category: "time", meaning: { en: "night", it: "notte" } }),
  defineA1Lexeme({ id: "a1-lexeme-ban", valueIds: ["a1-value-seq-evening", "a1-value-obj-evening"], kana: "ばん", romaji: "ban", category: "time", meaning: { en: "evening", it: "sera" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-kyou", valueIds: ["a1-value-today", "a1-value-time-today"], kana: "きょう", romaji: "kyou", category: "time", meaning: { en: "today", it: "oggi" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-senshuu", valueIds: ["a1-value-time-last-week"], kana: "せんしゅう", romaji: "senshuu", category: "time", meaning: { en: "last week", it: "la settimana scorsa" } }),
  defineA1Lexeme({ id: "a1-lexeme-ototoi", valueIds: ["a1-value-time-day-before-yesterday"], kana: "おととい", romaji: "ototoi", category: "time", meaning: { en: "the day before yesterday", it: "l'altro ieri" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-hare", valueIds: ["a1-value-weather-sunny"], kana: "はれ", romaji: "hare", category: "expression", meaning: { en: "sunny; clear weather", it: "bel tempo; sereno" } }),
  defineA1Lexeme({ id: "a1-lexeme-kumori", valueIds: ["a1-value-weather-cloudy"], kana: "くもり", romaji: "kumori", category: "expression", meaning: { en: "cloudy weather", it: "tempo nuvoloso" } }),
  defineA1Lexeme({ id: "a1-lexeme-ame", valueIds: ["a1-value-weather-rain"], kana: "あめ", romaji: "ame", category: "noun", meaning: { en: "rain; rainy weather", it: "pioggia; tempo piovoso" } }),
  defineA1Lexeme({ id: "a1-lexeme-yuki-weather", valueIds: ["a1-value-weather-snow"], kana: "ゆき", romaji: "yuki", category: "noun", meaning: { en: "snow; snowy weather", it: "neve; tempo nevoso" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-juusu", valueIds: ["a1-value-obj-juice"], kana: "ジュース", romaji: "juusu", category: "noun", meaning: { en: "juice", it: "succo" } }),
  defineA1Lexeme({ id: "a1-lexeme-onigiri", valueIds: ["a1-value-obj-onigiri"], kana: "おにぎり", romaji: "onigiri", category: "noun", meaning: { en: "rice ball", it: "polpetta di riso" } }),
  defineA1Lexeme({ id: "a1-lexeme-sandoicchi", valueIds: ["a1-value-obj-sandwich"], kana: "サンドイッチ", romaji: "sandoicchi", category: "noun", meaning: { en: "sandwich", it: "panino" } }),
  defineA1Lexeme({ id: "a1-lexeme-fukuro", valueIds: ["a1-value-obj-shopping-bag"], kana: "ふくろ", romaji: "fukuro", category: "noun", meaning: { en: "shopping bag", it: "sacchetto" } }),
  defineA1Lexeme({ id: "a1-lexeme-reshiito", valueIds: ["a1-value-obj-receipt"], kana: "レシート", romaji: "reshiito", category: "noun", meaning: { en: "receipt", it: "scontrino" } }),
  defineA1Lexeme({ id: "a1-lexeme-zasshi", valueIds: ["a1-value-obj-magazine"], kana: "ざっし", romaji: "zasshi", category: "noun", meaning: { en: "magazine", it: "rivista" } }),
  defineA1Lexeme({ id: "a1-lexeme-enpitsu", valueIds: ["a1-value-ex-pencil"], kana: "えんぴつ", romaji: "enpitsu", category: "noun", meaning: { en: "pencil", it: "matita" } }),
  defineA1Lexeme({ id: "a1-lexeme-keshigomu", valueIds: ["a1-value-obj-eraser", "a1-value-ex-eraser"], kana: "けしごむ", romaji: "keshigomu", category: "noun", meaning: { en: "eraser", it: "gomma" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-hana", valueIds: ["a1-value-ex-flower"], kana: "はな", romaji: "hana", category: "noun", meaning: { en: "flower", it: "fiore" } }),
  defineA1Lexeme({ id: "a1-lexeme-kasa", valueIds: ["a1-value-ex-umbrella"], kana: "かさ", romaji: "kasa", category: "noun", meaning: { en: "umbrella", it: "ombrello" } }),
  defineA1Lexeme({ id: "a1-lexeme-keitaidenwa", valueIds: ["a1-value-ex-phone"], kana: "けいたいでんわ", romaji: "keitaidenwa", category: "noun", meaning: { en: "mobile phone", it: "telefono cellulare" } }),
  defineA1Lexeme({ id: "a1-lexeme-neko", valueIds: ["a1-value-ex-cat", "a1-value-obj-cat"], kana: "ねこ", romaji: "neko", category: "noun", meaning: { en: "cat", it: "gatto" } }),
  defineA1Lexeme({ id: "a1-lexeme-inu", valueIds: ["a1-value-ex-dog", "a1-value-obj-dog"], kana: "いぬ", romaji: "inu", category: "noun", meaning: { en: "dog", it: "cane" } }),
  defineA1Lexeme({ id: "a1-lexeme-tori", valueIds: ["a1-value-ex-bird"], kana: "とり", romaji: "tori", category: "noun", meaning: { en: "bird", it: "uccello" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-kusuri", valueIds: ["a1-value-obj-medicine"], kana: "くすり", romaji: "kusuri", category: "noun", meaning: { en: "medicine", it: "medicina" } }),
  defineA1Lexeme({ id: "a1-lexeme-pasupooto", valueIds: ["a1-value-obj-passport"], kana: "パスポート", romaji: "pasupooto", category: "noun", meaning: { en: "passport", it: "passaporto" } }),
  defineA1Lexeme({ id: "a1-lexeme-chizu", valueIds: ["a1-value-obj-map"], kana: "ちず", romaji: "chizu", category: "noun", meaning: { en: "map", it: "mappa" } }),
  defineA1Lexeme({ id: "a1-lexeme-jisho", valueIds: ["a1-value-obj-dictionary"], kana: "じしょ", romaji: "jisho", category: "noun", meaning: { en: "dictionary", it: "dizionario" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-aatisuto", valueIds: ["a1-value-obj-artist"], kana: "アーティスト", romaji: "aatisuto", category: "person", meaning: { en: "artist", it: "artista" } }),
  defineA1Lexeme({ id: "a1-lexeme-kangoshi", valueIds: ["a1-value-obj-nurse"], kana: "かんごし", romaji: "kangoshi", category: "person", meaning: { en: "nurse", it: "infermiere; infermiera" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-shisho", valueIds: ["a1-value-obj-librarian"], kana: "ししょ", romaji: "shisho", category: "person", meaning: { en: "librarian", it: "bibliotecario; bibliotecaria" } }),
  defineA1Lexeme({ id: "a1-lexeme-ongakuka", valueIds: ["a1-value-obj-musician"], kana: "おんがくか", romaji: "ongakuka", category: "person", meaning: { en: "musician", it: "musicista" } }),
  defineA1Lexeme({ id: "a1-lexeme-sakka", valueIds: ["a1-value-obj-writer"], kana: "さっか", romaji: "sakka", category: "person", meaning: { en: "writer", it: "scrittore; scrittrice" } }),
  defineA1Lexeme({ id: "a1-lexeme-rina", valueIds: ["a1-value-rina"], kana: "りな", romaji: "rina", category: "person", meaning: { en: "Rina", it: "Rina" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-kauntaa", valueIds: ["a1-value-q-counter"], kana: "カウンター", romaji: "kauntaa", category: "noun", meaning: { en: "counter", it: "bancone" } }),
  defineA1Lexeme({ id: "a1-lexeme-deguchi", valueIds: ["a1-value-q-exit"], kana: "でぐち", romaji: "deguchi", category: "noun", meaning: { en: "exit", it: "uscita" } }),
  defineA1Lexeme({ id: "a1-lexeme-rokkaa", valueIds: ["a1-value-q-locker"], kana: "ロッカー", romaji: "rokkaa", category: "noun", meaning: { en: "locker", it: "armadietto" } }),
  defineA1Lexeme({ id: "a1-lexeme-kankokugo", valueIds: ["a1-value-obj-korean-language"], kana: "かんこくご", romaji: "kankokugo", category: "noun", meaning: { en: "Korean language", it: "lingua coreana" } }),
  defineA1Lexeme({ id: "a1-lexeme-supeingo", valueIds: ["a1-value-obj-spanish-language"], kana: "スペインご", romaji: "supeingo", category: "noun", meaning: { en: "Spanish language", it: "lingua spagnola" } }),
  defineA1Lexeme({ id: "a1-lexeme-doitsugo", valueIds: ["a1-value-obj-german-language"], kana: "ドイツご", romaji: "doitsugo", category: "noun", meaning: { en: "German language", it: "lingua tedesca" } }),
  defineA1Lexeme({ id: "a1-lexeme-chuugokugo", valueIds: ["a1-value-obj-chinese-language"], kana: "ちゅうごくご", romaji: "chuugokugo", category: "noun", meaning: { en: "Chinese language", it: "lingua cinese" } }),
  defineA1Lexeme({ id: "a1-lexeme-sarada", valueIds: ["a1-value-obj-salad"], kana: "サラダ", romaji: "sarada", category: "noun", meaning: { en: "salad", it: "insalata" } }),
  defineA1Lexeme({ id: "a1-lexeme-keeki", valueIds: ["a1-value-obj-cake"], kana: "ケーキ", romaji: "keeki", category: "noun", meaning: { en: "cake", it: "torta" } }),
  defineA1Lexeme({ id: "a1-lexeme-suupu", valueIds: ["a1-value-obj-soup"], kana: "スープ", romaji: "suupu", category: "noun", meaning: { en: "soup", it: "zuppa" } }),
  defineA1Lexeme({ id: "a1-lexeme-hakubutsukan", valueIds: ["a1-value-loc-museum"], kana: "はくぶつかん", romaji: "hakubutsukan", category: "noun", meaning: { en: "museum", it: "museo" } }),
  defineA1Lexeme({ id: "a1-lexeme-yuubinkyoku", valueIds: ["a1-value-loc-post-office"], kana: "ゆうびんきょく", romaji: "yuubinkyoku", category: "noun", meaning: { en: "post office", it: "ufficio postale" } }),
  defineA1Lexeme({ id: "a1-lexeme-jimu", valueIds: ["a1-value-loc-gym"], kana: "ジム", romaji: "jimu", category: "noun", meaning: { en: "gym", it: "palestra" } }),
  defineA1Lexeme({ id: "a1-lexeme-daigaku", valueIds: ["a1-value-loc-university"], kana: "だいがく", romaji: "daigaku", category: "noun", meaning: { en: "university", it: "università" } }),
  defineA1Lexeme({ id: "a1-lexeme-gaidobukku", valueIds: ["a1-value-obj-guidebook"], kana: "ガイドブック", romaji: "gaidobukku", category: "noun", meaning: { en: "guidebook", it: "guida" } }),
  defineA1Lexeme({ id: "a1-lexeme-bentou", valueIds: ["a1-value-obj-bento"], kana: "べんとう", romaji: "bentou", category: "noun", meaning: { en: "boxed lunch", it: "bento" } }),
  defineA1Lexeme({ id: "a1-lexeme-hagaki", valueIds: ["a1-value-obj-postcard"], kana: "はがき", romaji: "hagaki", category: "noun", meaning: { en: "postcard", it: "cartolina" } }),
  defineA1Lexeme({ id: "a1-lexeme-poddokyasuto", valueIds: ["a1-value-obj-podcast"], kana: "ポッドキャスト", romaji: "poddokyasuto", category: "noun", meaning: { en: "podcast", it: "podcast" } }),
  defineA1Lexeme({ id: "a1-lexeme-meeru", valueIds: ["a1-value-obj-email"], kana: "メール", romaji: "meeru", category: "noun", meaning: { en: "email", it: "email" } }),
  defineA1Lexeme({ id: "a1-lexeme-rokuji-han", valueIds: ["a1-value-time-630"], kana: "ろくじはん", romaji: "rokuji han", category: "time", meaning: { en: "six thirty", it: "le sei e mezza" } }),
  defineA1Lexeme({ id: "a1-lexeme-shichiji-han", valueIds: ["a1-value-time-730"], kana: "しちじはん", romaji: "shichiji han", category: "time", meaning: { en: "seven thirty", it: "le sette e mezza" } }),
  defineA1Lexeme({ id: "a1-lexeme-hachiji-han", valueIds: ["a1-value-time-830"], kana: "はちじはん", romaji: "hachiji han", category: "time", meaning: { en: "eight thirty", it: "le otto e mezza" } }),
  defineA1Lexeme({ id: "a1-lexeme-juuji-han", valueIds: ["a1-value-time-1030"], kana: "じゅうじはん", romaji: "juuji han", category: "time", meaning: { en: "ten thirty", it: "le dieci e mezza" } }),
  defineA1Lexeme({ id: "a1-lexeme-kinou-no-asa", valueIds: ["a1-value-time-yesterday-morning"], kana: "きのうのあさ", romaji: "kinou no asa", category: "time", meaning: { en: "yesterday morning", it: "ieri mattina" } }),
  defineA1Lexeme({ id: "a1-lexeme-kinou-no-gogo", valueIds: ["a1-value-time-yesterday-afternoon"], kana: "きのうのごご", romaji: "kinou no gogo", category: "time", meaning: { en: "yesterday afternoon", it: "ieri pomeriggio" } }),
  ...
  defineA1Lexeme({ id: "a1-lexeme-ryukku", valueIds: ["a1-value-obj-backpack"], kana: "リュック", romaji: "ryukku", category: "noun", meaning: { en: "backpack", it: "zaino" } }),
  defineA1Lexeme({ id: "a1-lexeme-souvenir", valueIds: ["a1-value-obj-souvenir"], kana: "おみやげ", romaji: "omiyage", category: "noun", meaning: { en: "souvenir", it: "souvenir" } }),
]);
