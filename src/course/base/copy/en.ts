...
const POLITE_VERBS_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("polite-verbs-1", {
    ...
    instructions: [
      ...
      "Use every tile to reproduce the teacher’s two-part card.",
    ...
    accepted: [
      ...
      "The two tiles reproduce the stated ぶんまつ card.",
    ...
    retry: [
      ...
      "Use every tile in the demonstrated order.",
  ...
  ...semanticLessonCopy("polite-verbs-4", {
    ...
    instructions: [
      ...
      "Tanaka listens first; the roster adds Suzuki to that same routine. Transform the displayed stem into Suzuki’s complete statement.",
      "Yamada will make one item; the schedule adds Mari to the same plan. Complete Mari’s statement.",
      "The displayed predicate attaches the polite ending to the wrong base. Choose the one-defect repair.",
      "Tanaka will meet the group first; the schedule adds Yuki to the same plan. Choose Yuki’s statement.",
      "Yuki sings first; the roster adds the friend to the same routine. Retrieve the friend’s statement.",
    ...
    accepted: [
      ...
      "Suzuki is added with も, and the generated stem correctly takes ます.",
      "Mari is added with も to the established future plan.",
      "The repair uses the speaking predicate required by context.",
      "Yuki is added with も; the recoverable meeting partner remains implicit.",
      "The friend is added with も to the established singing routine.",
    ...
    retry: [
      ...
      "Keep the listening verb and express Suzuki’s additional routine.",
      "Keep the making verb and the established antecedent for も.",
      "Diagnose the malformed stem-plus-ending combination before selecting a repair.",
      "Keep the meeting partner implicit and preserve the additional-plan reading.",
      "Retrieve the friend’s additional singing routine.",
...
const ARGUMENT_PARTICLES_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("argument-particles-1", {
    ...
    instructions: [
      ...
      "A magazine purchase is shown in neutral packaging. Repackage the magazine as the established discourse topic.",
      ...
      "Listen to the fruit-purchase confirmation and choose its written match.",
      "From the magazine cue, say Yamada’s hidden reading sentence.",
    ],
    accepted: [
      "The eating predicate licenses the rice theme and its を.",
      "Both choices keep drinking fixed; the selected packaging fits the stated card.",
      "Every tile is used and the predicate remains final.",
      "The fruit is marked as the theme of buying.",
      "The magazine remains the licensed theme of buying while は changes its discourse status.",
    ...
    retry: [
      ...
      "Keep the drinking predicate fixed and compare only the two discourse packages.",
      "Keep を after the letter and put the verb last.",
      "Use the buying predicate for the fruit context.",
      "Topicalize the magazine while keeping the buying predicate unchanged.",
  ...
  ...semanticLessonCopy("argument-particles-4", {
    ...
    retry: [
      ...
      "Keep the reading predicate and package the diary as the established topic.",
...
const TIME_MOVEMENT_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("time-movement-1", {
    ...
    purposes: [
      ...
      "Adds a regular rest event under the habitual reading.",
      "Uses a scheduled sleep event, never an ongoing reading.",
    ],
    instructions: [
      "The learner’s calendar shows running every Saturday. Choose the matching annotation.",
      "Tanaka’s travel booking is dated next month. Choose the matching annotation.",
      "Order every tile on Yamada’s weekly cooking card.",
      "Satou’s ticket is dated tomorrow. Complete the matching card.",
      "Suzuki runs every Sunday. Choose the matching annotation.",
      "Mari’s outing is booked for tomorrow, but the displayed annotation says every week. Repair only that annotation.",
      "Yuki’s calendar marks a rest day every Sunday. Retrieve the matching card.",
      "The friend’s bedtime is on tomorrow’s schedule. Complete the matching card.",
      "Listen for the date on Yamada’s travel booking and choose its written match.",
    ...
    accepted: [
      ...
      "Yuki’s regular rest is retrieved with the weekly reading.",
      "The friend’s sleep event is scheduled for the stated day.",
    ...
    retry: [
      ...
      "Retrieve the established weekly rest card.",
      "Keep the friend’s sleep on the stated schedule.",
  ...
  ...semanticLessonCopy("time-movement-3", {
    ...
    instructions: [
      ...
      "Tanaka’s log has no leisure entry for last week. Retrieve the matching sentence.",
      "Yamada’s roster has no rest shift this week. Choose the matching sentence.",
  ...
  ...semanticLessonCopy("time-movement-4", {
    ...
    instructions: [
      "The morning log records the run as completed. Choose the matching sentence.",
      ...
      "Tanaka’s roster shows the same evening shift every week. Choose the matching sentence.",
