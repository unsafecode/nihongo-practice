...
const SENTENCE_FOUNDATIONS_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("sentence-foundations-1", {
    ...
    instructions: [
      ...
      "At the classroom door, select the fragment that labels the teacher.",
      "When pointing at the animal in a picture, choose the cat fragment.",
      "At school, when asked which object is needed, choose the book fragment.",
      "On a simple map, choose the home fragment.",
      "For the scene with waves, choose the sea fragment.",
      "For the building shown on the morning route, choose the school fragment.",
      "On the telephone screen, choose the photograph fragment.",
      "At the travel counter, say the ticket fragment aloud.",
    ],
  ...
  ...semanticLessonCopy("sentence-foundations-2", {
    ...
    instructions: [
      ...
      "When the category rather than a name is requested, choose person.",
      "In the role slot at the end of the anatomy model, choose student.",
      "In the title slot at the end of the model, choose teacher.",
      "With the photographed speaker already shared, answer only I/me.",
      "With the pictured referent shared, answer only cat.",
      "With the object already pointed out, answer only book.",
      "With the map location shared, answer only home.",
      "With the telephone screen shared, say only photograph.",
    ],
  ...
  ...semanticLessonCopy("sentence-foundations-3", {
    ...
    instructions: [
      ...
      "The clerk points to the ticket; complete the noun predicate with です.",
      "The map points to the school; choose the complete polite identification.",
      "The friend supplies the meeting-time cue; choose the complete predicate identifying morning.",
      "The key is the item in question; complete the polite identification.",
      ...
      "The warning sign is in question; choose the complete caution predicate.",
      "Say the complete polite predicate identifying travel.",
    ],
  ...
  ...semanticLessonCopy("sentence-foundations-4", {
    ...
    instructions: [
      ...
      "With Yamada reintroduced as a hanging topic, identify the friendship relation.",
      "With the friend explicit, choose the broader category student rather than the more specific international-student label.",
      "The pictured scene is already shared; answer only that it is the sea.",
      "In the shared family photograph, answer only that the animal is a cat.",
      "The object being discussed is shared; answer only that it is a telephone.",
      "The place is shared; answer only that it is a home.",
      "The counter item is shared; answer only that it is a ticket.",
      "Say the complete predicate for the shared school referent.",
    ],
...
const TOPIC_QUESTIONS_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("topic-questions-1", {
    ...
    instructions: [
      "The photo shows Tokyo; choose the sentence that sets the photo as topic and identifies Tokyo.",
      "The next photo shows Kyoto; choose the contrasting topic comment.",
      "The third photo shows Osaka; choose its topic comment.",
      "Your student status is already under discussion; choose the established-topic answer.",
      "Tanaka is already under discussion; identify Tanaka as a nurse with は.",
      "Contrast Yamada with Tanaka and identify Yamada as a lawyer.",
      ...
      "The home location is the topic; choose Tokyo as the contextually supplied answer.",
      "The ticket is for Kyoto; say the contrasting ticket-destination answer.",
    ],
  ...
  ...semanticLessonCopy("topic-questions-2", {
    ...
    translations: [
      ...
      "No—Suzuki is the one who is the teacher.",
      "The doctor is Mari.",
      "As for Satou, they are a student.",
      "As for Suzuki, they are a teacher.",
      "As for Mari, they are a doctor.",
    ...
    purposes: [
      ...
      "Uses が for corrective focus after the wrong teacher was proposed.",
      "Uses が for an exhaustive role selection: Mari fills the doctor role.",
    ...
    instructions: [
      "Satou asks which city is newly identified as a city; select Tokyo with focused が.",
      "Suzuki keeps the photograph as the established topic and identifies Tokyo; select は.",
      "Mari asks which city is the newly selected city; select Kyoto with が.",
      "Satou keeps the home as established topic and identifies Kyoto; select は.",
      "Suzuki selects Osaka as the focused city; choose が.",
      "Mari keeps the photograph as established topic and identifies Osaka; choose は.",
      "Tanaka is already the topic; keep は while stating the known nurse fact.",
      "Yamada remains the established topic; keep は with the lawyer fact.",
      "The friend is already established; choose は for the international-student fact.",
      "The question selects the speaker as the new university student; choose が.",
    ],
  ...
  ...semanticLessonCopy("topic-questions-3", {
    ...
    instructions: [
      ...
      "Add that my older brother is also a student, keeping わたしの together.",
      "Add that my older sister is also a lawyer, keeping わたしの together.",
      "With my father established as topic, state that he is a teacher.",
      "With my mother established as topic, state that she is a doctor.",
      "With my older brother established, state that he is a student.",
      "With my older sister established, state that she is a lawyer.",
      "Listen for the respectful family term and additive も in the teacher statement.",
      "Say the respectful mother statement with additive も aloud.",
    ],
  ...
  ...semanticLessonCopy("topic-questions-4", {
    ...
    instructions: [
      "Confirm whether the name is Yuki with a complete か question.",
      "Confirm whether the country is the United States.",
      "When asked which countries are included, answer with the bounded list America and Italy.",
      "When asked which two fields are needed, answer with country and name.",
      "React to surprising information with the complete question “Is that so?”",
      "Confirm the United States with a natural はい response.",
      "Reject Italy and correct the country to the United States.",
      "Ask whether Yuki is friends with someone, using companion と and か.",
      "Listen for the statement “I am friends with Yuki.”",
      "Ask aloud who the person is friends with, using companion と and か.",
    ],
...
const SEMANTIC_OPERATION_COPY_EN: Readonly<Record<string, string>> = {
  ...
  "diagnose-error-feedback-accepted":
    "The diagnosis identifies the actual chunk or particle mismatch.",
  "diagnose-error-feedback-retry":
    "Check the context, then name the specific chunk or particle that conflicts with it.",
