...
export const baseNavigationCopyEn: BaseNavigationCopy = deepFreeze({
  ...
  content: {
    ...
    "snd1-discriminate-vowels-instruction": "Choose the close, high front vowel; the other option is mid front.",
    ...
    "snd2-recognize-jidi-instruction": "Choose the option that completes the displayed spelling pattern.",
