...
const SENTENCE_FOUNDATIONS_COPY_EN: Readonly<Record<string, string>> = {
  ...
  ...semanticLessonCopy("sentence-foundations-4", {
    ...
    constraints:
      "The name-title unit is a bounded modifier-head model. Possessive の and productive noun modification begin in “Noun relations with の, も, and と.”",
    commonError:
      "Do not reverse title and name, insert さん before せんせい, or put です before its noun.",
    nearestContrast:
      "“Predicate-final order and recoverable omission” showed what context can omit; this lesson shows internal modifier-head order and a complete short predicate.",
    recap:
      "Retrieve the bare names and student roles; put a name before せんせい and an identifying noun before です.",
    translations: [
      "This is Sakura, the teacher.",
      "This is Ken, the teacher.",
      "It is a book.",
      "It is a ticket.",
    ...
    retry: [
      ...
      "Use the friend’s established role, not an unrelated title.",
      "Retrieve the established group value for the photograph.",
...
const POLITE_VERBS_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("polite-verbs-1", {
    ...
    purposes: [
      ...
      "Completes the six selected lookup lemmas.",
    ...
    instructions: [
      ...
      "The displayed form is circled inside a model clause. From that context, say the hidden two-label analysis card.",
    ],
    accepted: [
    ...
    retry: [
      "Re-read what the model clause asks you to identify.",
      ...
      "Use the glossary’s displayed layout as the evidence.",
      "Change only the mismatched annotation; keep the verb unchanged.",
      "Retrieve the analysis requested by the worksheet.",
      "Replay the entire recording and compare both complete cards.",
      "Use the model-clause context to reconstruct the hidden analysis; no answer is displayed.",
    ],
  }),
  ...semanticLessonCopy("polite-verbs-2", {
    title: "Verb classes from the complete dictionary form",
    objective:
    ...
    construction:
      "Compare the complete dictionary form with its verb class, then keep する and くる in their own special classes.",
    constraints:
      "Final る alone never proves ichidan. This lesson classifies forms; it does not yet ask you to produce stems.",
    commonError:
      "Do not strip る from every -iru/-eru verb: かえる follows the godan pattern.",
    nearestContrast:
    ...
    translations: [
      ...
      "たべる is ichidan.",
      "みる is ichidan.",
      "する belongs to its own special verb class.",
      "くる belongs to its own special verb class.",
    ...
    purposes: [
      "Classifies the whole verb rather than relying on the final sound alone.",
      ...
      "Distinguishes two similar-looking endings by checking the complete verb.",
      "Applies class recognition in an explicit analysis card.",
      "Retrieves くる with its own explicit class label.",
    ],
    instructions: [
      "A sea-scene lookup card needs a class analysis. Choose the analysis supported by the complete dictionary form.",
      "A viewing-scene lookup card needs a class analysis. Choose the supported analysis.",
      "A menu card shows the verb used for eating. Choose the classification supported by the complete dictionary form.",
      "The reviewed -eru exception card needs a class analysis. Choose the class that fits the complete verb.",
      "The displayed return card was guessed from spelling alone. Choose the repair.",
      "The chart has a separate row for the basic verb used to do an action. Choose the matching row.",
      "The chart has a separate row for the verb used when someone comes. Retrieve the matching row.",
    ...
    accepted: [
      ...
      "みる follows the ichidan class.",
      "The eating verb follows the ichidan classification.",
      ...
      "The spoken card gives the godan analysis for the displayed verb.",
    ],
    retry: [
      "Use the complete dictionary form rather than the scene’s meaning.",
      "Check the complete dictionary form rather than its visible ending alone.",
      "Compare the complete eating lemma with the two proposed classifications.",
      "Use the exception note attached to the displayed entry.",
      "Identify the suffix-only guess as the error.",
      "Use the chart row reserved for the displayed entry.",
      "Retrieve the separate chart row for the displayed entry.",
      "Compare the complete dictionary form against both proposed analyses.",
      "Replay the complete recording and compare both written cards.",
  ...
  ...semanticLessonCopy("polite-verbs-3", {
    ...
    main:
      "The polite stem follows the verb class. Godan moves to the i-row, ichidan removes る, する uses し, and くる uses き.",
    construction:
    ...
    purposes: [
      "Derives a godan stem with the godan rule.",
      "Shows the godan つ-to-ち row change.",
      "Applies the special exception correctly.",
    ...
    instructions: [
      ...
      "Listen to which of the two proposed analyses is read aloud, then choose its exact written match.",
      "From the displayed reading lookup form, say the hidden stem analysis.",
    ],
    accepted: [
      "The godan rule yields かき.",
      "The godan rule changes まつ to まち.",
    ...
    retry: [
      "Reapply the transformation rule to the displayed dictionary form.",
      "Reapply the transformation rule to the displayed waiting verb.",
      "Re-check how the displayed study card maps onto one complete analysis.",
      "Reapply the exceptional mapping shown in this lesson; the later ending is outside this task.",
      "Reapply the separate mapping shown for the coming card.",
      "Use the exception note rather than the regular-looking shortcut.",
      "Reapply the compound rule to the displayed telephone card.",
      "Reapply the compound rule to the displayed walking card.",
      "Replay the entire recording and compare both complete cards.",
  ...
  ...semanticLessonCopy("polite-verbs-4", {
    ...
    retry: [
      ...
      "Re-check how the displayed route maps onto one complete sentence.",
      "Use the roster context to rebuild Yamada’s complete statement.",
      "Use the schedule context to rebuild Tanaka’s complete statement.",
...
const ARGUMENT_PARTICLES_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("argument-particles-1", {
    ...
    instructions: [
      "The duty card identifies the learner as the eater and introduces rice as new information. Choose the neutral sentence.",
      ...
      "The duty card identifies the learner as the buyer, and the magazine is already under discussion. Repackage only its information status.",
      ...
      "The roster identifies the learner as the writer and introduces the letter as new information. Retrieve the neutral sentence.",
    ...
    retry: [
      ...
      "Re-check how the displayed letter card maps onto one complete sentence.",
      "Keep Satou and buying fixed; follow the new-information context.",
      "Use the duty card’s information status and compare the source with both outcomes.",
      ...
      "Use the roster’s information status while keeping every participant unchanged.",
      "Replay the whole recording and compare both complete sentences.",
  ...
  ...semanticLessonCopy("argument-particles-2", {
    ...
    constraints:
      "へ is pronounced e. に and へ are not cosmetic substitutes in these practice sentences.",
    commonError:
    ...
    retry: [
      "Re-read whether the ticket describes a stop or an open route.",
      "Use the continuing arrow as the evidence for the trip.",
      "Re-check how the displayed appointment maps onto one complete sentence.",
      "Use the arrow on Satou’s route card as the evidence.",
      "Change the licensed movement view, not merely the printed glyph.",
      "Check the entire itinerary against both complete alternatives.",
      "Use the continuing map arrow as the evidence.",
      "Use the ticket’s stopping condition and compare both complete routes.",
      "Replay the whole recording and compare both written travel statements.",
      "Use the map arrow to reconstruct the whole hidden route; no option is shown.",
    ],
  }),
  ...semanticLessonCopy("argument-particles-3", {
    ...
    retry: [
      "Use the note’s stay-versus-tool distinction and compare both sentences.",
      "Use Tanaka’s stated writing setup and compare both sentences.",
      "Re-check how the displayed ticket maps onto one complete sentence.",
      "Use the icon on Satou’s travel pass and compare both routes.",
      "Use Suzuki’s stated writing setup and compare both sentences.",
      "Diagnose the incompatible label without changing the writing form.",
      "Use the stated details and retrieve the complete sentence.",
      "Use Yamada’s stated details and compare both sentences.",
      "Replay the whole recording and compare both written routes.",
      "Reconstruct the hidden writing sentence from the displayed cue.",
    ],
  }),
  ...semanticLessonCopy("argument-particles-4", {
    ...
    instructions: [
      "The learner is assigned this trip, and the ticket names the cafeteria as where it ends. Choose the matching sentence.",
      ...
      "The report identifies Satou as the eater and introduces rice as new information. Complete the neutral sentence.",
    ...
    accepted: [
      "The cafeteria is the arrival point for the learner’s trip.",
      "The office is licensed as the location of Tanaka’s writing.",
      "The umbrella remains the bought theme.",
      "Rice is introduced neutrally in Satou’s eating sentence.",
    ...
    retry: [
      "Use the stated travel situation and compare both complete sentences.",
      "Use the stay-versus-tool detail and compare both writing sentences.",
      "Re-check how the displayed purchase card maps onto one complete sentence.",
      "Use the report and compare both complete eating statements.",
      "Use the continuing map arrow and compare both route views.",
      "Use the desk record to identify the single implausible item.",
      "Keep reading fixed and package the diary as already established.",
      "Use the ticket’s stopping condition and compare both cards.",
      "Replay the whole recording and compare both written routes.",
...
const TIME_MOVEMENT_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("time-movement-1", {
    ...
    purposes: [
      ...
      "Uses an explicit future time without ongoing meaning.",
    ...
    retry: [
      "Re-read whether the card describes a routine or a dated plan.",
      "Use the date on the work booking and compare both complete sentences.",
      "Re-check how the displayed cooking card maps onto one complete sentence.",
      "Use the date printed on Satou’s ticket and compare both sentences.",
      "Use the filing category on Suzuki’s card and compare both sentences.",
      "Use the booking conflict and change only the mismatched time evidence.",
      "Use the recurrence marks on the calendar and retrieve the complete sentence.",
      "Use the date on the bedtime schedule and compare both sentences.",
      "Replay the whole recording and compare both written sentences.",
      "Reconstruct the hidden outing sentence from both displayed cues.",
    ],
  }),
  ...semanticLessonCopy("time-movement-2", {
    ...
    construction:
      "Classify the time expression, then add に only to the selected specific-time sentence; use から for a start and まで for an endpoint.",
    constraints:
    ...
    retry: [
      "Use the alarm card’s clock reading and compare both statements.",
      "Use the date printed on the day-off note and compare both statements.",
      "Re-check how the displayed schedule maps onto one complete sentence.",
      "Use Satou’s schedule card and compare both plans.",
      "Use both stated interval boundaries and compare the complete sentences.",
      "Use the requirement for a complete route and repair only the missing bound.",
      "Check whether the study card marks a cutoff or a single appointment.",
      "Use the origin shown on the return card and compare both statements.",
      "Replay the whole recording and compare both written plans.",
      "Reconstruct the hidden route from all displayed cues.",
    ],
  }),
  ...semanticLessonCopy("time-movement-3", {
    ...
    main:
      "Polite verbs have exactly four cells here: nonpast affirmative, nonpast negative, past affirmative, and past negative.",
    construction:
    ...
    retry: [
      "Use the scheduled shift and compare both complete forms.",
      "Use the roster date and check which complete form fits it.",
      "Re-check how the attendance log maps onto one complete sentence.",
      "Use the completion mark in the log and apply the owned transformation.",
      "Use the empty attendance log and compare both complete forms.",
      "Use the cancellation and schedule date together; repair only the form.",
      "Use the empty log entry and compare both complete forms.",
      "Use the absence mark on the calendar and compare both dates.",
      "Replay the whole recording and compare both written forms.",
      "Reconstruct the hidden plan from every displayed cue.",
    ],
  }),
  ...semanticLessonCopy("time-movement-4", {
    ...
    accepted: [
      ...
      "Sunday takes に in the stated routine.",
    ...
    retry: [
      "Use the completed event in the morning log and compare both forms.",
      "Use the date printed on the meeting card and compare both plans.",
      "Re-check how the displayed work card maps onto one complete sentence.",
      "Use the date on the lunch schedule and compare both statements.",
      "Use both recurrence marks on the study card and compare both statements.",
      "Use the cancellation mark and repair only the mismatched event status.",
      "Use the day named on the calendar and retrieve the complete routine.",
      "Use the time marker on the review schedule and compare both statements.",
      "Replay the whole recording and compare both written travel statements.",
      "Reconstruct the hidden event sentence from both displayed cues.",
    ],
  }),
  ...
  "noun-ashita-meaning": "tomorrow; the next day",
...
const COPULA_ADJECTIVES_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("copula-adjectives-1", {
    title: "Affirmative and negative noun predicates",
    objective:
      "Review affirmative です and use ではありません for a polite negative noun predicate.",
    main:
      "A noun predicate identifies or classifies someone or something. Keep reviewed です for an affirmative statement and use ではありません for its polite negative counterpart.",
    construction:
      "Keep the same topic and predicate noun; select です when the classification holds and ではありません when it does not.",
    constraints:
      "The canonical negative here is ではありません. じゃありません is only a linked recognition variant, never the reference replacement.",
    commonError:
      "Do not negate only the noun or attach an adjective ending to a noun.",
    nearestContrast:
      "たなかさんはかいしゃいんです affirms a role; やまださんはかいしゃいんではありません denies that role.",
    recap:
      "Retrieve the affirmative noun predicate, then contrast it with the polite negative while keeping the noun unchanged.",
    translations: [
      "Tanaka is a company employee.",
      "Yamada is not a company employee.",
      "Satou is a researcher.",
      "Suzuki is not a researcher.",
      "Mari is a cook.",
      "I am not a cook.",
      "Tanaka is not a student.",
      "Yamada is a teacher.",
      "Satou is not a nurse.",
      "Suzuki is a lawyer.",
    ],
    purposes: [
      "Reviews affirmative です with a new profession.",
      "Introduces polite negative noun predication.",
      "Keeps the noun predicate affirmative.",
      "Changes only polarity for a noun predicate.",
      "Uses the reviewed affirmative pattern with a person.",
      "Uses ではありません with a recoverable speaker.",
      "Contrasts the earlier affirmative student predicate.",
      "Retrieves affirmative noun predication.",
      "Applies the negative copula to a reviewed role.",
      "Closes with a clear affirmative contrast.",
    ],
    instructions: [
      "A personnel card confirms the displayed role. Choose the matching complete statement.",
      "A directory crosses out the proposed role. Choose the statement that fits the record.",
      "Arrange the displayed personnel chunks into one complete statement.",
      "A corrected staff list rejects its earlier classification. Complete the response.",
      "Update the highlighted record after its status changes.",
      "The displayed personnel statement conflicts with the marked record. Choose the one-change repair.",
      "The visible friend profile crosses out company employee for the friend. Choose the matching statement.",
      "A kitchen roster identifies the speaker's job. Retrieve the matching identity statement.",
      "Listen to the complete personnel statement, then choose its exact written match.",
      "The hidden record says Satou is not a company employee. Say that complete Japanese correction from memory.",
    ],
    accepted: [
      "The statement affirms the role recorded on the card.",
      "The statement politely denies the crossed-out role.",
      "The person remains the topic and the identifying noun completes the statement.",
      "The completed response matches the corrected record.",
      "Only the requested status changes.",
      "The repair changes the polarity and preserves the person and role.",
      "The response matches the visible friendship profile.",
      "The identity statement matches the kitchen roster.",
      "The written statement matches the complete recording.",
      "The spoken statement preserves the hidden correction.",
    ],
    retry: [
      "Compare both complete statements with the confirmation mark.",
      "Use the crossed-out status rather than guessing from the person's name.",
      "Keep the personnel chunks together as one complete claim.",
      "Use only the corrected record shown in the situation.",
      "Keep the person and role fixed while applying the update.",
      "Change only the part contradicted by the record.",
      "Return to the visible profile before choosing.",
      "Use the workplace clue while keeping the complete identity pattern.",
      "Replay the whole recording and compare both written statements.",
      "Recover the named person, recorded role, and marked status without reading a choice.",
    ],
  }),
  ...semanticLessonCopy("copula-adjectives-2", {
    title: "The four noun-predicate cells",
    objective:
      "Use noun predicates across nonpast and past, affirmative and negative.",
    main:
      "Polite noun predicates have four canonical cells: です, ではありません, でした, and ではありませんでした.",
    construction:
      "First locate the situation in present or past time, then preserve the predicate noun while choosing whether the classification holds.",
    constraints:
      "Past time and negative polarity are separate choices; the full past negative must retain both.",
    commonError:
    ...
    translations: [
      ...
      "Yamada is not an engineer.",
      "Satou was an engineer.",
      "Suzuki was not an engineer.",
      "Mari is a bank employee.",
      "Yuki is not a bank employee.",
      "I was a bank employee.",
      "Tanaka was not a civil servant.",
      "Yamada was a civil servant.",
      "Satou is not a civil servant.",
    ],
    purposes: [
      "Shows the nonpast affirmative cell.",
      "Shows the nonpast negative cell.",
      "Introduces the past affirmative noun predicate.",
      "Introduces the past negative noun predicate.",
      "Applies the first grid cell to a new role.",
      "Applies the second grid cell.",
      "Applies the past affirmative cell.",
      "Applies the full past-negative ending.",
      "Contrasts past affirmative and past negative.",
      "Returns to nonpast negative without changing the noun.",
    ],
    instructions: [
      "A former-employment card confirms the recorded role. Choose the matching statement.",
      "A dated bank record rejects the proposed status. Choose the matching statement.",
      "Arrange the displayed historical-record chunks into one complete statement.",
      "A résumé marks the former role as absent. Complete the record.",
      "Move the profile from its current entry to its earlier entry.",
      "The historical status on the displayed record is wrong. Choose the one-change repair.",
      "Use the school alumnus record and choose the supported statement.",
      "An archived public-service roster identifies the former role. Retrieve the matching statement.",
      "Listen to the complete historical statement, then choose its exact written match.",
      "The hidden history says the cook did not work as an engineer in the past. Say that complete Japanese record from memory.",
    ],
    accepted: [
      "The statement matches the confirmed former role.",
      "The time and status both match the dated record.",
      "The historical chunks form one predicate-final statement.",
      "The response preserves the person and records the absent former role.",
      "The transformed statement matches the earlier entry.",
      "The repair changes only the contradicted status.",
      "The statement follows the visible alumnus record.",
      "The retrieved statement matches the archived public-service role.",
      "The written statement matches the complete recording.",
      "The spoken answer preserves the hidden historical status.",
    ],
    retry: [
      "Use the date and confirmation mark together.",
      "Compare the complete statements with the dated status.",
      "Keep the historical record as one complete claim.",
      "Use the résumé mark without changing the person or role.",
      "Keep the profile fixed and use the earlier entry.",
      "Repair only what the historical record contradicts.",
      "Return to the visible alumnus record.",
      "Use the archived workplace clue with a complete past statement.",
      "Replay the whole recording before comparing the two statements.",
      "Recover the person, former role, time, and marked status without reading an option.",
    ],
  }),
  ...semanticLessonCopy("copula-adjectives-3", {
    title: "Descriptive adjectives that self-conjugate",
    objective:
      "Use い-adjectives as predicates and noun modifiers across the Base time-and-polarity grid.",
    main:
      "An い-adjective carries its own inflection. Polite です follows the completed adjective form as a politeness marker; it is not plain copula だ.",
    construction:
      "For おいしい, use おいしい, おいしくない, おいしかった, or おいしくなかった before polite です. Before a noun, keep the dictionary adjective directly before that noun.",
    constraints:
      "Never add plain だ after an い-adjective. The reviewed adjective forms also include the irregular よ- forms of いい.",
    commonError:
      "たかいだ is not a valid い-adjective predicate; repair only that ending.",
    nearestContrast:
      "おいしいです is predicative and polite; おいしいごはん places the same adjective directly before a noun.",
    recap:
      "Retrieve all four predicate forms, the direct noun-modifier pattern, and the rule that です marks politeness here.",
    translations: [
      "The rice is tasty.",
      ...
      "The shop was good.",
      "The cafeteria was not good.",
      "It is tasty rice.",
      "It is an expensive bicycle.",
    ],
    purposes: [
      "Shows an い-adjective predicate with polite です.",
      "The adjective itself forms the negative.",
      "Shows the self-conjugated past affirmative.",
      "Shows the full past-negative adjective ending.",
      "Keeps です as politeness, never plain だ.",
      "Changes only adjective polarity.",
      "Uses the irregular stem for いい.",
      "Completes the irregular いい grid.",
      "Uses an い-adjective directly before a noun.",
      "Contrasts attributive use with predicative politeness.",
    ],
    instructions: [
      "A tasting card marks the displayed water as tasty. Choose the matching statement.",
      "A price card marks the displayed rice as not expensive. Choose the supported statement.",
      "Arrange the displayed review chunks into one complete statement.",
      "A dated tasting note rejects its earlier evaluation. Complete the note.",
      "Move the displayed review from its current entry to its dated entry.",
      "The displayed evaluation contains one malformed ending. Choose the one-change repair.",
      "Use the speaker's scorecard and choose the supported statement.",
      "A market note describes the sampled fruit. Retrieve the matching noun description.",
      "Listen to the complete evaluation, then choose its exact written match.",
      "The hidden review says the magazine was not good. Say that complete Japanese evaluation from memory.",
    ],
    accepted: [
      "The completed adjective form matches the tasting card.",
      "The price evaluation matches the rejected proposal.",
      "The review chunks form one predicate-final statement.",
      "The response preserves the item and matches the dated evaluation.",
      "Only the requested time setting changes.",
      "The repair removes the invalid plain-copula construction.",
      "The response matches the visible scorecard.",
      "The noun description matches the sampled fruit.",
      "The written statement matches the complete recording.",
      "The spoken evaluation is the uniquely recoverable hidden answer.",
    ],
    retry: [
      "Compare both complete evaluations with the tasting mark.",
      "Keep the displayed rice fixed and use the price mark.",
      "Keep the review chunks together as one complete claim.",
      "Use the dated mark and keep the evaluated item fixed.",
      "Keep the evaluation fixed while applying the date.",
      "Repair only the malformed ending shown.",
      "Return to the visible scorecard.",
      "Use the market clue and keep the adjective directly before its noun.",
      "Replay the whole recording before comparing both statements.",
      "Recover the reviewed item, dated rating, and whether that rating held without reading a choice.",
    ],
  }),
  ...semanticLessonCopy("copula-adjectives-4", {
    title: "Nominal-type adjectives and noun modification",
    objective:
      "Use な-adjectives with a copula predicatively and な before a modified noun.",
    main:
      "A な-adjective behaves like a nominal-type predicate: it needs a copula in predicate position, but it takes な directly before a noun.",
    construction:
      "Use です, ではありません, でした, or ではありませんでした after the adjective in predicate position; insert な between the adjective and its noun in attributive position.",
    constraints:
      "Do not omit the predicative copula or attributive な, and do not impose this rule on い-adjectives.",
    commonError:
      "しずかしょくどうです lacks the required attributive な; add only that link.",
    nearestContrast:
      "しずかです needs a copula as a predicate; しずかなしょくどう needs な before the noun; たかいかさ uses neither rule.",
    recap:
      "Retrieve the four copular predicate cells and the separate attributive な pattern while keeping い-adjectives distinct.",
    translations: [
      "The office is quiet.",
      "The shop is not quiet.",
      "The park was pretty.",
      "The office was not clean.",
      "Satou is famous.",
      "I am not well.",
      "It is a quiet office.",
      "They are a well-presented student.",
      "The park is nice.",
      "It is an expensive umbrella.",
    ],
    purposes: [
      "Shows that predicative な-adjectives require the copula.",
      "Uses the nominal-type negative copula path.",
      "Uses the past affirmative copula.",
      "Uses the complete past-negative copula.",
      "Keeps the nominal-type predicate bounded.",
      "Applies the same nominal-type copula path.",
      "Requires な before the modified noun.",
      "Applies attributive な to another adjective.",
      "Keeps the い-adjective path distinct.",
      "Shows that an い-adjective never inserts な.",
    ],
    instructions: [
      "Mari's profile describes her as quiet. Choose the matching statement.",
      "A dated inspection says the displayed umbrella was not clean. Choose the supported statement.",
      "Arrange the displayed profile chunks into one complete statement.",
      "A health card says the displayed friend is not well. Complete the response.",
      "Move the park report from its current entry to its dated entry.",
      "The displayed cafeteria description is missing one required link. Choose the one-change repair.",
      "A visitor report marks the displayed office as clean. Choose the supported statement.",
      "An earlier report calls the displayed shop quiet. Retrieve its noun description.",
      "Listen to the complete place description, then choose its exact written match.",
      "The hidden current profile says the student is pretty now. Say that complete Japanese description from memory.",
    ],
    accepted: [
      "The description uses the copular predicate path required here.",
      "The dated inspection statement matches the card.",
      "The profile chunks form one predicate-final statement.",
      "The completed response matches the health card.",
      "The transformed report keeps the place fixed.",
      "The repair inserts the required noun-modifying link and changes nothing else.",
      "The statement matches the visitor report.",
      "The retrieved description follows the noun-modifier pattern.",
      "The written description matches the complete recording.",
      "The spoken profile preserves the hidden description.",
    ],
    retry: [
      "Compare both complete descriptions with the report.",
      "Use the date and inspection result together.",
      "Keep the profile chunks together as one complete claim.",
      "Use the visible health card without changing its participant.",
      "Keep the place and description fixed while applying the date.",
      "Add only the missing link shown by the noun-description context.",
      "Return to the visible visitor report.",
      "Use the earlier noun-description pattern with this place.",
      "Replay the whole recording before comparing both statements.",
      "Recover the person, current description, and whether it holds without reading a choice.",
    ],
  }),
  "noun-kaishain-meaning": "company employee",
  "noun-kenkyuusha-meaning": "researcher",
  "noun-ryourinin-meaning": "cook; chef",
  "noun-enjinia-meaning": "engineer",
  "noun-ginkouin-meaning": "bank employee",
  "noun-koumuin-meaning": "civil servant",
  "adjective-oishii-meaning": "tasty; delicious",
  "adjective-takai-meaning": "expensive; high",
  "adjective-ii-meaning": "good",
  "adjective-shizuka-meaning": "quiet",
...
const EXISTENCE_LOCATION_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("existence-location-1", {
    title: "Choosing animate or inanimate existence",
    objective:
      "Choose ある for things and いる for people and animals in statements of existence.",
    main:
      "Japanese uses two existence verbs. In this lesson's established-topic questions and answers, ある marks an inanimate thing as available or present; いる marks a person or animal as present.",
    construction:
      "Start with a referent already established by the situation, mark that topic with は, then select polite あります or います from its entity class.",
    constraints:
      "These nonpast predicates describe a present state. They do not mean that the entity is carrying out an action right now.",
    commonError:
      "Do not choose the verb from an English translation alone; first decide whether the Japanese referent is animate.",
    nearestContrast:
      "These は clauses ask or answer about an established referent; they do not neutrally introduce a new one.",
    recap:
      "Retrieve the independent entity class, then use あります for a thing or います for a person or animal.",
    translations: [
      "Yes, the desk is available.",
      "Yes, the dog is here.",
      "The car is available, right?",
      "Yes, the book is available.",
      "My friend is here.",
      "Is the umbrella here?",
      "The teacher is here, isn't she?",
      "Yes, the pencil is available.",
      "Is Tanaka here?",
      "The bicycle is available.",
    ],
    purposes: [
      "Answers about an already requested thing with あります.",
      "Answers about an established animal with います.",
      "Confirms availability of a known inanimate option.",
      "Answers about a requested object.",
      "Reports an established person as present.",
      "Checks for a previously mentioned item.",
      "Confirms the presence of an established person.",
      "Answers a stock question about a known item.",
      "Asks whether a named person is present.",
      "Reports availability of a selected vehicle.",
    ],
    instructions: [
      "A kennel card confirms that the displayed dog is present. Choose the complete matching line.",
      "An inventory asks whether the displayed car is present. Choose the matching question.",
      "Arrange the displayed attendance chunks into one complete statement.",
      "A stock check asks whether the displayed desk is present. Complete the check.",
      "Update the attendance line for the displayed person.",
      "The displayed attendance line conflicts with the person card. Choose the one-change repair.",
      "A visitor log identifies which displayed person is present. Choose the supported line.",
      "A pantry record identifies which displayed item is available. Retrieve the supported line.",
      "Listen to the complete desk comment, then choose its exact written match.",
      "Recall the hidden student attendance record and say the full statement.",
    ],
    accepted: [
      "The complete line matches the kennel record.",
      "The question matches the inventory record.",
      "The chunks form one complete predicate-final statement.",
      "The completed check matches the stock record.",
      "The updated attendance line matches the card.",
      "The repair changes only the incompatible existence verb.",
      "The response matches the visitor log.",
      "The response matches the pantry record.",
      "The written line matches the whole recording.",
      "The spoken line preserves the hidden attendance fact.",
    ],
    retry: [
      "Compare both complete lines with the same kennel card.",
      "Use the inventory situation without guessing from option length.",
      "Keep the displayed chunks together as one statement.",
      "Return to the stock check before choosing.",
      "Keep the displayed person fixed while updating the line.",
      "Repair only the part contradicted by the attendance card.",
      "Use only the visible visitor record.",
      "Return to the pantry record and compare both full lines.",
      "Replay the whole recording before comparing the endings.",
      "Recall the attendance card without reading an option.",
    ],
  }),
  ...semanticLessonCopy("existence-location-2", {
    title: "Place and entity in existence statements",
    objective:
      "Build the exact existence frame place に entity が あります or います.",
    main:
      "An existence statement first locates a scene with に, then marks the entity introduced in that scene with が.",
    construction:
      "Say the place plus に, the entity plus が, and finish with あります for an inanimate entity or います for an animate one.",
    constraints:
      "The two particles attach to different meanings: に marks the existence location, while が marks what exists there.",
    commonError:
      "Do not exchange the two attachments or choose the existence verb without checking the entity.",
    nearestContrast:
      "へやにいすがあります locates a chair; にわにいぬがいます locates a dog.",
    recap:
      "Retrieve the complete place に entity が frame and preserve both attachments before selecting the existence verb.",
    translations: [
      ...
      "There is a car at the shop.",
      "There is a book in the room.",
      "Mari is in the garden.",
      "There is a pencil in the office.",
      "There is a dog in the park.",
    ],
    purposes: [
      "Introduces the complete frame.",
      "Uses the frame with a living entity.",
      "Fixes the location attachment.",
      "Fixes the entity attachment.",
      "Keeps the predicate stative.",
      "Uses another thing and place.",
      "Retrieves a familiar object.",
      "Locates a named person.",
      "Preserves both attachments.",
      "Closes with an animate frame.",
    ],
    instructions: [
      "The floor plan places the displayed chair in the office. Choose the complete matching statement.",
      "A room register marks who is present. Choose the supported complete statement.",
      "Arrange the displayed location chunks into one predicate-final statement.",
      "The updated log places the displayed dog at the university. Complete the statement.",
      "The plan places the displayed umbrella in the garden. Update the statement.",
      "The displayed room statement uses the wrong existence verb for its entity. Choose the one-change repair.",
      "A shop log records the displayed visitor. Choose the supported statement.",
      "The plan places the displayed pencil in the room. Retrieve the complete frame.",
      "Listen to the complete dog-location statement, then choose its exact written match.",
      "Recall the hidden park attendance record and say the full statement.",
    ],
    accepted: [
      "The chair statement matches the room plan.",
      "The complete statement matches the room register.",
      "The chunks preserve the location and entity attachments.",
      "The updated statement matches the building log.",
      "The umbrella is placed at the marked location.",
      "The repair changes only the incompatible existence verb.",
      "The visitor statement matches the shop log.",
      "The retrieved statement uses the complete location frame.",
      "The written statement matches the full recording.",
      "The spoken statement preserves the hidden park record.",
    ],
    retry: [
      "Compare both full statements with the same plan.",
      "Use the room register without relying on option length.",
      "Keep each particle beside the noun it follows.",
      "Keep the dog fixed and use the updated location.",
      "Return to the marked place on the plan.",
      "Repair only the verb contradicted by the visible entity.",
      "Use only the shop visitor record.",
      "Rebuild the complete frame from the plan.",
      "Replay the whole recording before comparing locations.",
      "Recall the park record without reading a choice.",
    ],
  }),
  ...semanticLessonCopy("existence-location-3", {
    title: "Existence location, action place, and topic",
    objective:
      "Distinguish existence-location に from action-place で and existential が from topic は.",
    main:
      "Location marking follows the predicate's relation to the place. Existence selects に; an action carried out at a place selects で.",
    construction:
      "Use place に entity が when introducing what exists. Use entity は place に when continuing an established topic. Use place で with an action predicate.",
    constraints:
      "The surface location does not choose a particle by itself. Predicate licensing and information structure determine the relation.",
    commonError:
      "Do not replace existential が with は when the context neutrally introduces a new entity.",
    nearestContrast:
      "きょうしつにいすがあります says a chair exists there; きょうしつでべんきょうします says studying happens there.",
    recap:
      "Retrieve the predicate relation first, then distinguish new existential が from an already established topic は.",
    translations: [
      ...
      "There is a flower in the room.",
      "As for the fish, it is at home.",
      "As for the flower, it is in the room.",
      "I play in the garden.",
      "The teacher is in the office.",
    ],
    purposes: [
      "Uses に for existence.",
      "Contrasts action-place で.",
      "Keeps an animate existence frame.",
      "Uses で with working.",
      "Uses いる for a child in a plausible outdoor setting.",
      "Classifies a flower for ある.",
      "Continues a household fish as the established topic.",
      "Contrasts topic and existential focus.",
      "Shows another action place.",
      "Returns to a stative location.",
    ],
    instructions: [
      "A home card describes what is present rather than an activity. Choose the matching statement.",
      "A classroom card identifies what is present there. Choose the supported statement.",
      "Arrange the displayed chunks that place the fish at home into one complete statement.",
      "A conversation continues talking about the displayed flower. Complete the response.",
      "Change an activity card into the presence report shown beside it.",
      "The displayed room line introduces a new dog but uses the continuing-topic marking. Choose the one-change repair.",
      "A workplace schedule reports an activity. Choose the matching statement.",
      "Retrieve the location statement for the already established teacher.",
      "Listen to the complete Yuki-location statement, then choose its exact written match.",
      "Recall the hidden study-location card and say the full statement.",
    ],
    accepted: [
      "The statement matches a presence report.",
      "The classroom statement matches what is present.",
      "The chunks form one complete existence statement.",
      "The response keeps the established flower as topic.",
      "The transformed statement matches the presence report.",
      "The repair changes only the information-structure marking.",
      "The statement matches the workplace activity.",
      "The retrieved line keeps the established teacher as topic.",
      "The written line matches the whole recording.",
      "The spoken line matches the hidden study card.",
    ],
    retry: [
      "Decide what relation the home card reports before choosing.",
      "Use the classroom card, not the apparent length of an option.",
      "Keep each displayed chunk in one predicate-final statement.",
      "Keep the flower established throughout the response.",
      "Use the presence report as the transformation goal.",
      "Repair only the marking contradicted by the introduction context.",
      "Return to the visible workplace schedule.",
      "Keep the teacher established while retrieving the location.",
      "Replay the whole recording before comparing locations.",
      "Recall the study card without reading an option.",
    ],
  }),
  ...semanticLessonCopy("existence-location-4", {
    title: "Finding people and things",
    objective:
      "Ask where a person or thing is and understand a practical location answer.",
    main:
      "Use どこに in a polite existence question, with ある for a thing or place and いる for a person or animal.",
    construction:
      "Make the sought entity the topic, add どこに, finish with the appropriate existence verb and か, then answer with a concrete location.",
    constraints:
      "Existence can describe where a personal item is, but this lesson does not turn ある or いる into a universal translation of English have.",
    commonError:
    ...
    translations: [
      ...
      "The restroom is at reception.",
      "Where is the police officer?",
      "The police officer is at the convenience store.",
      "Where is the bus stop?",
      "The bus stop is at the station.",
      "Where is the bag?",
      "There is a map at reception.",
    ],
    purposes: [
      "Asks for a thing.",
      "Answers with a landmark.",
      "Asks for a person.",
      "Answers with an animate location.",
      "Asks for a landmark.",
      "Gives a practical location.",
      "Asks about a personal item.",
      "Uses natural possession-like existence.",
    ],
    instructions: [
      "A driver is looking for the displayed car. Choose the matching location question.",
      "A room card shows who is present. Choose the supported location statement.",
      "Arrange the displayed bus-stop location chunks into one complete answer.",
      "The building plan places the displayed map at the convenience store. Complete the answer.",
      "Update the location response for the displayed restroom while keeping the room fixed.",
      "The displayed reception line uses the wrong existence verb for the station employee. Choose the one-change repair.",
      "The station map places the displayed convenience store at the station. Choose the supported answer.",
      "The staff roster places the established station employee in the classroom. Retrieve the response.",
      "Listen to the complete bag-location response, then choose its exact written match.",
      "The hidden station card places the police officer at the station. Say that complete Japanese location response from memory.",
    ],
    accepted: [
      "The question asks for the displayed car.",
      "The statement matches the room card.",
      "The chunks form one complete location answer.",
      "The map statement matches the building plan.",
      "The updated response follows the displayed item.",
      "The repair changes only the incompatible existence verb.",
      "The answer matches the station map.",
      "The response keeps the station employee as the established topic.",
      "The written response matches the whole recording.",
      "The spoken response preserves the hidden location.",
    ],
    retry: [
      "Keep the displayed car fixed while comparing both questions.",
      "Use the room card without guessing from sentence length.",
      "Keep the bus-stop chunks in one predicate-final answer.",
      "Return to the building plan before choosing.",
      "Keep the marked room fixed and track the displayed item.",
      "Repair only the verb contradicted by the station employee.",
      "Use only the visible station map.",
      "Keep the established employee fixed while retrieving the place.",
      "Replay the whole recording before comparing the locations.",
      "Recover the person and recorded place from the hidden card without reading an option.",
    ],
  }),
  "existence-location-4-practical-dialogue-outcome":
    "Ask for a map, find it at reception, then ask where the station employee is.",
  "existence-location-4-practical-dialogue-turn-1-translation":
    "Where is the map?",
  "existence-location-4-practical-dialogue-turn-1-purpose":
    "Opens by asking for an inanimate object.",
  "existence-location-4-practical-dialogue-turn-2-translation":
    "The map is at reception.",
  "existence-location-4-practical-dialogue-turn-2-purpose":
    "Provides the requested landmark.",
  ...
  "existence-location-4-practical-dialogue-turn-3-purpose":
    "Continues by asking for a person.",
  "existence-location-4-practical-dialogue-turn-4-translation":
    "The station employee is at reception.",
  "existence-location-4-practical-dialogue-turn-4-purpose":
    "Closes with an animate location answer.",
  ...semanticLessonCopy("requests-connection-1", {
    title: "Building every bounded te form",
    objective:
      "Produce the practical te form for every Base verb class and ending family.",
    main:
      "The te form follows a verb's class and ending: う・つ・る become って; む・ぶ・ぬ become んで; く becomes いて; ぐ becomes いで; and す becomes して.",
    construction:
      "For ichidan verbs replace final る with て. Store する→して and くる→きて separately, and retain the reviewed exception いく→いって.",
    constraints:
      "These changes provide only the bounded te form used in this module; they do not introduce a full informal conjugation system.",
    commonError:
      "Do not extend the regular く pattern to いく: the canonical form is いって, not いいて.",
    nearestContrast:
      "The dictionary form names the lexical entry; the te form is the linked form used by the three constructions that follow.",
    recap:
      "Choose the verb class and final-sound family, apply the matching change, and remember that いく becomes いって.",
    translations: [
      "かう becomes かって.",
      "まつ becomes まって.",
      "とる becomes とって.",
    ...
    purposes: [
      "Shows the う member of the って family.",
      "Shows the つ member of the って family.",
      "Shows the godan る member of the って family.",
      "Shows the む member of the んで family.",
      "Shows the ぶ member of the んで family.",
      "Shows the ぬ member of the んで family.",
      "Shows the regular く to いて change.",
      "Shows the ぐ to いで change.",
      "Shows the す to して change.",
      "Shows the ichidan る replacement.",
      "Keeps する as a special form.",
      "Keeps くる as a special form.",
      "Records いって instead of overgeneralized いいて.",
      "Applies the くる change inside a compound.",
    ],
    instructions: [
      "Use the displayed action card to complete its linked change.",
      "Keep the action fixed and choose the matching result card.",
      "Build the comparison card from all the displayed pieces.",
      "Use the card for the action of turning something off.",
      "Complete the displayed change for opening.",
      "The travel card disagrees with the reviewed travel form. Repair only that form.",
      "Retrieve the linked form for bringing something.",
      "Recall the special form for coming.",
      "Listen to the whole recording, then choose the matching complete card.",
      "Recall the linked spoken form without reading an option.",
    ],
    accepted: [
      "Right: とる links to とって.",
      "Right: しぬ links to しんで.",
      "Right: the source and result are in a usable order.",
      "Right: けす links to けして.",
      "Right: あける links to あけて.",
      "Right: the travel form is いって.",
      "Right: もってくる links to もってきて.",
      "Right: くる links to きて.",
      "Right: that card matches the recording.",
      "Right: はなす links to はなして.",
    ],
    retry: [
      "Keep the same action and revisit its ending family.",
      "Keep the source card fixed before trying again.",
      "Use every displayed piece once.",
      "Return to the visible action card.",
      "Keep the opening action unchanged.",
      "Compare the whole travel card with the reviewed exception.",
      "Keep the compound action intact.",
      "Return to the special action.",
      "Replay the whole recording before choosing.",
      "Recall the displayed action without adding another one.",
    ],
  }),
  ...semanticLessonCopy("requests-connection-2", {
    title: "Making bounded requests",
    objective:
      "Make practical requests with てください and respond naturally in a short exchange.",
    main:
      "Attach ください to a generated te form to make an explicit practical request. A brief すみません can get attention before the request.",
    construction:
      "Name the object with を, use the requested action's te form, then add ください. Add ね only when the particular relationship and situation support that softening.",
    constraints:
      "てください is an explicit request, not a universal guarantee of politeness and not a permission formula. Choose wording that fits the relationship and setting.",
    commonError:
      "Stopping at a bare te form does not complete the explicit てください request practiced here.",
    nearestContrast:
      "A request asks the other person to act; おねがいします can instead accept an offer in the exchange shown here.",
    recap:
      "Use a generated te form plus ください for a bounded request, and soften only when the context warrants it.",
    translations: [
      "Excuse me, please close the window.",
    ...
    purposes: [
      ...
      "Applies てください to a bounded request.",
      "Uses a natural task-specific request.",
      "Shows a familiar table request.",
      "Uses a person as the object of よぶ.",
      "Reuses a familiar object with the same construction.",
      "Keeps the requested action explicit.",
      "Contrasts opening with the earlier closing request.",
      "Models a softened acceptance of a wanted offer.",
    ],
    instructions: [
      "A coworker offers to help with the work, and you want the help. Choose the acceptance.",
      "You need to see the map and first get the other person's attention. Choose the complete line.",
      "Build the luggage request from all displayed chunks.",
      "A manager asks you to call the police officer. Choose the coherent full response and follow-through.",
      "Ask to be shown the bag identified in the handoff.",
      "The window line stops before its intended request is complete. Repair only the ending.",
      "At the table, make the salt request gently in this familiar exchange.",
      "You are inviting a colleague to look at the umbrella you are showing. Choose the line that fits this handoff.",
      "Listen to the whole recording, then choose the matching complete request.",
      "At the school office, first get the receptionist's attention and then ask them to call the teacher. Recall that complete Japanese request aloud.",
    ],
    accepted: [
      "Right: おねがいします naturally accepts the offer here.",
      "Right: the attention-getter and request form one complete line.",
      "Right: the luggage precedes the predicate-final request.",
      "Right: the response accepts the request and names the promised action.",
      "Right: the requested item is the displayed bag.",
      "Right: ください completes the intended request.",
      "Right: ね provides context-appropriate softening here.",
      "Right: どうぞ fits the invitation to look at the umbrella.",
      "Right: the request matches the recording.",
      "Right: the hidden response is uniquely recovered from the teacher card.",
    ],
    retry: [
      "Return to the offer and the response it invites.",
      "Keep both the attention-getter and map situation in view.",
      "Use each luggage-request chunk once in one predicate-final line.",
      "Keep the requested person and the promised follow-through fixed.",
      "Keep the bag and requested outcome fixed.",
      "Preserve the visible request and repair only what is unfinished.",
      "Keep the familiar table relationship in mind.",
      "Keep the umbrella and the invitation setting fixed.",
      "Replay the whole recording before choosing.",
      "Keep the office need, the person to call, and the attention situation fixed.",
    ],
  }),
  ...semanticLessonCopy("requests-connection-3", {
    title: "Connecting two actions in sequence",
    objective:
      "Connect two simple actions with te when the intended relation is chronological succession.",
    main:
      "Put the first action in its generated te form and place the second action after it. This lesson uses that link only for a simple first-then-second sequence.",
    construction:
      "Generate the first verb's te form, then finish with the second verb in the polite form appropriate to the statement.",
    constraints:
      "Sequential te does not by itself assert every possible relation such as cause, contrast, or simultaneous action.",
    commonError:
      "Two separate polite endings do not realize the single linked sequence practiced here; the first action needs the connecting form.",
    nearestContrast:
      "The final polite verb closes the sentence, while the first te form leaves the sequence open for the next action.",
    recap:
      "Use generated te on the first action and a polite final verb on the second, making only a bounded chronological claim.",
    translations: [
      "I will wake up and then eat.",
      "I will eat and then return.",
      "I will buy something and then return.",
      "I will write and then read.",
      "I will wash and then rest.",
      "I will enter and then rest.",
      "I will leave and then go.",
      "I will board and then go.",
      "I will come and then eat.",
      "I will swim and then return.",
      "I will speak and then write.",
      "I will look and then buy.",
    ],
    purposes: [
      "Presents one explicit chronological sequence.",
      "Keeps the relation to simple succession.",
      "Connects two bounded actions.",
      "Shows that the final verb carries the polite ending.",
      "Introduces あらう in a two-step sequence.",
      "Keeps entering before resting.",
      "Introduces でる as the first action.",
      "Uses のる without claiming a broader discourse relation.",
      "Reuses the special くる form.",
      "Reuses the voiced いで allomorph.",
      "Connects two familiar actions in order.",
      "Shows a practical inspect-then-buy order.",
    ],
    instructions: [
      "The schedule says to wash first and eat second. Choose the line that preserves that timeline.",
      "The schedule says to enter first and read second. Complete that sequence.",
      "Build the leave-then-return line from every displayed chunk.",
      "The traveler boards first and then comes here. Keep that chronology.",
      "Transform the two displayed actions into one stated sequence.",
      "The line intends one eat-then-go sequence but closes both actions separately. Repair only the first verb phrase.",
      "At lunch, drink first and wash up afterward. Match that visible order.",
      "The travel card shows returning first and boarding afterward. Retrieve that order.",
      "Listen to the entire sequence, then choose the matching complete line.",
      "Recall the enter-then-eat sequence aloud without reading an option.",
    ],
    accepted: [
      "Right: washing is linked before eating.",
      "Right: entering is linked before reading.",
      "Right: the pieces form one predicate-final sequence.",
      "Right: boarding precedes coming in this stated plan.",
      "Right: buying is linked before reading.",
      "Right: the first action now connects to the final action.",
      "Right: this line preserves drink-then-wash.",
      "Right: this line preserves return-then-board.",
      "Right: the sequence matches the recording.",
      "Right: the hidden sequence is recovered in the stated order.",
    ],
    retry: [
      "Keep the two displayed events and their timeline fixed.",
      "Return to the schedule before choosing.",
      "Use every displayed chunk once.",
      "Keep the boarding event first.",
      "Preserve the order shown on the action card.",
      "Repair only the connection between the two actions.",
      "Read the visible timeline again.",
      "Return to the route card before trying again.",
      "Replay the whole recording before choosing.",
      "Keep entering first and eating second.",
    ],
  }),
  ...semanticLessonCopy("requests-connection-4", {
    title: "Actions in progress and current states",
    objective:
      "Use ています for a bounded ongoing action or a lexically supported resulting/current state.",
    main:
      "Generated te plus います can report a dynamic action visibly underway now. With selected predicates it instead reports a current or resulting state.",
    construction:
      "Generate the verb's te form and attach います. Interpret the result from the predicate and visible situation: action underway, or supported current state.",
    constraints:
      "Do not call every nonpast verb present progressive. Outside this bounded construction, dynamic nonpast in Base remains habitual or future.",
    commonError:
      "Ordinary polite nonpast does not encode the live ongoing reading required by a scene that visibly shows an action underway.",
    nearestContrast:
      "わたしはいまごはんをたべています anchors an action underway; わたしはやまださんをしっています is current knowledge, while すずきさんはいすにすわっています and やまださんはふくをきています are maintained states.",
    recap:
      "Use ています only with an explicit ongoing-now or supported state reading, and let the predicate plus scene decide between them.",
    translations: [
      "I am eating rice now.",
      "Tanaka is reading a book now.",
      "Yamada is writing a letter now.",
      "Suzuki is on the phone now.",
      "Tanaka is swimming now.",
      "Yamada is studying now.",
      "Suzuki is working now.",
      "I know Yamada.",
      "Yamada is wearing clothes.",
      "Suzuki is seated on a chair.",
      "Tanaka is waiting at the station now.",
      "Suzuki is looking at a magazine now.",
    ],
    purposes: [
      "Names the current time, eater, and food in Japanese.",
      "Uses the visible time and book to anchor reading in progress.",
      "Uses the letter and current-time phrase to make the ongoing event explicit.",
      "Uses a subject and visible current-time phrase to anchor the call.",
      "Uses the current-time phrase to select an ongoing swim.",
      "Names subject and time in Japanese for current study.",
      "Uses visible time to distinguish current work from habitual nonpast.",
      "Names the object of a current knowledge state.",
      "Uses an explicit clothing object to select the wearing-state reading.",
      "Uses the chair location to anchor the state after sitting.",
      "Uses current time and action place to anchor waiting as underway.",
      "Uses visible time and object to anchor the action in progress.",
    ],
    instructions: [
      "Tanaka already knows Yamada. Choose the report of that current knowledge.",
      "A live scene shows Yamada eating at this moment. Complete the report.",
      "Build the live magazine-reading report from all displayed chunks.",
      "Yamada has taken a seat on the displayed chair and remains there. Choose the visible current condition.",
      "A live scene shows Tanaka writing. Transform the displayed action into that report.",
      "A live camera shows the document reading already under way. Repair only the verb phrase.",
      "In the clothing check, report Suzuki's condition with the displayed clothes after getting dressed.",
      "Tanaka already knows Suzuki. Retrieve that current knowledge report.",
      "Listen to the whole recording, then choose the matching complete current-action report.",
      "Tanaka has taken a seat on the displayed chair. Recall the current-condition report aloud.",
    ],
    accepted: [
      "Right: しっています reports current knowledge.",
      "Right: the scene is encoded as an action underway.",
      "Right: the object and ongoing predicate form one complete line.",
      "Right: すわっています reports the maintained seated state.",
      "Right: the writing is marked as underway now.",
      "Right: the repaired verb phrase matches the live scene.",
      "Right: きています reports the resulting wearing state here.",
      "Right: しっています matches the established knowledge.",
      "Right: the ongoing-action report matches the recording.",
      "Right: すわっています is recovered as Tanaka's current condition.",
    ],
    retry: [
      "Keep the established knowledge situation fixed.",
      "Return to what the live scene visibly shows.",
      "Use every displayed chunk once.",
      "Keep the post-sitting condition in view.",
      "Keep Tanaka and the live writing scene fixed.",
      "Repair only the verb phrase contradicted by the camera.",
      "Return to the clothing-check result.",
      "Keep both people in the established knowledge record fixed.",
      "Replay the whole recording before choosing.",
      "Keep Tanaka's post-sitting condition in view.",
    ],
  }),
  "requests-connection-2-practical-dialogue-outcome":
    "Make and answer two practical requests in one office exchange.",
  "requests-connection-2-practical-dialogue-turn-1-translation":
    "Excuse me, please show me the documents.",
  "requests-connection-2-practical-dialogue-turn-1-purpose":
    "Opens one office exchange with a softened document request.",
  "requests-connection-2-practical-dialogue-turn-2-translation":
    "Yes, here you are.",
  "requests-connection-2-practical-dialogue-turn-2-purpose":
    "Responds naturally while handing over the documents.",
  ...
  "requests-connection-2-practical-dialogue-turn-3-purpose":
    "Makes a second document request in the same office.",
  "requests-connection-2-practical-dialogue-turn-4-translation":
    "Yes, understood.",
  "requests-connection-2-practical-dialogue-turn-4-purpose":
    "Accepts the letter request without unnaturally echoing the verb.",
  "requests-connection-4-practical-dialogue-outcome":
    "Check a live reading action and a current seated state.",
  "requests-connection-4-practical-dialogue-turn-1-translation":
    "Is Tanaka reading now?",
  "requests-connection-4-practical-dialogue-turn-1-purpose":
    "Asks about an action visibly underway.",
  "requests-connection-4-practical-dialogue-turn-2-translation":
    "Yes, Tanaka is reading a book.",
  "requests-connection-4-practical-dialogue-turn-2-purpose":
    "Answers with an ongoing dynamic action.",
  "requests-connection-4-practical-dialogue-turn-3-translation":
    "Is Suzuki seated now?",
  "requests-connection-4-practical-dialogue-turn-3-purpose":
    "Contrasts the current state with the ongoing action.",
  "requests-connection-4-practical-dialogue-turn-4-translation":
    "Yes, Suzuki is seated on a chair.",
  "requests-connection-4-practical-dialogue-turn-4-purpose":
    "Answers with the current state after sitting down.",
  "verb-motte-kuru-meaning": "to bring",
  "verb-shinu-meaning": "to die",
  "verb-toru-meaning": "to take; to pass",
  "verb-kesu-meaning": "to turn off; to erase",
  "verb-akeru-meaning": "to open",
  "verb-shimeru-meaning": "to close",
  "verb-miseru-meaning": "to show",
  "verb-tetsudau-meaning": "to help",
  "verb-yobu-meaning": "to call",
  "expression-sumimasen-meaning": "excuse me; sorry",
  "expression-onegaishimasu-meaning": "please; yes, please",
  "expression-douzo-meaning": "here you are; please",
  "expression-wakarimashita-meaning": "understood; all right",
  "noun-mado-meaning": "window",
  "noun-shorui-meaning": "documents",
  "noun-nimotsu-meaning": "luggage",
  "noun-shio-meaning": "salt",
  "noun-ima-meaning": "now",
  "noun-fuku-meaning": "clothes",
  "verb-arau-meaning": "to wash",
  "verb-hairu-meaning": "to enter",
  "verb-deru-meaning": "to leave; to exit",
  "verb-noru-meaning": "to board; to ride",
  "verb-suwaru-meaning": "to sit",
  "verb-kiru-meaning": "to put on; to wear",
  "verb-shiru-meaning": "to know",
  "verb-aru-meaning": "to exist; to be present (inanimate)",
  "verb-iru-meaning": "to exist; to be present (animate)",
  "noun-tsukue-meaning": "desk",
  "noun-inu-meaning": "dog",
  "noun-kuruma-meaning": "car",
  "noun-heya-meaning": "room",
  "noun-niwa-meaning": "garden",
  "noun-isu-meaning": "chair",
  "noun-kodomo-meaning": "child",
  "noun-kyoushitsu-meaning": "classroom",
  "noun-uchi-meaning": "home",
  "noun-sakana-meaning": "fish",
  "noun-hana-meaning": "flower",
  "noun-doko-meaning": "where",
  "noun-uketsuke-meaning": "reception desk",
  "noun-toire-meaning": "restroom",
  "noun-konbini-meaning": "convenience store",
  "noun-basutei-meaning": "bus stop",
  "noun-chizu-meaning": "map",
...
const SYNTHESIS_RETRY_EN = [
  "Re-read the whole situation, compare both choices, and try again.",
  "Compare only the requested contrast, then try again.",
  "Rebuild the complete utterance from the visible chunks, then retry.",
  "Check every visible cue without adding new information, then retry.",
  "Locate the single visible defect and try again.",
  "Return to the stated situation and choose again.",
  "Review how the supplied details work together, then retry.",
  "Return to the sentence-level cue, compare both complete choices, and try again.",
...
const SYNTHESIS_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("base-synthesis-1", {
    ...
    construction:
      "Use the reviewed topic, noun-predicate, adjective, modification, and existence patterns in complete sentences.",
    constraints:
    ...
    purposes: [
      ...
      "Places the familiar な-adjective before a profession in a family description.",
    ...
    instructions: [
      "The researcher is not famous in this situation. Choose the matching description.",
      "Ai is not from Japan in this situation. Choose the matching sentence.",
      "Choose the sentence whose visible chunks form one natural description of Satou.",
      "The speaker's mother is a bank clerk. Complete the matching response.",
      "Repair the one malformed polite past ending.",
      "The flower is already being discussed and is at the station. Choose the matching location statement.",
      "Yuki is feeling well here. Choose the sentence that matches that fact.",
      "An employee is being introduced at the office. Choose the matching sentence.",
      "Listen once or replay, then choose the sentence you actually hear.",
      "Use the two visible items in their shown order to say that Tanaka is a station employee.",
    ],
    accepted: SYNTHESIS_ACCEPTED_EN,
    retry: SYNTHESIS_RETRY_EN,
  }),
  "base-synthesis-1-practical-dialogue-outcome":
    "Exchange connected information about two parents while omitting only a uniquely recoverable topic.",
  "base-synthesis-1-practical-dialogue-turn-1-translation":
    "What is your father's name?",
  "base-synthesis-1-practical-dialogue-turn-1-purpose":
    "Opens a family exchange with one explicit name question.",
  ...
  "base-synthesis-1-practical-dialogue-turn-2-purpose":
    "Answers with the corresponding in-group family term.",
  ...
  "base-synthesis-1-practical-dialogue-turn-3-purpose":
    "Moves clearly from the father to the mother.",
  ...
  "base-synthesis-1-practical-dialogue-turn-4-purpose":
    "Confirms the mother's profession while she remains recoverable.",
  ...
  "base-synthesis-1-practical-dialogue-turn-7-purpose":
    "Introduces one related possession without an ambiguous referent.",
  ...
  "base-synthesis-1-practical-dialogue-turn-8-purpose":
    "Answers about the same umbrella without repeating its owner.",
  ...
  ...semanticLessonCopy("base-synthesis-2", {
    ...
    construction:
      "Attach に to a specific clock time, use から and まで for two bounds, and form every verb according to its familiar class.",
    constraints:
    ...
    purposes: [
      ...
      "Keeps the clothing argument visibly licensed by を.",
    ...
    instructions: [
      "Sora will write tomorrow. Choose the sentence that fits that plan.",
      "Tanaka will not sing at night. Choose the matching statement.",
      "The plan is to listen and then make it. Choose the matching utterance.",
      "The speaker plans to wear the clothes. Complete the matching statement.",
  ...
  "base-synthesis-2-practical-dialogue-outcome":
    "Introduce yourself, discuss a work routine and two plans, then respond to a document request.",
  ...
  "base-synthesis-2-practical-dialogue-turn-2-purpose":
    "Opens the schedule exchange with a habitual question.",
  ...
  "base-synthesis-2-practical-dialogue-turn-5-purpose":
    "Moves from the routine to two ordered actions at five.",
  ...
  "base-synthesis-2-practical-dialogue-turn-6-purpose":
    "Keeps both actions in order while correcting the time.",
  ...
  ...semanticLessonCopy("base-synthesis-3", {
    ...
    purposes: [
      ...
      "Asks whether the map will be brought to the stated destination.",
    ...
    instructions: [
      "Salt is being introduced as present in the shop. Choose the matching statement.",
      "The luggage is already understood. Ask Tanaka to bring it to the office.",
      "Board and then leave. Choose the utterance that keeps that order.",
      "Invite someone politely to come in tonight.",
      "Repair only the malformed ending in the visible clothes-washing statement.",
      "The police officer is speaking at this moment. Choose the matching statement.",
      "The map is already being discussed and is at the office. Choose the matching location statement.",
      "Ask Tanaka politely to close the window.",
      "Listen to the complete reading statement, then select the exact sentence.",
      "Use the visible bag and action cues to ask someone to open the bag and then take it.",
    ],
    accepted: SYNTHESIS_ACCEPTED_EN,
    retry: SYNTHESIS_RETRY_EN,
  }),
  "base-synthesis-3-practical-dialogue-outcome":
    "Find two familiar places, confirm a travel plan, and request a map in one coherent exchange.",
  ...
  ...semanticLessonCopy("base-synthesis-4", {
    title: "Putting the foundations together",
    objective:
      "Use the sentence patterns, particles, verb forms, and descriptions reviewed so far in one guided interaction.",
    main:
      "This lesson brings together sentence structure, particles, verb types, tense and polarity, adjectives, and です.",
    construction:
      "Use each familiar form and particle in the role practiced earlier.",
    constraints:
      "This is practice only; it does not certify a level or unlock new content.",
    commonError:
    ...
    purposes: [
      ...
      "Samples the ichidan class through a familiar generated form.",
    ...
    instructions: [
      "The energetic civil servant runs on Sunday. Choose the matching statement.",
      "The speaker's mother's name is Haru. Choose the matching statement.",
      "Listen and then help. Choose the utterance that keeps that order.",
      "The child's fish is already being discussed and is at home. Choose the matching location statement.",
      "Complete the malformed polite past ending in last week's diary-reading statement.",
      "Suzuki will cook at five rather than nine. Choose the matching statement.",
      "The speaker currently knows the famous engineer. Choose the matching statement.",
      "Yuki is seated on a chair now. Choose the matching statement.",
      "Listen to the complete activity statement, then select the exact match.",
      "Use the visible magazine and reading cues to make one polite request.",
    ],
    accepted: SYNTHESIS_ACCEPTED_EN,
    retry: SYNTHESIS_RETRY_EN,
  }),
  "base-synthesis-4-practical-dialogue-outcome":
    "Identify and locate Sakura's friend, then make a motivated request to call her.",
  ...
  "base-synthesis-4-practical-dialogue-turn-2-purpose":
    "Returns the introduction before another person is mentioned.",
...
export const baseNavigationCopyEn: BaseNavigationCopy = deepFreeze({
  ...
  lessons: {
    ...
    "copula-adjectives-1": { title: "Polite noun-predicate negatives" },
    "copula-adjectives-2": { title: "Noun predicates across time and polarity" },
    "copula-adjectives-3": { title: "Descriptive adjectives that self-conjugate" },
    "copula-adjectives-4": { title: "Nominal-type adjectives and noun modification" },
    "existence-location-1": { title: "Choosing animate or inanimate existence" },
    "existence-location-2": { title: "Place and entity in existence statements" },
    "existence-location-3": { title: "Existence location, action place, and topic" },
    "existence-location-4": { title: "Finding people and things" },
    "requests-connection-1": { title: "Building every bounded te form" },
    "requests-connection-2": { title: "Making bounded requests" },
    "requests-connection-3": { title: "Connecting two actions in sequence" },
    "requests-connection-4": { title: "Actions in progress and current states" },
  ...
  outcomes: {
    ...
    "base-module-outcome-base-synthesis":
      "Use the foundations together in a supported everyday exchange.",
  },
  content: {
