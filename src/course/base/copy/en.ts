...
const TOPIC_QUESTIONS_COPY_EN: Readonly<Record<string, string>> = {
  ...
  ...semanticLessonCopy("topic-questions-3", {
    ...
    instructions: [
      ...
      'Two travel destinations must remain peer items. Choose the bounded list.',
    ...
    accepted: [
      ...
      "The two destinations remain peer items linked by bounded-list と.",
    ...
    retry: [
      ...
      "Keep と between the two peer destination nouns; の would create modification.",
