...
export const baseNavigationCopyEn: BaseNavigationCopy = deepFreeze({
  ...
  content: {
    ...
    "snd1-discriminate-vowels-instruction": "Choose the front-vowel partner that completes the displayed contrast with あ.",
    ...
    "snd1-match-ie-instruction": "Match the visible morae to the anchor word いえ.",
    ...
    "snd2-discriminate-kaga-instruction": "Choose the voiced partner of unvoiced か.",
    "snd2-segment-kagi-instruction": "Segment the anchor word かぎ into morae.",
    "snd2-recognize-jidi-instruction": "Choose the sequence that preserves all four spellings じ, ぢ, ず, and づ.",
    "snd2-map-dakuten-instruction": "Map unmarked kana to their dakuten or handakuten forms.",
    "snd2-match-kaze-instruction": "Match the visible morae to the anchor word かぜ.",
    "snd2-assemble-denwa-instruction": "Assemble で・ん・わ, keeping ん as one mora.",
    "snd2-listen-kaga-instruction": "Listen and identify voiced が rather than unvoiced か.",
    "snd2-read-panpu-instruction": "Read ぱ and ぷ aloud with handakuten.",
    "snd3-discriminate-obasan-instruction": "Choose the long-vowel timing partner of おばさん.",
    ...
    "snd4-discriminate-yoon-instruction": "Choose the correctly formed one-mora yoon with a sh onset.",
    ...
    "snd4-match-shashin-instruction": "Match the visible morae しゃ・し・ん to the anchor word しゃしん.",
