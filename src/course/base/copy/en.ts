...
const POLITE_VERBS_COPY_EN: Readonly<Record<string, string>> = {
  ...
  ...semanticLessonCopy("polite-verbs-2", {
    ...
    instructions: [
      ...
      "A meal-scene lookup card needs a class analysis. Choose the supported analysis.",
      ...
      "A basic do-action card needs its special-class analysis. Choose the supported analysis.",
      "An arrival-action card needs its special-class analysis. Retrieve the supported analysis.",
      ...
      "From the friend cue, say the hidden class-analysis card from memory.",
    ],
    accepted: [
  ...
  ...semanticLessonCopy("polite-verbs-3", {
    ...
    instructions: [
      ...
      "A meal lookup card needs its generated stem analysis. Choose the supported derivation.",
      "Order the lookup form before its generated stem using every tile.",
      "Transform the displayed basic do-action lookup card into its owned stem analysis.",
      "Complete Suzuki’s arrival-action card with its owned stem analysis.",
      ...
      "Retrieve the generated stem analysis for the friend’s walking-action card.",
      "Listen to the student viewing stem and choose its written match.",
      "From the Tanaka cue, say the hidden waiting-action stem analysis.",
    ],
    accepted: [
      ...
      "The spoken card reproduces the hidden waiting-action stem analysis.",
    ],
    retry: [
  ...
  ...semanticLessonCopy("polite-verbs-4", {
    ...
    instructions: [
      "An alarm-scene context and two lookup cards are shown. Choose the complete owned form that fits the event.",
      "The shared roster marks Yamada’s day off. Choose the complete owned form.",
      "Yamada’s route plan is shown. Order every tile into one complete sentence.",
      "Transform the displayed listening stem into its complete owned polite form.",
      "Complete Mari’s plan with the making predicate.",
      "The displayed predicate attaches the polite ending to the wrong base. Choose the one-defect repair.",
      "Choose Yuki’s planned meeting sentence.",
      "Retrieve the friend’s singing routine.",
      "Listen to the complete teacher route-plan sentence and choose its written match.",
      "From the student cue, say the hidden planned-waiting sentence.",
    ],
    accepted: [
      "The ます predicate expresses the learner’s routine.",
      "The complete form matches Yamada’s established day-off context.",
    ...
    retry: [
      ...
      "Use Yamada’s day-off context and select the complete form.",
  ...
  "polite-verbs-4-practical-dialogue-turn-3-translation": "Does Yamada rest too?",
  "polite-verbs-4-practical-dialogue-turn-3-purpose":
    "Moves to a different referent before asking about rest.",
  "polite-verbs-4-practical-dialogue-turn-4-translation": "Yes, Yamada rests.",
  "polite-verbs-4-practical-dialogue-turn-4-purpose":
    "Confirms the new referent without contradicting Tanaka's work routine.",
...
const ARGUMENT_PARTICLES_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("argument-particles-1", {
    ...
    instructions: [
      ...
      "Order Yamada, the letter theme, and the final writing predicate while preserving every tile.",
      "Complete Satou’s fruit-purchase sentence.",
      "Repackage the displayed magazine theme as the established discourse topic.",
      "Mari’s neutral book statement was packaged as a contrastive topic. Repair only that packaging.",
      ...
      "Listen to the affirmative topicalized fruit response and choose its written match.",
    ...
    retry: [
      ...
      "Diagnose the neutral-versus-topical packaging mismatch before repairing it.",
  ...
  ...semanticLessonCopy("argument-particles-2", {
    ...
    instructions: [
      "The shared route treats the station as its endpoint. Choose the matching sentence.",
      ...
      "Mari’s route card shows a direction where the context requires an endpoint. Repair only that view.",
      "Choose Tanaka’s directional movement toward Tokyo.",
      "Retrieve Yamada’s endpoint-focused Kyoto route rather than its directional counterpart.",
      "Listen to Satou’s home-endpoint sentence and choose its written match.",
  ...
  ...semanticLessonCopy("argument-particles-3", {
    ...
    instructions: [
      "The library is the setting of study. Choose the matching role analysis.",
      "Tanaka’s park writing card is shown. Choose the supported role analysis.",
      "Order Yamada, train-as-means, and the going predicate.",
      "Satou’s bicycle travel card is shown. Choose the supported role analysis.",
      "The pencil is the writing instrument. Choose the matching role analysis.",
      "Mari’s shop writing card carries the wrong role analysis. Repair only that label.",
      "Retrieve Tanaka’s hospital study card with its supported role analysis.",
      "Complete Yamada’s school-study sentence.",
      "Listen to Satou’s train travel card and choose its supported role analysis.",
      "Say Mari’s hidden pencil-writing sentence.",
    ],
    accepted: [
      "The library is the place where studying happens.",
      "The role label identifies the park as the setting of writing.",
      ...
      "The hospital is retrieved as the setting of Tanaka’s study.",
    ...
    retry: [
      ...
      "Use the writing context to identify the role.",
      ...
      "Diagnose the incompatible role label without changing the predicate.",
      "Retrieve the hospital study card and its supported place analysis.",
  ...
  ...semanticLessonCopy("argument-particles-4", {
    ...
    instructions: [
      ...
      "Tanaka’s office writing card is shown. Choose the supported role analysis.",
    ...
    accepted: [
      ...
      "The role label identifies the office as the setting of writing.",
    ...
    retry: [
      ...
      "Use the writing setting to select the supported place analysis.",
      ...
      "Retrieve the topicalized reading frame rather than neutral object packaging.",
      "Choose the endpoint view rather than the directional view.",
      "Listen for both the park chunk and the movement predicate.",
...
const TIME_MOVEMENT_COPY_EN: Readonly<Record<string, string>> = {
  ...
  ...semanticLessonCopy("time-movement-2", {
    ...
    instructions: [
      ...
      "Order the named day chunk before Yamada’s final study predicate using every tile.",
      "Complete Satou’s plan for tomorrow.",
      "Tanaka’s study interval has a stated start and endpoint. Choose the bounded reading.",
  ...
  ...semanticLessonCopy("time-movement-3", {
    ...
    instructions: [
      "The schedule marks an unnegated event for this week. Choose the matching form.",
      "Tanaka’s schedule places an unnegated work event next week. Choose the matching form.",
      "Order Yamada, yesterday, and the worked form.",
      "The event happened last week and is not negated. Transform the displayed stem into the matching form.",
      "The event did not happen yesterday. Choose the form matching completed time and negative polarity.",
      "Mari’s next-week purchase card is crossed out, but the displayed form has the wrong time and polarity. Repair it.",
      "Retrieve Tanaka’s past-negative leisure sentence.",
      "This week’s schedule card shows a crossed-out planned event. Choose the form matching its time and polarity.",
  ...
  ...semanticLessonCopy("time-movement-4", {
    ...
    purposes: [
      ...
      "Uses に with the owned night-time expression.",
