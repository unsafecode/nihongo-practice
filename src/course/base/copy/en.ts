...
const COPULA_ADJECTIVES_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("copula-adjectives-1", {
    ...
    instructions: [
      ...
      "Use the friendship profile and choose the statement supported by it.",
      ...
      "Recall the hidden school-directory correction and say the full statement.",
    ],
    accepted: [
    ...
    retry: [
      ...
      "Recall the marked directory status without reading a choice.",
    ],
  }),
  ...semanticLessonCopy("copula-adjectives-2", {
    ...
    instructions: [
      ...
      "Recall the hidden kitchen-staff history and say the full statement.",
    ],
    accepted: [
    ...
    retry: [
      ...
      "Recall the kitchen record without reading an option.",
    ],
  }),
  ...semanticLessonCopy("copula-adjectives-3", {
    ...
    instructions: [
      ...
      "Recall the hidden magazine review and say the full statement.",
    ],
    accepted: [
    ...
    retry: [
      ...
      "Recall the magazine score without reading a choice.",
    ],
  }),
  ...semanticLessonCopy("copula-adjectives-4", {
    ...
    instructions: [
      ...
      "A preference card says you do not dislike the displayed friend. Complete the response.",
      ...
      "Recall the hidden student profile and say the full statement.",
    ],
    accepted: [
      ...
      "The completed response matches the preference card.",
    ...
    retry: [
      ...
      "Use the visible preference card without changing its participant.",
      ...
      "Replay the whole recording before comparing both statements.",
      "Recall the student profile without reading a choice.",
    ],
  }),
  ...
  "adjective-kirai-meaning": "disliked; disagreeable",
};
...
const EXISTENCE_LOCATION_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("existence-location-1", {
    ...
    main:
      "Japanese uses two existence verbs. ある presents an inanimate thing as existing; いる presents a person or animal as present.",
    construction:
      "Identify the entity independently, keep the familiar topic frame for now, and select polite あります or います.",
    constraints:
    ...
    nearestContrast:
      "つくえはあります presents a desk; いぬはいます presents a living dog.",
    recap:
    ...
    purposes: [
      "Pairs a thing with あります.",
      "Pairs an animal with います.",
      "Classifies another physical object.",
      "Retrieves a familiar object.",
      "Uses います for a person.",
      "Keeps the choice independent of size.",
      "Retrieves a familiar person.",
      "Applies あります to a small object.",
      "Applies います to a named person.",
      "Closes with a familiar vehicle.",
    ],
    instructions: [
  ...
  ...semanticLessonCopy("existence-location-4", {
    ...
    instructions: [
      ...
      "Recall the hidden police-officer location and say the full response.",
    ],
    accepted: [
    ...
    retry: [
      ...
      "Recall the location card without reading an option.",
    ],
  }),
  ...
  ...semanticLessonCopy("requests-connection-2", {
    ...
    purposes: [
      ...
      "Models a brief natural acceptance after a request.",
    ],
    instructions: [
      "A coworker offers to help with the work. Choose the natural acceptance.",
      "You need to see the map and first get the other person's attention. Choose the complete line.",
      "Build the bag request from all displayed chunks.",
      "At the station, ask someone to call the police officer named in the scene.",
      "Ask to be shown the luggage identified in the handoff.",
      ...
      "Ask a colleague to show the displayed documents, with gentle softening.",
      "Listen to the whole recording, then choose the matching complete request.",
      "From the teacher card, recall the complete softened request aloud.",
    ],
    accepted: [
      "Right: おねがいします naturally accepts the offer here.",
      "Right: the attention-getter and request form one complete line.",
      "Right: the object precedes the predicate-final request.",
      "Right: this asks for the police officer to be called.",
      "Right: the requested action is showing the luggage.",
      "Right: ください completes the intended request.",
      "Right: ね provides context-appropriate softening here.",
      "Right: this gently asks the colleague to show the documents.",
    ...
    retry: [
      ...
      "Use each chunk once in one predicate-final line.",
      "Keep the person in the station scene fixed.",
      "Keep the luggage and requested outcome fixed.",
      "Preserve the visible request and repair only what is unfinished.",
      "Keep the familiar table relationship in mind.",
      "Return to the document handoff.",
      "Replay the whole recording before choosing.",
      "Keep the teacher as the requested person.",
    ],
  }),
  ...
  ...semanticLessonCopy("requests-connection-4", {
    ...
    nearestContrast:
      "たべています describes eating in progress here; しっています is current knowledge, and すわっています or きています describes a maintained result/state.",
    recap:
    ...
    purposes: [
      "Tags a dynamic action visibly in progress.",
      "Keeps the claim tied to this moment.",
      "Applies the construction to writing in progress.",
      "Applies the construction to speech in progress.",
      "Uses the voiced allomorph in an ongoing action.",
      "Uses しています for current study.",
      "Contrasts a current action with habitual nonpast.",
      "Treats しっています as a current knowledge state.",
      "Uses きています for the state after putting clothing on.",
      "Uses すわっています for a maintained seated state.",
      "Bounds waiting as the action underway now.",
      "Uses the construction for a bounded action in progress.",
    ],
    instructions: [
      "Yamada already learned the answer. Choose the report of that current knowledge.",
      ...
      "Suzuki has taken a seat and remains there. Choose the visible current condition.",
      ...
      "In the clothing check, report Yamada's condition after getting dressed.",
      "Tanaka already learned the answer. Retrieve the current knowledge report.",
      "Listen to the whole recording, then choose the matching complete current-action report.",
      "Tanaka has taken a seat. Recall the current-condition report aloud.",
    ],
    accepted: [
  ...
  "requests-connection-2-practical-dialogue-turn-3-purpose":
    "Continues with a second bounded request.",
  "requests-connection-2-practical-dialogue-turn-4-translation":
    "Yes, I will take it.",
  "requests-connection-2-practical-dialogue-turn-4-purpose":
    "Confirms the second action.",
  "requests-connection-2-practical-dialogue-turn-5-translation":
    "I'll help with the work.",
  "requests-connection-2-practical-dialogue-turn-5-purpose":
    "Offers help rather than treating てください as permission.",
  "requests-connection-2-practical-dialogue-turn-6-translation":
    "Thank you—yes, please.",
  "requests-connection-2-practical-dialogue-turn-6-purpose":
    "Accepts the offered help naturally.",
