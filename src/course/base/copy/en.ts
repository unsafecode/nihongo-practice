...
const POLITE_VERBS_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("polite-verbs-1", {
    ...
    instructions: [
      ...
      "The model places the verb card in the left slot. Order every tile.",
  ...
  ...semanticLessonCopy("polite-verbs-4", {
    ...
    retry: [
      ...
      "Keep the making verb and the established antecedent for Tanaka’s も.",
      "Diagnose the malformed stem-plus-ending combination before selecting a repair.",
      "Keep the rest predicate and preserve the teacher’s additional-routine reading.",
...
const ARGUMENT_PARTICLES_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("argument-particles-1", {
    ...
    retry: [
      ...
      "Keep the learner topic and the neutral letter packaging.",
      "Listen for the particle after water and the complete buying predicate.",
...
const TIME_MOVEMENT_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("time-movement-1", {
    ...
    retry: [
      ...
      "Listen to the complete time phrase and predicate.",
  ...
  ...semanticLessonCopy("time-movement-4", {
    ...
    retry: [
      ...
      "Keep both まいしゅう and よるに with the study predicate.",
