...
const POLITE_VERBS_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("polite-verbs-1", {
    ...
    translations: [
      "Lookup form: かく, “to write.”",
      "Lookup form: よむ, “to read.”",
      "Lookup form: のむ, “to drink.”",
      "Lookup form: かう, “to buy.”",
      "Lookup form: はたらく, “to work.”",
      "Lookup form: あそぶ, “to play.”",
      "Book scene — action word よむ.",
      "Key scene — action word かう.",
      "Student scene — action word はたらく.",
      "Friend scene — action word あそぶ.",
    ],
    purposes: [
      "Presents a dictionary form as a lookup label, not a tense.",
      "Identifies the final verb predicate on a dictionary card.",
      "Keeps lemma recognition separate from time reference.",
      "Shows another complete lookup form ending in う.",
      "Recognizes a longer verb as one predicate lexeme.",
      "Completes the six authored lookup lemmas.",
      "Places a known noun cue before the final lookup predicate.",
      "Uses a scene label without presenting a productive sentence.",
      "Recognizes the verb as the final predicate item.",
      "Contrasts an action predicate with the preceding noun cue.",
    ],
    instructions: [
      "A family reading scene is shown. Choose the matching final lookup lemma.",
      "A ticket counter scene is shown. Choose the action lemma for buying, not working.",
      "Choose the card whose final item is the work predicate.",
      "Choose the card whose final item is the drink predicate.",
      "Order the student cue and reading lemma with the predicate last.",
      "Complete Tanaka’s scene card with the work lemma.",
      "The bread scene is paired with the wrong action. Choose the coherent repair.",
      "Retrieve the play predicate for Yamada’s leisure scene.",
      "Listen to the whole Satou action card, then choose its written match.",
      "Recall Suzuki’s work card and say the complete cue-plus-lemma label.",
    ],
    accepted: [
      "The reading lemma matches the scene and remains a lookup form.",
      "The buying lemma is the intended predicate item.",
      "The longer work lemma is kept intact at the end.",
      "The drink lemma, not an unrelated action, completes the card.",
      "The noun cue precedes the final predicate lemma.",
      "Tanaka’s card ends with the intended work predicate.",
      "The repair replaces reading with buying for the bread counter.",
      "The play lemma matches the leisure scene.",
      "The selected label matches the complete recording.",
      "The spoken card preserves both cue and lookup lemma.",
    ],
    retry: [
      "Use the scene meaning; do not choose a similar-looking ending.",
      "Separate the action meaning from the length of the lemma.",
      "Keep the predicate final and choose work rather than play.",
      "The cue calls for drinking; reject the longer unrelated verb.",
      "Use the same two tiles and put the action predicate last.",
      "Complete the specified scene rather than inventing a sentence ending.",
      "Diagnose the action mismatch, then choose the buying repair.",
      "Retrieve the leisure action rather than the reading action.",
      "Listen through the final lemma before selecting.",
      "Say the hidden target from the cue; do not read an option.",
    ],
  }),
  ...semanticLessonCopy("polite-verbs-2", {
    ...
    translations: [
      ...
      "Friend scene — およぐ is the godan predicate.",
      "Tanaka scene — くる uses the special class.",
    ],
    purposes: [
      ...
      "Applies class recognition in a scene label.",
      "Retrieves くる as a special lookup lemma.",
    ],
    instructions: [
      "The sea scene calls for およぐ. Choose its stored godan classification.",
      "Choose the card that correctly identifies みる as ichidan.",
      "Order the student cue and the たべる class card with the predicate last.",
      "Yamada’s return card uses the -eru exception. Choose the godan analysis.",
      "The displayed return card was guessed from spelling alone. Choose the repair.",
      "Choose the special する-class response for Satou’s action card.",
      "Retrieve the special class used by くる.",
      "A Mari viewing card is shown. Choose its ichidan analysis.",
      "Listen for the full わたし、たべる card and choose its class.",
      "Say the hidden friend-swimming class card from memory.",
    ],
    accepted: [
      "およぐ is correctly classified as godan.",
      "みる follows the stored ichidan class.",
      "The class card keeps the predicate in its final slot.",
      ...
      "The viewing predicate is correctly identified as ichidan.",
      "The written class card matches the recording.",
      "The spoken card preserves the friend cue and godan lemma.",
    ],
    retry: [
      "Use the stored class for およぐ, not a guess from meaning.",
      "Do not treat every る verb as godan.",
      "Keep the same tiles and place the predicate card last.",
      ...
      "Recall the -iru ichidan example みる.",
  ...
  ...semanticLessonCopy("polite-verbs-3", {
    ...
    instructions: [
      "Choose the generated godan stem for かく.",
      "Choose the generated ichidan stem for たべる.",
      "Order Yamada’s study cue with the stem in the final slot.",
      "Transform the displayed する lookup form into its owned stem.",
      "Complete Suzuki’s arrival card with the くる stem.",
      "The displayed return stem follows the wrong class. Choose the repair.",
      "A telephone scene is shown. Choose the matching でんわする stem.",
      "Retrieve the さんぽする stem for the friend scene.",
      "Listen to the student viewing stem and choose its written match.",
      "Say the hidden Tanaka telephone-stem card.",
    ],
    accepted: [
      "The godan engine yields かき.",
      "The ichidan engine yields たべ.",
      ...
      "The spoken card reproduces the hidden compound stem.",
    ],
    retry: [
      "Move the final godan row to its i-row form.",
      "Remove the final る from the stored ichidan lemma.",
      ...
      "Recall and say the hidden target; no option is visible.",
    ],
  }),
  ...semanticLessonCopy("polite-verbs-4", {
    ...
    translations: [
      ...
      "Yuki will meet them.",
      "My friend sings.",
      "I will speak. (speaker recoverable)",
      "I will go. (mover and goal recoverable)",
    ],
    purposes: [
      "Models a habitual polite action with an explicit topic.",
      "Uses the owned ichidan stem plus ます.",
      "Contrasts another ichidan action in a familiar topic frame.",
      ...
      "Omits the recoverable person while keeping the predicate natural.",
      "Adds an intransitive habitual action.",
      "Models natural omission with no overt argument-role claim.",
      "Introduces going without naming a goal before argument particles.",
    ],
    instructions: [
      "The learner’s routine card says they wake up. Choose the matching ます sentence.",
      "The shared roster says Tanaka works. Choose the contextual response.",
      "Order Yamada’s topic and walking predicate into one sentence.",
      "Transform the displayed listening stem into its owned ます form.",
      "Complete Mari’s plan with the making predicate.",
      "The displayed grounded action conflicts with the speaking plan. Choose the repair.",
      "Choose Yuki’s planned meeting sentence.",
      "Retrieve the friend’s singing routine.",
      "Listen to the complete teacher-speaking sentence and choose its match.",
      "From the student cue, say the hidden planned-waiting sentence.",
    ],
    accepted: [
      "The ます predicate expresses the learner’s routine.",
      "The response matches Tanaka’s established work routine.",
      "The explicit topic precedes the final walking predicate.",
      "The generated stem correctly takes ます.",
      "Mari’s planned action has a future nonpast reading.",
      "The repair uses the speaking predicate required by context.",
      "Yuki’s recoverable meeting partner remains implicit.",
      "The friend’s singing routine is retrieved.",
      "The selected sentence matches the complete recording.",
      "The spoken target is hidden, grounded, and complete.",
    ],
    retry: [
      "Choose the waking action rather than sleeping.",
      "Use the established roster fact, not a different plan.",
      "Keep the topic before the predicate and use every tile.",
      "Attach ます to the stem, not to a different verb.",
      "Use the planned making action.",
      "Diagnose the action mismatch before selecting a repair.",
      "Keep the meeting partner implicit; do not add an untaught particle.",
      "Retrieve singing rather than walking.",
      "Listen through the final ます.",
  ...
  "polite-verbs-4-practical-dialogue-turn-3-translation": "Does Tanaka work too?",
  "polite-verbs-4-practical-dialogue-turn-3-purpose":
    "Reuses the known additive topic in the same practical thread.",
  "polite-verbs-4-practical-dialogue-turn-4-translation": "No, he rests.",
  "polite-verbs-4-practical-dialogue-turn-4-purpose":
    "Answers with a contrasting owned ます predicate.",
...
const ARGUMENT_PARTICLES_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("argument-particles-1", {
    ...
    purposes: [
      ...
      "Replaces overt を with は while preserving the licensed theme.",
      "Contrasts a topicalized theme with ordinary を.",
      "Shows a recoverable future context with object topicalization.",
    ],
    instructions: [
      "The learner’s meal is rice. Choose the eating sentence with the licensed theme.",
      "Tanaka’s water card calls for drinking. Choose the correct predicate frame.",
      "Order Yamada, the letter theme, and the writing predicate without dropping を.",
      "Complete Satou’s fruit-purchase sentence.",
      "Transform Suzuki’s magazine theme from ordinary を packaging to topical は.",
      "Mari is reading the book; the displayed predicate conflicts. Choose the repair.",
      "A photograph-viewing context is shown. Choose the seeing sentence.",
      "Retrieve the written-letter sentence rather than the unrelated meal fact.",
      "Listen to Mari’s topicalized fruit sentence and choose its written match.",
      "From the magazine cue, say Yamada’s hidden reading sentence.",
    ],
    accepted: [
      "The eating predicate licenses the rice theme and its を.",
      "The drinking sense and water theme form one licensed frame.",
      "Every tile is used and the predicate remains final.",
      "The fruit is marked as the theme of buying.",
      "The theme remains licensed while は changes its discourse status.",
      "The repair selects reading for the book context.",
      "The seeing sense licenses the photograph theme.",
      "The retrieved sentence writes the intended letter.",
      "The written target matches the complete recording.",
      "The spoken target keeps を pronounced o.",
    ],
    retry: [
      "Start from the eating sense and its theme role.",
      "Water is the theme of drinking, not buying.",
      "Keep を after the letter and put the verb last.",
      "Use the buying predicate for the fruit context.",
      "Replace visible を with は; do not stack both particles.",
      "Diagnose the predicate-theme mismatch before repairing it.",
      "Choose the predicate that means seeing the photograph.",
      "Retrieve the letter fact rather than a different object.",
      "Listen for the topical は and the whole predicate.",
  ...
  ...semanticLessonCopy("argument-particles-2", {
    ...
    translations: [
      ...
      "Yamada heads back toward Osaka.",
    ...
    purposes: [
      ...
      "Frames home as the direction of returning.",
      "Combines an additive topic with a route direction.",
      "Turns the coming endpoint into a confirmation question.",
      "Presents Yamada's return direction as an update.",
      "Contrasts a return endpoint with a return direction.",
    ],
    instructions: [
      "The station is the learner’s endpoint. Choose goal に.",
      "Tanaka is heading in the university’s direction. Choose the directional frame.",
      "Order Yamada, the hospital goal, and the going predicate.",
      "Complete Satou’s route toward the shop.",
      "Reframe Suzuki’s school arrival as movement in the school’s direction.",
      "Mari is returning home; the displayed movement verb conflicts. Choose the repair.",
      "Choose Tanaka’s directional movement toward Tokyo.",
      "Retrieve Yamada’s arrival in Kyoto, not the Osaka return.",
      "Listen to Satou’s return-to-station sentence and choose its match.",
      "Say Suzuki’s hidden hospital-direction sentence.",
    ],
    accepted: [
      ...
      "The repair uses returning rather than going or coming.",
      "Tokyo is presented as a direction.",
      "Kyoto is the endpoint of coming.",
      "The recording matches the return-goal sentence.",
    ...
    retry: [
      ...
      "Use every tile and keep the movement predicate final.",
      "Keep the route context and choose directional へ.",
      "Change the licensed movement view, not merely the printed glyph.",
      "Diagnose which movement sense the home context requires.",
      "Treat Tokyo as a direction in this scene.",
      "Retrieve coming to Kyoto rather than returning toward Osaka.",
      "Listen for に after the station.",
  ...
  ...semanticLessonCopy("argument-particles-3", {
    ...
    instructions: [
      "The learner studies in the library. Choose action-place で.",
      "Tanaka plays in the park. Choose the action-place frame.",
      "Order Yamada, train-as-means, and the going predicate.",
      "Complete Satou’s bicycle travel sentence.",
      "A pencil is the writing instrument. Choose means で.",
      "Mari works at the shop; the displayed predicate conflicts. Choose the repair.",
      "Retrieve Tanaka’s hospital workplace sentence.",
      "Complete Yamada’s school-study sentence.",
      "Listen to Satou’s train return and choose its written match.",
      "Say Mari’s hidden pencil-writing sentence.",
    ],
    accepted: [
      "The library is the place where studying happens.",
      "The park is licensed as the place of play.",
      ...
      "The repair selects the workplace predicate.",
      "The hospital is retrieved as Tanaka’s workplace.",
      "School is the setting for studying.",
      "The written sentence matches the transport recording.",
      "The spoken answer keeps the instrument role grounded.",
    ],
    retry: [
      "Treat the library as the action setting, not transport.",
      "Use the play predicate to identify the role.",
      "Use every tile and keep で attached to the train chunk.",
      "Choose the travel-means frame.",
      "The context asks what is used for writing.",
      "Diagnose the incompatible play predicate.",
      "Retrieve work at the hospital, not writing with a pencil.",
      "Use action-place で with studying.",
  ...
  ...semanticLessonCopy("argument-particles-4", {
    ...
    instructions: [
      "The learner eats in the cafeteria. Choose the action-place sentence.",
      "Tanaka works in the office. Choose the predicate-led frame.",
      "Order Yamada, the umbrella theme, and the buying predicate.",
      "Complete Satou’s diary-writing sentence.",
      "Suzuki is heading toward the station. Choose the directional view.",
      "The displayed umbrella is not a writing instrument. Choose Mari’s pencil repair.",
      "Retrieve the affirmative topicalized-book reading response.",
      "Complete Yamada’s university movement with the endpoint sense.",
      "Listen to Satou’s park-play sentence and choose its match.",
      "Say Suzuki’s hidden umbrella-purchase sentence.",
    ],
    accepted: [
      "The cafeteria is the place of eating.",
      "The office is licensed by the work-place sense.",
      ...
      "The book remains a licensed reading theme under は.",
      "University is the endpoint of going.",
      "The selected sentence matches the complete recording.",
      "The spoken answer uses を as o.",
    ],
    retry: [
      "Start from eating and identify the venue role.",
      "Use the work predicate before selecting で.",
      "Keep を after the umbrella and the verb final.",
      "Choose the diary as the written theme.",
      "Use へ for the authored route view.",
      "Diagnose the implausible train-as-writing-instrument context.",
      "Retrieve the reading frame, not drinking.",
      "Choose endpoint に rather than action-place で.",
      "Listen for both the park chunk and play predicate.",
...
const TIME_MOVEMENT_COPY_EN: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("time-movement-1", {
    ...
    objective:
      "Interpret dynamic ます predicates as habitual or future, never as an action ongoing now.",
    main:
      "A dynamic polite nonpast predicate receives a habitual or future interpretation from context. Japanese needs a later construction for an action specifically in progress now.",
    construction:
      "Read the event context first, choose routine or plan, and keep that semantic tag aligned in English and Italian.",
    constraints:
    ...
    nearestContrast:
      "はしります can mean “run regularly” or “will run”; neither reading says “am running right now.”",
    recap:
      "For every dynamic nonpast target, state whether the context is habitual or future.",
    translations: [
      "I run regularly.",
      "Tanaka will travel.",
      "Yamada cooks regularly.",
      "Satou will go out.",
      "I will run. (speaker recoverable)",
      "We will travel. (group recoverable)",
      "Suzuki cooks too.",
      "Mari goes out regularly.",
      "Yuki works regularly.",
      "My friend will study.",
    ],
    purposes: [
      "Makes the habitual reading explicit in context.",
      "Uses dynamic nonpast for a future plan.",
      "Adds a habitual する compound.",
      "Uses an authored future context without ongoing meaning.",
      "Shows future nonpast with natural omission.",
      "Keeps the planned group implicit.",
      "Combines an owned additive topic with habitual nonpast.",
      "Contrasts a routine with the earlier plan.",
      "Reviews an earlier predicate under the new semantic distinction.",
      "Requires future rather than ongoing-now.",
    ],
    instructions: [
      "The learner’s routine includes running. Choose the habitual sentence.",
      "Tanaka has a travel plan. Choose the future reading.",
      "Order Yamada’s additive topic and cooking predicate.",
      "Complete Satou’s plan to go out.",
      "Choose Suzuki’s running routine rather than a travel plan.",
      "Mari’s card is a future outing, but the displayed reading is habitual. Repair it.",
      "Retrieve Yuki’s established work routine.",
      "Complete the friend’s future study plan.",
      "Listen to Yamada’s travel plan and choose its written match.",
      "Say Suzuki’s hidden future outing sentence.",
    ],
    accepted: [
      "The context licenses a habitual running reading.",
      "The travel predicate is correctly read as future.",
      "The topic precedes the habitual cooking predicate.",
      "Satou’s nonpast predicate expresses a plan.",
      "Suzuki’s authored context is a routine.",
      "The repair changes the event reading to future.",
      "Yuki’s work is retrieved as habitual.",
      "The friend’s study event is future.",
      "The selected future sentence matches the recording.",
      "The spoken target is future, not ongoing-now.",
    ],
    retry: [
      "Use the routine context; do not invent an action in progress.",
      "Choose the planned-event reading.",
      "Use every tile and keep the predicate final.",
      "Read the plan context before choosing the form.",
      "Distinguish Suzuki’s routine from a different future event.",
      "Diagnose the habitual/future mismatch.",
      "Retrieve the established work fact.",
      "Keep the friend’s event in the future.",
      "Listen to the whole predicate and its plan context.",
  ...
  ...semanticLessonCopy("time-movement-2", {
    ...
    translations: [
      ...
      "I will go from the station as far as the university.",
    ...
    purposes: [
      ...
      "Links a specific time to a work event.",
    ...
    instructions: [
      "The learner wakes at seven. Choose the specific-time sentence.",
      "Tanaka rests today. Choose the relative-time form without obligatory に.",
      "Order Yamada, Monday に, and the study predicate.",
      "Complete Satou’s plan for tomorrow.",
      "Tanaka works from nine until five. Choose the temporal bounds.",
      "Mari’s displayed bound mixes a station with work. Choose the movement repair.",
    ...
    accepted: [
      ...
      "The work interval has explicit start and endpoint.",
    ...
    retry: [
      ...
      "Match the station/university path with going.",
  ...
  ...semanticLessonCopy("time-movement-3", {
    ...
    translations: [
      ...
      "I will not rest this week.",
      "I will not buy it next week.",
      "I worked yesterday.",
      "I studied last week.",
      "I did not rest yesterday.",
    ...
    instructions: [
      "The learner is scheduled to work this week. Choose nonpast affirmative.",
      "Tanaka’s trip is next week. Choose the future affirmative.",
      "Order Yamada, yesterday, and the worked form.",
      "Transform the displayed study stem into Satou’s past affirmative.",
      "Suzuki did not rest yesterday. Choose past negative.",
      "Mari will not buy it next week; the displayed past form is wrong. Repair it.",
      "Retrieve Tanaka’s past-negative leisure sentence.",
      "Choose Yamada’s nonpast-negative plan for this week.",
      "Listen to Satou’s yesterday-writing sentence and choose its match.",
      "Say Suzuki’s hidden next-week negative study plan.",
    ],
    accepted: [
      ...
      "The retrieved event is past and negative.",
      "The plan is future/nonpast and negative.",
    ...
    retry: [
      ...
      "Retrieve both past time and negative polarity.",
      "Use ません for this future plan.",
  ...
  ...semanticLessonCopy("time-movement-4", {
    ...
    nearestContrast:
      "けさはしりました reports a past event; こんばんかいぎをします schedules a future event.",
    recap:
    ...
    purposes: [
      ...
      "Gives dynamic nonpast a habitual evening reading.",
      "Uses a future reading, never ongoing-now.",
    ...
    instructions: [
      "The morning run already happened. Choose the past affirmative.",
      "The meeting is tomorrow. Choose the matching scheduled event.",
      "Order tonight, the work theme, and the doing predicate.",
      "Complete tomorrow’s lunch plan.",
      "Choose the habitual evening-work sentence.",
      "The meeting was cancelled, but the displayed sentence is affirmative. Repair it.",
      "Retrieve Tanaka’s Sunday rest routine.",
      "Complete tomorrow’s schedule-checking plan.",
      "Listen to the train route and choose its written match.",
      "Say the hidden meeting plan for tonight.",
    ],
    accepted: [
      ...
      "The evening context is habitual.",
    ...
    retry: [
      "Use a past form for the completed morning run.",
      "Keep the meeting in the stated future time.",
      "Use every tile and keep を with the work theme.",
      "Use eating for the lunch theme.",
      "Read the repeated evening context as habitual.",
      "Diagnose polarity before choosing the repair.",
      "Retrieve the Sunday に routine.",
      "Choose the schedule-checking predicate.",
      "Listen for the train means and movement verb.",
      "Recall the hidden meeting plan without an ongoing form.",
    ],
  }),
