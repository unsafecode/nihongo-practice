...
export const baseNavigationCopyIt: BaseNavigationCopy = deepFreeze({
  ...
  content: {
    ...
    "snd1-discriminate-vowels-instruction": "Scegli il suono vocalico diverso dalle altre opzioni.",
    ...
    "snd1-match-ie-instruction": "Associa le more ascoltate alla parola-ancora いえ.",
    ...
    "snd2-discriminate-kaga-instruction": "Distingui か non sonora da が sonora.",
    "snd2-segment-kagi-instruction": "Dividi la parola-ancora かぎ in more.",
    "snd2-recognize-jidi-instruction": "Riconosci le grafie じ e ぢ senza postulare un contrasto acustico universale.",
    "snd2-map-dakuten-instruction": "Associa i kana senza segno alle forme con dakuten o handakuten.",
    "snd2-match-kaze-instruction": "Associa la sequenza sonora alla parola-ancora かぜ.",
    "snd2-assemble-denwa-instruction": "Componi で・ん・わ mantenendo ん come una mora.",
    "snd2-listen-zudzu-instruction": "Ascolta e identifica se la grafia mostrata è ず o づ.",
    "snd2-read-panpu-instruction": "Leggi ad alta voce ぱ e ぷ con handakuten.",
    "snd3-discriminate-obasan-instruction": "Distingui おばさん da おばあさん con vocale lunga.",
    ...
    "snd4-discriminate-yoon-instruction": "Distingui yoon comuni come きゃ, しゃ e ちゃ.",
    ...
    "snd4-match-shashin-instruction": "Associa しゃ・し・ん alla parola-ancora しゃしん.",
