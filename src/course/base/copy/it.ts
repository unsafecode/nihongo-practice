...
export const baseNavigationCopyIt: BaseNavigationCopy = deepFreeze({
  ...
  content: {
    ...
    "snd1-discriminate-vowels-instruction": "Scegli la vocale anteriore chiusa e alta; l'altra opzione è anteriore media.",
    ...
    "snd2-recognize-jidi-instruction": "Scegli l'opzione che completa lo schema ortografico mostrato.",
