...
const POLITE_VERBS_COPY_IT: Readonly<Record<string, string>> = {
  ...
  ...semanticLessonCopy("polite-verbs-3", {
    ...
    retry: [
      ...
      "Usa le stesse tessere e mantieni la base pre-ます alla fine.",
  ...
  ...semanticLessonCopy("polite-verbs-4", {
    ...
    retry: [
      ...
      "Usa tutte le tessere e mantieni la forma di camminare alla fine.",
      "Mantieni il verbo ascoltare ed esprimi la routine aggiuntiva di Yamada.",
      "Mantieni il verbo preparare e ripara soltanto il finale cortese mancante.",
      "Individua la combinazione malformata di base e finale prima di scegliere la riparazione.",
      "Mantieni la routine aggiuntiva di riposo dell'insegnante e ripara soltanto la base verbale.",
      "Recupera il piano aggiuntivo di Mari per dormire.",
      "Ascolta tutto il finale.",
...
const ARGUMENT_PARTICLES_COPY_IT: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("argument-particles-1", {
    ...
    instructions: [
      "La scheda del pasto introduce il riso come informazione nuova. Scegli la frase neutra sul mangiare.",
      ...
      "La rivista è già al centro del discorso. Riorganizza la scheda neutra dell'acquisto come elemento già stabilito.",
    ...
    retry: [
      ...
      "Mantieni fisso comprare e cambia soltanto l'organizzazione discorsiva della rivista.",
      ...
      "Mantieni nominato chi studia e conserva l'organizzazione neutra della lettera.",
      "Ascolta la particella dopo acqua e tutta la forma di comprare.",
  ...
  ...semanticLessonCopy("argument-particles-2", {
    ...
    retry: [
      ...
      "Usa tutte le tessere e mantieni in fondo la forma di movimento.",
  ...
  ...semanticLessonCopy("argument-particles-4", {
    ...
    retry: [
      ...
      "Ascolta sia il blocco parco sia la forma di movimento.",
...
const TIME_MOVEMENT_COPY_IT: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("time-movement-1", {
    ...
    retry: [
      ...
      "Usa tutte le tessere e mantieni in fondo la forma di cucinare.",
      ...
      "Ascolta l'espressione temporale completa e la forma di studiare.",
  ...
  ...semanticLessonCopy("time-movement-2", {
    ...
    retry: [
      ...
      "Usa tutte le tessere e mantieni in fondo la forma di studiare.",
  ...
  ...semanticLessonCopy("time-movement-3", {
    ...
    retry: [
      ...
      "Costruisci ました dalla base pre-ます nota.",
  ...
  ...semanticLessonCopy("time-movement-4", {
    ...
    retry: [
      ...
      "Usa tutte le tessere e mantieni を dopo l'elemento lavoro.",
      "Mantieni mangiare con l'elemento pranzo.",
      "Mantieni sia まいしゅう sia よるに con la forma di studiare.",
      "Individua la polarità prima di riparare.",
      "Recupera la routine domenicale con に.",
      "Scegli la forma che indica il controllo del programma.",
