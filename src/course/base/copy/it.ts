...
const POLITE_VERBS_COPY_IT: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("polite-verbs-1", {
    ...
    instructions: [
      ...
      "Usa ogni tessera per riprodurre la scheda in due parti del docente.",
      ...
      "Dal verbo mostrato, pronuncia la scheda di analisi nascosta con due etichette.",
    ],
    accepted: [
      ...
      "Le due tessere riproducono la scheda ぶんまつ indicata.",
    ...
    retry: [
      "Usa la posizione della scheda nel modello, non il suo significato.",
      ...
      "Usa ogni tessera nell'ordine mostrato.",
      "Segui la disposizione intestazione-verbo mostrata nel glossario.",
      "Cambia soltanto l'annotazione incompatibile; conserva il verbo.",
      "Recupera l'analisi richiesta dal foglio.",
      "Ascolta entrambe le parti prima di scegliere.",
      "Ricorda la scheda analizzata nascosta; non è mostrata alcuna risposta.",
    ],
  }),
  ...
  ...semanticLessonCopy("polite-verbs-4", {
    ...
    instructions: [
      ...
      "Tanaka ascolta per primo; l'elenco aggiunge Suzuki alla stessa routine. Trasforma il tema mostrato nell'enunciato completo di Suzuki.",
      "Yamada preparerà un oggetto; il programma aggiunge Mari allo stesso piano. Completa l'enunciato di Mari.",
      "Il predicato mostrato collega il finale cortese alla base sbagliata. Ripara soltanto questo difetto.",
      "Tanaka incontrerà per primo il gruppo; il programma aggiunge Yuki allo stesso piano. Scegli l'enunciato di Yuki.",
      "Yuki canta per prima; l'elenco aggiunge l'amico alla stessa routine. Recupera l'enunciato dell'amico.",
    ...
    accepted: [
      ...
      "Suzuki è aggiunto con も e il tema generato prende correttamente ます.",
      "Mari è aggiunta con も al piano futuro già stabilito.",
      "La riparazione usa il predicato parlare richiesto dal contesto.",
      "Yuki è aggiunta con も; la persona dell'incontro resta implicita e recuperabile.",
      "L'amico è aggiunto con も alla routine di canto già stabilita.",
    ...
    retry: [
      ...
      "Mantieni il verbo ascoltare ed esprimi la routine aggiuntiva di Suzuki.",
      "Mantieni il verbo preparare e l'antecedente stabilito per も.",
      "Individua la combinazione malformata di tema e finale prima di scegliere la riparazione.",
      "Mantieni implicita la persona incontrata e conserva la lettura di piano aggiuntivo.",
      "Recupera la routine aggiuntiva di canto dell'amico.",
...
const ARGUMENT_PARTICLES_COPY_IT: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("argument-particles-1", {
    ...
    instructions: [
      ...
      "L'acquisto di una rivista è mostrato con organizzazione neutra. Rendi la rivista il tema discorsivo stabilito.",
      ...
      "Ascolta la conferma sull'acquisto della frutta e scegli la forma scritta.",
      "Dall'indizio rivista, pronuncia la frase nascosta di Yamada.",
    ],
    accepted: [
      "Mangiare ammette il tema riso e il relativo を.",
      "Entrambe le scelte mantengono fisso bere; l'organizzazione scelta corrisponde alla scheda.",
      "Tutte le tessere sono usate e il predicato resta finale.",
      "La frutta è marcata come tema di comprare.",
      "La rivista resta il tema ammesso da comprare mentre は ne cambia lo stato discorsivo.",
    ...
    retry: [
      ...
      "Mantieni fisso il predicato bere e confronta soltanto le due organizzazioni discorsive.",
      "Mantieni を dopo lettera e il verbo in fondo.",
      "Usa comprare nel contesto della frutta.",
      "Topicalizza la rivista mantenendo invariato il predicato comprare.",
  ...
  ...semanticLessonCopy("argument-particles-3", {
    ...
    retry: [
      "Usa la biblioteca come luogo in cui avviene la scrittura, non come ciò che la esegue.",
      "Mantieni fisso scrivere e seleziona la frase con il negozio.",
      "Usa tutte le tessere e mantieni で con il blocco treno.",
      "Segui la bicicletta mostrata sull'abbonamento di Satou.",
      "Segui ciò che Suzuki usa quando scrive.",
      "Individua l’etichetta di ruolo incompatibile senza cambiare il predicato.",
      "Recupera la frase sulla scrittura al parco.",
      "Usa il contesto della scrittura a scuola.",
  ...
  ...semanticLessonCopy("argument-particles-4", {
    ...
    retry: [
      ...
      "Mantieni fisso scrivere e scegli dove si trova Tanaka, non ciò che usa.",
      ...
      "Mantieni il predicato leggere e presenta il diario come tema già stabilito.",
...
const TIME_MOVEMENT_COPY_IT: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("time-movement-1", {
    ...
    purposes: [
      ...
      "Aggiunge un riposo regolare con lettura abituale.",
      "Usa un evento di sonno programmato, mai una lettura progressiva.",
    ],
    instructions: [
      "Il calendario di chi studia mostra una corsa ogni sabato. Scegli l'annotazione corrispondente.",
      "La prenotazione del viaggio di Tanaka è datata il mese prossimo. Scegli l'annotazione corrispondente.",
      "Ordina ogni tessera sulla scheda della cucina settimanale di Yamada.",
      "Il biglietto di Satou è datato domani. Completa la scheda corrispondente.",
      "Suzuki corre ogni domenica. Scegli l'annotazione corrispondente.",
      "L'uscita di Mari è prenotata per domani, ma l'annotazione mostrata dice ogni settimana. Ripara soltanto l'annotazione.",
      "Il calendario di Yuki segna riposo ogni domenica. Recupera la scheda corrispondente.",
      "L'ora di dormire dell'amico è nel programma di domani. Completa la scheda corrispondente.",
      "Ascolta la data sulla prenotazione del viaggio di Yamada e scegli la forma scritta.",
    ...
    accepted: [
      ...
      "Il riposo regolare di Yuki è recuperato con la lettura settimanale.",
      "Il sonno dell'amico è programmato per il giorno indicato.",
    ...
    retry: [
      ...
      "Recupera la scheda del riposo settimanale stabilito.",
      "Mantieni il sonno dell'amico nel programma indicato.",
  ...
  ...semanticLessonCopy("time-movement-3", {
    ...
    instructions: [
      ...
      "Il registro della settimana scorsa indica la sessione di studio come conclusa. Trasforma il tema mostrato.",
      ...
      "Nel registro di Tanaka non compare alcuna attività di svago la settimana scorsa. Recupera la frase.",
      "Nell'elenco di Yamada non compare alcun turno di riposo questa settimana. Scegli la frase.",
  ...
  ...semanticLessonCopy("time-movement-4", {
    ...
    instructions: [
      "Il registro del mattino indica la corsa come conclusa. Scegli la frase corrispondente.",
      ...
      "L'elenco di Tanaka mostra lo stesso turno serale ogni settimana. Scegli la frase corrispondente.",
