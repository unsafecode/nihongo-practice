...
const SENTENCE_FOUNDATIONS_COPY_IT: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("sentence-foundations-1", {
    ...
    instructions: [
      ...
      "Alla porta dell'aula, scegli il frammento che indica l'insegnante.",
      "Indicando l'animale nella foto, scegli il frammento gatto.",
      "A scuola, quando viene chiesto l'oggetto necessario, scegli il frammento libro.",
      "Su una mappa semplice, scegli il frammento casa.",
      "Per la scena con le onde, scegli il frammento mare.",
      "Per l'edificio sul percorso mattutino, scegli il frammento scuola.",
      "Sullo schermo del telefono, scegli il frammento fotografia.",
      "Al banco viaggi, pronuncia il frammento biglietto.",
    ],
  ...
  ...semanticLessonCopy("sentence-foundations-2", {
    ...
    instructions: [
      ...
      "Quando viene richiesta la categoria e non il nome, scegli persona.",
      "Nello spazio finale del modello, scegli studente.",
      "Nello spazio del titolo finale, scegli insegnante.",
      "Con il parlante della foto già condiviso, rispondi soltanto io.",
      "Con l'animale già condiviso, rispondi soltanto gatto.",
      "Con l'oggetto già indicato, rispondi soltanto libro.",
      "Con il luogo sulla mappa già condiviso, rispondi soltanto casa.",
      "Con lo schermo del telefono condiviso, pronuncia soltanto fotografia.",
    ],
  ...
  ...semanticLessonCopy("sentence-foundations-3", {
    ...
    instructions: [
      ...
      "L'addetto indica il biglietto: completa il predicato con です.",
      "La mappa indica la scuola: scegli l'identificazione cortese completa.",
      "L'amico fornisce l'indizio dell'orario: scegli il predicato completo mattina.",
      "La chiave è l'oggetto in questione: completa l'identificazione.",
      ...
      "È in questione il cartello di attenzione: scegli il predicato completo.",
      "Pronuncia il predicato cortese completo che identifica il viaggio.",
    ],
  ...
  ...semanticLessonCopy("sentence-foundations-4", {
    ...
    instructions: [
      ...
      "Reintroducendo Yamada come tema sospeso, indica la relazione di amicizia.",
      "Con l'amico esplicito, scegli la categoria più ampia studente invece dell'etichetta specifica studente internazionale.",
      "La scena è già condivisa: rispondi soltanto che è il mare.",
      "Nella foto di famiglia condivisa, rispondi soltanto che l'animale è un gatto.",
      "L'oggetto è condiviso: rispondi soltanto che è un telefono.",
      "Il luogo è condiviso: rispondi soltanto che è una casa.",
      "L'oggetto al banco è condiviso: rispondi soltanto che è un biglietto.",
      "Pronuncia il predicato completo per la scuola già condivisa.",
    ],
...
const TOPIC_QUESTIONS_COPY_IT: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("topic-questions-1", {
    ...
    instructions: [
      "La foto mostra Tokyo: scegli la frase che pone la foto come tema.",
      "La foto seguente mostra Kyoto: scegli il commento contrastivo.",
      "La terza foto mostra Osaka: scegli il suo commento tematico.",
      "Il tuo stato di studente è già in discussione: scegli は.",
      "Tanaka è già in discussione: identificalo come infermiere con は.",
      "Contrasta Yamada con Tanaka e identificalo come avvocato.",
      ...
      "La casa è il tema: scegli Tokyo come risposta fornita dal contesto.",
      "Il biglietto è per Kyoto: pronuncia la risposta contrastiva sulla destinazione.",
    ],
  ...
  ...semanticLessonCopy("topic-questions-2", {
    ...
    translations: [
      ...
      "No: è Suzuki a essere l'insegnante.",
      "Il medico è Mari.",
      "Quanto a Satou, è studente.",
      "Quanto a Suzuki, è insegnante.",
      "Quanto a Mari, è medico.",
      "È Tanaka a essere l'infermiere.",
      "È Yamada a essere l'avvocato.",
      "Quanto a me, sono studente universitario.",
      "È il mio amico a essere lo studente internazionale.",
    ],
    purposes: [
      "Introduce un nuovo soggetto nominato come risposta focalizzata.",
      "Usa が come focus correttivo dopo una proposta errata.",
      "Usa が per una selezione esaustiva del ruolo di medico.",
    ...
    instructions: [
      "Satou chiede quale città sia appena identificata: scegli Tokyo con が.",
      "Suzuki mantiene la fotografia come tema e identifica Tokyo: scegli は.",
      "Mari chiede quale città sia appena selezionata: scegli Kyoto con が.",
      "Satou mantiene la casa come tema e identifica Kyoto: scegli は.",
      "Suzuki seleziona Osaka come città focalizzata: scegli が.",
      "Mari mantiene la fotografia come tema e identifica Osaka: scegli は.",
      "Tanaka è già tema: mantieni は nel fatto che è infermiere.",
      "Yamada resta il tema: mantieni は nel fatto che è avvocato.",
      "L'amico è già stabilito: scegli は per studente internazionale.",
      "La domanda seleziona il parlante come nuovo studente: scegli が.",
    ],
  ...
  ...semanticLessonCopy("topic-questions-3", {
    ...
    instructions: [
      ...
      "Aggiungi che anche mio fratello è studente, mantenendo わたしの.",
      "Aggiungi che anche mia sorella è avvocata, mantenendo わたしの.",
      "Con mio padre come tema, afferma che è insegnante.",
      "Con mia madre come tema, afferma che è medico.",
      "Con mio fratello maggiore stabilito, afferma che è studente.",
      "Con mia sorella maggiore stabilita, afferma che è avvocata.",
      "Ascolta il termine familiare rispettoso e il も additivo.",
      "Pronuncia la frase sulla madre rispettosa con も additivo.",
    ],
  ...
  ...semanticLessonCopy("topic-questions-4", {
    ...
    instructions: [
      "Conferma se il nome è Yuki con una domanda completa in か.",
      "Conferma se il paese sono gli Stati Uniti.",
      "Alla domanda sui paesi inclusi, rispondi con l'elenco America e Italia.",
      "Alla domanda sui due dati richiesti, rispondi paese e nome.",
      "Reagisci a un'informazione sorprendente con «Davvero?» completo.",
      "Conferma gli Stati Uniti con una risposta naturale in はい.",
      "Rifiuta Italia e correggi il paese in Stati Uniti.",
      "Chiedi se Yuki è amico di qualcuno con と di compagnia e か.",
      "Ascolta l'affermazione «Sono amico di Yuki».",
      "Chiedi ad alta voce con chi è amica la persona, usando と e か.",
    ],
...
const SEMANTIC_OPERATION_COPY_IT: Readonly<Record<string, string>> = {
  ...
  "diagnose-error-feedback-accepted":
    "La diagnosi individua la reale incompatibilità del blocco o della particella.",
  "diagnose-error-feedback-retry":
    "Controlla il contesto, poi indica il blocco o la particella che lo contraddice.",
