...
const COPULA_ADJECTIVES_COPY_IT: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("copula-adjectives-1", {
    ...
    instructions: [
      ...
      "Usa il profilo dell'amicizia e scegli l'enunciato supportato.",
      ...
      "Ricorda la correzione nascosta dell'elenco scolastico e pronuncia l'enunciato completo.",
    ],
    accepted: [
    ...
    retry: [
      ...
      "Ricorda lo stato segnato senza leggere una scelta.",
    ],
  }),
  ...semanticLessonCopy("copula-adjectives-2", {
    ...
    instructions: [
      ...
      "Ricorda la storia nascosta del personale di cucina e pronuncia l'enunciato completo.",
    ],
    accepted: [
    ...
    retry: [
      ...
      "Ricorda il dato della cucina senza leggere un'opzione.",
    ],
  }),
  ...semanticLessonCopy("copula-adjectives-3", {
    ...
    instructions: [
      ...
      "Ricorda la recensione nascosta della rivista e pronuncia l'enunciato completo.",
    ],
    accepted: [
    ...
    retry: [
      ...
      "Ricorda il giudizio sulla rivista senza leggere una scelta.",
    ],
  }),
  ...semanticLessonCopy("copula-adjectives-4", {
    ...
    instructions: [
      ...
      "Una scheda dice che il parlante non detesta l'amico mostrato. Completa la risposta.",
      ...
      "Ricorda il profilo nascosto dello studente e pronuncia l'enunciato completo.",
    ],
    accepted: [
      ...
      "La risposta completata corrisponde alla scheda.",
    ...
    retry: [
      ...
      "Mantieni insieme i blocchi come un'unica affermazione completa.",
      "Usa la scheda visibile senza cambiare il partecipante.",
      ...
      "Riascolta tutto prima di confrontare entrambi gli enunciati.",
      "Ricorda il profilo dello studente senza leggere una scelta.",
    ],
  }),
  ...
  "adjective-kirai-meaning": "sgradito; antipatico",
};
...
const EXISTENCE_LOCATION_COPY_IT: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("existence-location-1", {
    ...
    main:
      "Il giapponese usa due verbi d'esistenza. ある presenta una cosa inanimata come esistente; いる presenta una persona o un animale come presente.",
    construction:
      "Classifica autonomamente l'entità, conserva per ora il noto schema con tema e scegli あります o います cortese.",
    constraints:
    ...
    nearestContrast:
      "つくえはあります presenta una scrivania; いぬはいます presenta un cane vivo.",
    recap:
    ...
    purposes: [
      "Abbina una cosa ad あります.",
      "Abbina un animale ad います.",
      "Classifica un altro oggetto.",
      "Recupera un oggetto noto.",
      "Usa います per una persona.",
      "Mantiene la scelta indipendente dalla dimensione.",
      "Recupera una persona nota.",
      "Applica あります a un piccolo oggetto.",
      "Applica います a una persona nominata.",
      "Chiude con un veicolo noto.",
    ],
    instructions: [
  ...
  ...semanticLessonCopy("existence-location-4", {
    ...
    instructions: [
      ...
      "Ricorda il luogo nascosto dell'agente e pronuncia la risposta completa.",
    ],
    accepted: EXISTENCE_ACCEPTED_IT,
    retry: EXISTENCE_RETRY_IT,
  }),
  ...
  ...semanticLessonCopy("requests-connection-2", {
    ...
    purposes: [
      ...
      "Modella una breve accettazione naturale dopo una richiesta.",
    ],
    instructions: [
      "Un collega offre aiuto con il lavoro. Scegli l'accettazione naturale.",
      "Devi vedere la mappa e prima richiamare l'attenzione dell'altra persona. Scegli la battuta completa.",
      "Costruisci la richiesta sulla borsa con tutti i segmenti mostrati.",
      "Alla stazione, chiedi di chiamare l'agente indicato nella scena.",
      "Chiedi che venga mostrato il bagaglio indicato nel passaggio.",
      ...
      "Chiedi a un collega di mostrare i documenti, attenuando la richiesta.",
      "Ascolta tutta la registrazione, poi scegli la richiesta completa corrispondente.",
      "Dalla scheda dell'insegnante, richiama a voce la richiesta completa e attenuata.",
    ],
    accepted: [
      "Giusto: qui おねがいします accetta naturalmente l'offerta.",
      "Giusto: richiamo e richiesta formano una battuta completa.",
      "Giusto: l'oggetto precede la richiesta con predicato finale.",
      "Giusto: si chiede di chiamare l'agente.",
      "Giusto: l'azione richiesta è mostrare il bagaglio.",
      "Giusto: ください completa la richiesta prevista.",
      "Giusto: qui ね attenua in modo adatto al contesto.",
      "Giusto: si chiede con delicatezza al collega di mostrare i documenti.",
    ...
    retry: [
      ...
      "Usa una volta ogni segmento in una battuta con predicato finale.",
      "Mantieni fissa la persona nella scena della stazione.",
      "Mantieni fissi il bagaglio e il risultato richiesto.",
      "Conserva la richiesta visibile e ripara solo ciò che è incompleto.",
      "Tieni presente il rapporto familiare a tavola.",
      "Torna al passaggio dei documenti.",
      "Riascolta tutta la registrazione prima di scegliere.",
      "Mantieni l'insegnante come persona richiesta.",
    ],
  }),
  ...
  ...semanticLessonCopy("requests-connection-4", {
    ...
    nearestContrast:
      "たべています descrive qui il mangiare in corso; しっています è conoscenza attuale, mentre すわっています o きています descrive un risultato/stato mantenuto.",
    recap:
    ...
    translations: [
      ...
      "Lo indosso.",
      "Sono seduto.",
      "Sto aspettando adesso.",
      "Sto guardando adesso.",
    ],
    purposes: [
      "Contrassegna un'azione dinamica visibilmente in corso.",
      "Lega l'affermazione a questo momento.",
      "Applica la costruzione alla scrittura in corso.",
      "Applica la costruzione al parlare in corso.",
      "Usa l'allomorfo sonoro in un'azione in corso.",
      "Usa しています per lo studio in corso.",
      "Contrappone un'azione attuale al non passato abituale.",
      "Tratta しっています come stato attuale di conoscenza.",
      "Usa きています per lo stato dopo aver indossato un capo.",
      "Usa すわっています per uno stato seduto mantenuto.",
      "Delimita l'attesa come azione in corso ora.",
      "Usa la costruzione per un'azione delimitata in corso.",
    ],
    instructions: [
      "Yamada ha già imparato la risposta. Scegli l'enunciato della conoscenza attuale.",
      ...
      "Suzuki si è seduto e rimane lì. Scegli la condizione attuale visibile.",
      ...
      "Nel controllo dell'abbigliamento, riferisci la condizione di Yamada dopo essersi vestito.",
      "Tanaka ha già imparato la risposta. Recupera il resoconto della conoscenza attuale.",
      "Ascolta tutta la registrazione, poi scegli il resoconto completo dell'azione attuale corrispondente.",
      "Tanaka si è seduto. Richiama a voce il resoconto della condizione attuale.",
    ],
    accepted: [
  ...
  "requests-connection-2-practical-dialogue-turn-6-purpose":
    "Accetta naturalmente l'aiuto offerto.",
