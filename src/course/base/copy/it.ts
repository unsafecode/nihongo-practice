...
const POLITE_VERBS_COPY_IT: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("polite-verbs-1", {
    ...
    instructions: [
      ...
      "Il modello colloca la scheda verbale nello spazio a sinistra. Ordina ogni tessera.",
  ...
  ...semanticLessonCopy("polite-verbs-3", {
    ...
    instructions: [
      ...
      "Una scheda sull'azione di aspettare richiede l'analisi del tema generato. Scegli la derivazione sostenuta.",
      ...
      "Completa la scheda mostrata del verbo venire con l'analisi del tema noto.",
      ...
      "Recupera l'analisi del tema generato per il composto passeggiare mostrato.",
      "Ascolta la scheda del tema di guardare e scegli la forma scritta.",
      "Dalla forma di consultazione di leggere, pronuncia l'analisi nascosta del tema.",
    ],
    accepted: [
    ...
    retry: [
      ...
      "Sposta il つ finale nella forma godan in ち.",
      ...
      "Ricorda e pronuncia il tema nascosto di leggere; non ci sono opzioni.",
    ],
  }),
  ...semanticLessonCopy("polite-verbs-4", {
    ...
    instructions: [
      ...
      "Suzuki ascolta per primo; l'elenco aggiunge Yamada alla stessa routine. Trasforma il tema mostrato nell'enunciato completo di Yamada.",
    ...
    retry: [
      ...
      "Mantieni il verbo ascoltare ed esprimi la routine aggiuntiva di Yamada.",
      "Mantieni il verbo preparare e l'antecedente stabilito per il も di Tanaka.",
      "Individua la combinazione malformata di tema e finale prima di scegliere la riparazione.",
      "Mantieni il predicato riposare e conserva la lettura aggiuntiva dell'insegnante.",
...
const ARGUMENT_PARTICLES_COPY_IT: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("argument-particles-1", {
    ...
    instructions: [
      ...
      "L'elenco richiede la frase neutra di chi studia sulla lettera scritta. Recuperala.",
    ...
    retry: [
      ...
      "Mantieni il tema di chi studia e l'organizzazione neutra della lettera.",
      "Ascolta la particella dopo acqua e tutto il predicato comprare.",
  ...
  ...semanticLessonCopy("argument-particles-4", {
    ...
    instructions: [
      "Il pasto di chi studia si svolge in mensa. Scegli la frase corrispondente.",
...
const TIME_MOVEMENT_COPY_IT: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("time-movement-1", {
    ...
    retry: [
      "Segui ふだん; non inventare un'azione in corso.",
      "Segui l'espressione temporale di domani.",
      "Usa tutte le tessere e mantieni finale il predicato.",
      "Leggi il biglietto datato prima di scegliere la frase.",
      "Distingui ogni settimana da domani.",
      "Sostituisci la prova temporale errata senza spostarla.",
      "Recupera la frase di riposo con まいしゅう.",
      "Mantieni il sonno dell'amico con あした.",
      "Ascolta l'espressione temporale completa e il predicato.",
  ...
  ...semanticLessonCopy("time-movement-2", {
    ...
    retry: [
      ...
      "Abbina il percorso stazione/università a viaggiare.",
  ...
  ...semanticLessonCopy("time-movement-3", {
    ...
    retry: [
      ...
      "Recupera l'evento di canto assente della settimana scorsa.",
      "Mantieni assente l'incontro dal calendario di questa settimana.",
  ...
  ...semanticLessonCopy("time-movement-4", {
    ...
    retry: [
      "Usa una forma passata per la camminata mattutina conclusa.",
      ...
      "Mantieni sia まいしゅう sia よるに con il predicato studiare.",
      ...
      "Usa sia Suzuki sia stasera dall'indizio; non aggiungere una forma progressiva.",
    ],
  }),
