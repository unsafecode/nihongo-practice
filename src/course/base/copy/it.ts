...
const POLITE_VERBS_COPY_IT: Readonly<Record<string, string>> = {
  ...
  ...semanticLessonCopy("polite-verbs-2", {
    ...
    instructions: [
      ...
      "Una scheda sull’azione del mangiare richiede un’analisi di classe. Scegli quella sostenuta.",
      ...
      "Una scheda sull’azione di fare richiede l’analisi della classe speciale. Scegli quella sostenuta.",
      "Una scheda sull’azione di arrivare richiede l’analisi della classe speciale. Recupera quella sostenuta.",
      ...
      "Dall’indizio amico, pronuncia a memoria la scheda nascosta di analisi della classe.",
    ],
    accepted: [
  ...
  ...semanticLessonCopy("polite-verbs-3", {
    ...
    instructions: [
      "Una scheda sull’azione di scrivere richiede l’analisi del tema generato. Scegli la derivazione sostenuta.",
      "Una scheda sull’azione di mangiare richiede l’analisi del tema generato. Scegli la derivazione sostenuta.",
      "Ordina la forma di consultazione prima del tema generato usando tutte le tessere.",
      "Trasforma la scheda di consultazione dell’azione fare nell’analisi del tema noto.",
      "Completa la scheda dell’azione di arrivare di Suzuki con l’analisi del tema noto.",
      "Il tema di ritorno segue la classe sbagliata. Scegli la riparazione.",
      "Una scheda sull’azione di telefonare richiede l’analisi del tema generato. Scegli la derivazione sostenuta.",
      "Recupera l’analisi del tema generato per la scheda dell’azione di passeggiare dell’amico.",
      "Ascolta il tema del guardare dello studente e scegli la forma scritta.",
      "Dall’indizio Tanaka, pronuncia l’analisi nascosta del tema dell’azione aspettare.",
    ],
    accepted: [
      ...
      "La scheda pronunciata riproduce l’analisi nascosta del tema dell’azione aspettare.",
    ],
    retry: [
  ...
  ...semanticLessonCopy("polite-verbs-4", {
    ...
    instructions: [
      "Sono mostrati un contesto con sveglia e due schede di consultazione. Scegli la forma completa nota che corrisponde all’evento.",
      "La scheda condivisa indica il giorno libero di Yamada. Scegli la forma completa nota.",
      "È mostrato il piano di percorso di Yamada. Ordina tutte le tessere in una frase completa.",
      "Trasforma il tema dell’azione di ascoltare nella forma cortese completa già nota.",
      "Completa il piano di Mari con il predicato preparare.",
      "Il predicato mostrato collega il finale cortese alla base sbagliata. Ripara soltanto questo difetto.",
      "Scegli la frase sull'incontro programmato di Yuki.",
      "Recupera la routine di canto dell'amico.",
      "Ascolta la frase completa sul percorso dell’insegnante e scegli la forma scritta.",
      "Dall'indizio studente, pronuncia la frase nascosta sull'attesa.",
    ],
    accepted: [
      "Il predicato in ます esprime la routine di chi parla.",
      "La forma completa corrisponde al giorno libero stabilito per Yamada.",
    ...
    retry: [
      ...
      "Usa il contesto del giorno libero di Yamada e scegli la forma completa.",
      ...
      "Individua la combinazione malformata di tema e finale prima di scegliere la riparazione.",
  ...
  "polite-verbs-4-practical-dialogue-turn-3-translation": "Anche Yamada riposa?",
  "polite-verbs-4-practical-dialogue-turn-3-purpose":
    "Passa a un referente diverso prima di chiedere del riposo.",
  "polite-verbs-4-practical-dialogue-turn-4-translation": "Sì, Yamada riposa.",
  "polite-verbs-4-practical-dialogue-turn-4-purpose":
    "Conferma il nuovo referente senza contraddire la routine di Tanaka.",
...
const ARGUMENT_PARTICLES_COPY_IT: Readonly<Record<string, string>> = {
  ...semanticLessonCopy("argument-particles-1", {
    ...
    instructions: [
      ...
      "Ordina Yamada, il tema lettera e il predicato finale usando tutte le tessere.",
      "Completa la frase di Satou sull'acquisto della frutta.",
      "Riorganizza il tema rivista mostrato come tema discorsivo stabilito.",
      "L’affermazione neutra di Mari sul libro è stata organizzata come tema contrastivo. Ripara soltanto l’organizzazione.",
      ...
      "Ascolta la risposta affermativa sulla frutta topicalizzata e scegli la forma scritta.",
    ...
    retry: [
      ...
      "Individua l’incompatibilità tra organizzazione neutra e topicale.",
  ...
  ...semanticLessonCopy("argument-particles-2", {
    ...
    instructions: [
      "Il percorso condiviso tratta la stazione come punto d’arrivo. Scegli la frase corrispondente.",
      ...
      "La scheda di percorso di Mari mostra una direzione dove il contesto richiede una meta. Ripara soltanto la prospettiva.",
      "Scegli il movimento di Tanaka verso Tokyo.",
      "Recupera il percorso di Yamada verso Kyoto visto come meta, non come direzione.",
      "Ascolta la frase di Satou con casa come meta e scegli la forma scritta.",
    ...
    retry: [
      ...
      "Individua se il contesto casa richiede una direzione o una meta.",
      "In questa scena Tokyo è una direzione.",
      "Recupera la prospettiva di Kyoto come meta, non quella direzionale.",
  ...
  ...semanticLessonCopy("argument-particles-3", {
    ...
    instructions: [
      "La biblioteca è l’ambiente dello studio. Scegli l’analisi di ruolo corrispondente.",
      "È mostrata la scheda di Tanaka che scrive al parco. Scegli l’analisi di ruolo sostenuta.",
      "Ordina Yamada, il treno come mezzo e il predicato andare.",
      "È mostrata la scheda di Satou sul viaggio in bicicletta. Scegli l’analisi di ruolo sostenuta.",
      "La matita è lo strumento per scrivere. Scegli l’analisi di ruolo corrispondente.",
      "La scheda di Mari sulla scrittura al negozio porta l’analisi di ruolo sbagliata. Ripara soltanto l’etichetta.",
      "Recupera la scheda di Tanaka sullo studio in ospedale con l’analisi sostenuta.",
      "Completa la frase di Yamada sullo studio a scuola.",
      "Ascolta la scheda di Satou sul viaggio in treno e scegli l’analisi sostenuta.",
      "Pronuncia la frase nascosta di Mari con la matita.",
    ],
    accepted: [
      "La biblioteca è il luogo in cui avviene lo studio.",
      "L’etichetta di ruolo identifica il parco come ambiente della scrittura.",
      ...
      "L’ospedale è recuperato come ambiente dello studio di Tanaka.",
    ...
    retry: [
      ...
      "Usa il contesto della scrittura per individuare il ruolo.",
      ...
      "Individua l’etichetta di ruolo incompatibile senza cambiare il predicato.",
      "Recupera la scheda di studio in ospedale e l’analisi di luogo sostenuta.",
  ...
  ...semanticLessonCopy("argument-particles-4", {
    ...
    instructions: [
      ...
      "È mostrata la scheda di Tanaka che scrive in ufficio. Scegli l’analisi di ruolo sostenuta.",
    ...
    accepted: [
      ...
      "L’etichetta di ruolo identifica l’ufficio come ambiente della scrittura.",
    ...
    retry: [
      ...
      "Usa l’ambiente della scrittura per scegliere l’analisi di luogo sostenuta.",
      ...
      "Individua il contesto incoerente dell’ombrello come strumento di scrittura.",
      "Recupera lo schema topicalizzato di lettura, non l’organizzazione neutra dell’oggetto.",
      "Scegli la prospettiva di meta, non quella direzionale.",
      "Ascolta sia il blocco parco sia il predicato di movimento.",
...
const TIME_MOVEMENT_COPY_IT: Readonly<Record<string, string>> = {
  ...
  ...semanticLessonCopy("time-movement-2", {
    ...
    instructions: [
      ...
      "Ordina il blocco del giorno nominato prima del predicato finale di Yamada usando tutte le tessere.",
  ...
  ...semanticLessonCopy("time-movement-3", {
    ...
    instructions: [
      "Il programma segna un evento non negato per questa settimana. Scegli la forma corrispondente.",
      "Il programma di Tanaka colloca un evento di lavoro non negato nella prossima settimana. Scegli la forma corrispondente.",
      "Ordina Yamada, ieri e la forma passata di lavorare.",
      "L’evento è avvenuto la settimana scorsa e non è negato. Trasforma il tema mostrato nella forma corrispondente.",
      "L’evento non è avvenuto ieri. Scegli la forma che corrisponde al tempo concluso e alla polarità negativa.",
      "La scheda dell’acquisto di Mari per la prossima settimana è barrata, ma la forma mostrata ha tempo e polarità sbagliati. Riparala.",
      "Recupera la frase passata negativa sullo svago di Tanaka.",
      "La scheda di questa settimana mostra un evento programmato barrato. Scegli la forma che corrisponde a tempo e polarità.",
  ...
  ...semanticLessonCopy("time-movement-4", {
    ...
    purposes: [
      ...
      "Usa に con l'espressione temporale nota per la sera.",
