...
const SENTENCE_FOUNDATIONS_COPY_IT: Readonly<Record<string, string>> = {
  ...
  ...semanticLessonCopy("sentence-foundations-2", {
    ...
    translations: [
      ...
      "Telefono—insegnante. (frammento di instradamento esplicito)",
      "Insegnante. (il campo telefono è recuperabile)",
    ],
    purposes: [
      ...
      "Esprime insieme il campo telefono e il ruolo instradato.",
...
const TOPIC_QUESTIONS_COPY_IT: Readonly<Record<string, string>> = {
  ...
  ...semanticLessonCopy("topic-questions-2", {
    ...
    retry: [
      ...
      "Conserva il fatto su Tanaka infermiere cambiando il tema sospeso in focus correttivo.",
  ...
  ...semanticLessonCopy("topic-questions-3", {
    ...
    instructions: [
      'Una scheda familiare appartiene al parlante. Scegli l’identificazione possessiva.',
    ...
    accepted: [
      "Il parlante resta prima di の e il nome familiare lo segue.",
    ...
    retry: [
      "Mantieni il parlante prima di の e la testa familiare dopo.",
  ...
  ...semanticLessonCopy("topic-questions-4", {
    ...
    purposes: [
      ...
      "Usa なん soltanto in una domanda aperta naturale.",
    ...
    instructions: [
      ...
      'Disponi l’affermazione d’identità e colloca il marcatore interrogativo dopo il predicato.',
      'Una fotografia richiede una conferma sì-no dell’identità, non una domanda aperta.',
    ...
    accepted: [
      ...
      "Gli stessi blocchi formano una domanda solo con か dopo il predicato.",
      "Il nome rispettoso forma la domanda sì-no di identificazione prevista.",
      "La trasformazione conserva il contenuto e cambia l’affermazione in domanda.",
      "La correzione rifiuta il valore falso con いいえ e fornisce l’Italia come aggiornamento.",
    ...
    retry: [
      ...
      "Scegli la conferma con nome rispettoso, non l’alternativa aperta.",
...
const SENTENCE_EXAMPLE_CONTEXT_COPY_IT: Readonly<Record<string, string>> = {
  ...
  "sentence-foundations-2-example-9-context": "Il campo telefono e il ruolo insegnante sono espliciti.",
  "sentence-foundations-2-example-10-context": "Il campo telefono è recuperabile, quindi resta soltanto il titolo.",
