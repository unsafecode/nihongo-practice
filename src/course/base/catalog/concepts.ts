...
export const BASE_CONCEPTS: readonly BaseConcept[] = deepFreeze([
  ...
  concept("modifier-before-noun", "concept", "topic-questions-3", [
    "sentence-order",
  ]),
  concept("additive-mo", "concept", "topic-questions-3", ["topic-wa"]),
  concept("nominal-listing-to", "concept", "topic-questions-4", ["topic-wa"]),
  concept("companion-to", "concept", "topic-questions-4", ["topic-wa"]),
