...
export const BASE_LEXICON: readonly BaseLexeme[] = deepFreeze([
  ...
  verb("verb-au", "あう", "au", "godan", "dynamic", "time-movement-3", DYNAMIC_TE_CONSTRUCTIONS),
  verb("verb-utau", "うたう", "utau", "godan", "dynamic", "time-movement-3", DYNAMIC_TE_CONSTRUCTIONS),
...
export const BASE_TASK11_LEXEME_RECURRENCE_PLANS: readonly BaseLexemeRecurrencePlan[] =
  deepFreeze([
    ...
    ...recurrence(["verb-hashiru"], [], ["base-synthesis-3"]),
    ...recurrence(["verb-ryouri-suru"], ["time-movement-4"]),
    ...
    ...recurrence(["noun-maishuu"], ["time-movement-4"]),
    ...recurrence(["noun-fudan"], [], ["base-synthesis-3"]),
