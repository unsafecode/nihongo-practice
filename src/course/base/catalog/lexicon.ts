...
export const BASE_LEXICON: readonly BaseLexeme[] = deepFreeze([
  ...
  verb("verb-yasumu", "やすむ", "yasumu", "godan", "dynamic", "time-movement-1", DYNAMIC_TE_CONSTRUCTIONS),
  verb("verb-okiru", "おきる", "okiru", "ichidan", "dynamic", "polite-verbs-4", DYNAMIC_TE_CONSTRUCTIONS),
  verb("verb-neru", "ねる", "neru", "ichidan", "dynamic", "time-movement-1", DYNAMIC_TE_CONSTRUCTIONS),
