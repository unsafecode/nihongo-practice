...
describe("Base first-teach ownership", () => {
  ...
  it("locks the Task7 verb and adjective first-teach sequence to exact owners", () => {
    ...
    expect(
      [
        ...
        ["concept", "suru-verb-class", "polite-verbs-2"],
        ["concept", "kuru-verb-class", "polite-verbs-2"],
      ...
      ["suru-verb-class", "polite-verbs-2", "polite-verbs-2"],
      ["kuru-verb-class", "polite-verbs-2", "polite-verbs-2"],
  ...
  it("locks Task7 productive verb and adjective lexemes to their owner lessons", () => {
    ...
    expect(
      ...
      ["verb-hanasu", "polite-verbs-4"],
      ["verb-matsu", "polite-verbs-3"],
      ["verb-shinu", "requests-connection-1"],
      ["verb-asobu", "polite-verbs-1"],
      ["verb-nomu", "polite-verbs-1"],
      ["verb-kau", "polite-verbs-1"],
      ["verb-yomu", "polite-verbs-1"],
      ["verb-hataraku", "polite-verbs-1"],
    ...
    expect(
      ...
      ["verb-suru", "polite-verbs-2"],
      ["verb-kuru", "polite-verbs-2"],
      ["verb-benkyou-suru", "polite-verbs-3"],
      ["verb-motte-kuru", "requests-connection-1"],
    ]);
    expect(
      [
        "adjective-takai",
  ...
  it("keeps retrieval systems reviewable only after their latest Task7 component owner", () => {
    ...
    expect(
      ...
      ["suru-verb-class", "polite-verbs-2"],
      ["kuru-verb-class", "polite-verbs-2"],
