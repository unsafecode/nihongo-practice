...
const L3: BaseTask11LessonSpec = {
  ...
  examples: [
    ...
    ex(predicateTarget("i-adjective", "adjective-ii", "pastAffirmative", I_PAST_AFFIRMATIVE, "noun-mise"), "shop-was-good", "The shop was good.", "Il negozio era buono.", "Uses the irregular stem for いい.", "Usa il tema irregolare di いい.", "i-past-affirmative"),
...
const L4: BaseTask11LessonSpec = {
  ...
  examples: [
    ...
    ex(modifierTarget("na-adjective", "adjective-kirei", "noun-gakusei", NA_ATTRIBUTIVE), "pretty-student", "They are a well-presented student.", "È uno studente dall'aspetto curato.", "Applies attributive な to another adjective.", "Applica il な attributivo a un altro aggettivo.", "na-attributive"),
    ex(predicateTarget("i-adjective", "adjective-ii", "affirmative", I_AFFIRMATIVE, "noun-kouen"), "contrast-good-park", "The park is nice.", "Il parco è buono.", "Keeps the い-adjective path distinct.", "Mantiene distinto il percorso degli aggettivi in い.", "i-present-affirmative"),
