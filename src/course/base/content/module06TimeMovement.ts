...
const L2: BaseTask11LessonSpec = {
  ...
  activities: [
    ...
    act(promptOf(bounds("noun-tokyo", null, "verb-ryokou-suru", "movement", "noun-mari")), bounds("noun-tokyo", "noun-osaka", "verb-ryokou-suru", "movement", "noun-mari"), (() => { const target = bounds("noun-tokyo", null, "verb-ryokou-suru", "movement", "noun-mari"); return { ...target, parts: [...target.parts, C, task11AnalysisLabel("analysis-direction")] }; })(), 1, "time-movement-2", 6, MOVEMENT_BOUNDS, BASE_ERROR_ACTIVITY_SHAPE, "mari", "mari-tokyo-osaka", "movement-bound-incomplete"),
