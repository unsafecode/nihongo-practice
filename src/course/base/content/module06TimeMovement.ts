...
function evidencedNonpast(
  ...
  return eventTarget(
    ...
    [
      ...
      ...(!topicId && task11VerbNeedsKanaSeparator(lemmaId) ? [C] : []),
    ],
    patternCellId,
...
const L1: BaseTask11LessonSpec = {
  ...
  examples: [
    ...
    ex(evidencedNonpast("verb-dekakeru", FUTURE, "noun-yuki-san"), "yuki-goes-out", "Yuki will go out tomorrow.", "Yuki uscirà domani.", "Uses a clear future time cue without ongoing meaning.", "Usa un chiaro indizio di tempo futuro senza significato progressivo.", "future"),
...
function specificTime(
  ...
  return eventTarget(
    ...
    [
      ...
      ...(task11VerbNeedsKanaSeparator(lemmaId) ? [C] : []),
    ],
    patternCellId,
    [tag],
...
const L2: BaseTask11LessonSpec = {
  ...
  examples: [
    ...
    ex(bounds("noun-tokyo", "noun-kyoto", "verb-ryokou-suru", "movement"), "tokyo-to-kyoto-travel", "I will travel from Tokyo as far as Kyoto.", "Viaggerò da Tokyo fino a Kyoto.", "Uses only movement source and endpoint bounds.", "Usa soltanto i limiti di origine e arrivo del movimento.", "future"),
  ...
  activities: [
    ...
    act(promptOf(bounds("noun-tokyo", "noun-chuugoku", "verb-ryokou-suru", "movement", "noun-mari")), bounds("noun-tokyo", "noun-osaka", "verb-ryokou-suru", "movement", "noun-mari"), bounds("noun-tokyo", "noun-chuugoku", "verb-ryokou-suru", "movement", "noun-mari"), 1, "time-movement-2", 6, MOVEMENT_BOUNDS, BASE_ERROR_ACTIVITY_SHAPE, "mari", "mari-tokyo-osaka", "movement-bound-destination-mismatch"),
    ...
    act(task11Cue(L("noun-suzuki"), C, task11VerbForm("verb-iku", "polite-nonpast")), relativeTime("noun-ashita", "verb-iku", RELATIVE_TIME, "future", "noun-suzuki"), relativeTime("noun-kyou", "verb-iku", RELATIVE_TIME, "future", "noun-suzuki"), 0, "time-movement-2", 9, RELATIVE_TIME, BASE_LISTENING_ACTIVITY_SHAPE),
...
const L4: BaseTask11LessonSpec = {
  ...
  examples: [
    ...
    ex(scheduleExample("noun-konban", "verb-ryouri-suru", "polite-nonpast", ["future"]), "cook-tonight", "I will cook tonight.", "Cucinerò stasera.", "Uses a future reading, never an action in progress now.", "Usa una lettura futura, mai progressiva.", "future"),
    ...
    ex(eventTarget("verb-iku", "polite-nonpast", [L("noun-konban"), L("noun-eki"), P("direction-he", "goal", "noun-eki")], ROUTE, ["future"], ["time", "direction"], ["relative-time-omission", "direction-he"], { predicateSenseId: "go-direction", provided: { goal: "direction-he" }, attachmentLexemeIdByRole: { goal: "noun-eki" } }), "station-tonight", "I will head toward the station tonight.", "Stasera mi dirigerò verso la stazione.", "Adds a coherent future movement item to the schedule.", "Aggiunge al programma un movimento futuro coerente.", "future"),
