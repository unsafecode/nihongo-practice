...
const L3: BaseTask11LessonSpec = {
  ...
  examples: [
    ...
    ex(fullExistence("noun-niwa", "noun-kodomo", IRU), "child-in-garden", "There is a child in the garden.", "In giardino c'è un bambino.", "Uses いる for a child in a plausible outdoor setting.", "Usa いる per un bambino in un contesto esterno plausibile.", "animate-location"),
    ...
    ex(topicLocation("noun-sakana", "noun-uchi", IRU), "fish-topic-home", "As for the fish, it is at home.", "Quanto al pesce, è a casa.", "Continues a household fish as the established topic.", "Continua come tema già stabilito un pesce tenuto in casa.", "topic-location"),
  ...
  activities: [
    ...
    act(task11Cue(L("noun-sakana")), fullExistence("noun-uchi", "noun-sakana", IRU), { ...fullExistence("noun-uchi", "noun-sakana", IRU), parts: [L("noun-uchi"), P("existence-location-ni", "existence-location", "noun-uchi"), task11VerbForm(IRU, "polite-nonpast"), L("noun-sakana"), P("existential-subject-ga", "existential-subject", "noun-sakana")] }, 0, "existence-location-3", 3, FRAME_CELL, BASE_ORDERING_ACTIVITY_SHAPE, null, { contrastAxis: "word-order", heldConstantPredicateLexemeId: IRU }),
    ...
    act(task11Cue(L("noun-yuki-san")), fullExistence("noun-uchi", "noun-yuki-san", IRU), fullExistence("noun-kyoushitsu", "noun-yuki-san", IRU), 0, "existence-location-3", 9, FRAME_CELL, BASE_LISTENING_ACTIVITY_SHAPE, null, { contrastAxis: "meaning", heldConstantPredicateLexemeId: IRU }),
