...
const LESSON_SPECS: readonly LessonSpec[] = deepFreeze([
  ...
  },
  {
    ...
    activities: [
      ...
      act(["noun-daigakusei", "wa", "noun-watashi", "desu"], ["noun-daigakusei", "ga", "noun-watashi", "desu"], ["noun-watashi", "wa", "noun-gakusei", "desu"], 0, "topic-questions-2-activity-10-instruction", "tq2-focused-subject", "focused-new-subject", BASE_SPOKEN_ACTIVITY_SHAPE, "speaker", "speaker-role"),
    ],
    dialogue: null,
    translationSemanticTags: [
      "focused-nurse",
