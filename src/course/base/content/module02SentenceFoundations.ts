...
const LESSON_SPECS: readonly LessonSpec[] = deepFreeze([
  ...
  },
  {
    ...
    activities: [
      ...
      activity(["noun-watashi"], ["noun-hito", "desu"], ["noun-gakusei", "desu"], 1, "sentence-foundations-4-activity-5-instruction", "sf4-complete-short-sentence", BASE_MEANING_ACTIVITY_SHAPE),
